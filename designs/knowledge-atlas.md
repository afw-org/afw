...
| Remaining APR | [`remaining-apr.md`](remaining-apr.md) — pools (reservoir + `get_apr_pool`). Campaign trail: [`afw-vector.md`](afw-vector.md) *Later*. Archaeology: [`memory-management.md`](memory-management.md) |
