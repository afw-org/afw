...
| **Open** | Umbrella **#2** still open. **Scoreboard (how close):** [`issue-2-hold-in-inf.md`](issue-2-hold-in-inf.md) *Live status (2026-09-15)*. Lab table **2026-09-15**: [`01-rss-hard-loops/README.md`](../src/afw/tests-extra/issue-2/01-rss-hard-loops/README.md). `function_return` still ~1.5 MiB/s (under bar). Do not treat GitHub #2 body or `experiment-brainstorm.md` “next session” as the scoreboard. |
