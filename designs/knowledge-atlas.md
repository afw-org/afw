...
| **Open** | Umbrella **#2** still open. **Scoreboard (how close):** [`issue-2-hold-in-inf.md`](issue-2-hold-in-inf.md) *Live status (2026-09-15)*. Protocol is the system on `develop` (including [PR #327](https://github.com/afw-org/afw/pull/327)); campaign not complete. Do not treat RSS README (table 2026-09-10), GitHub #2 body, or `experiment-brainstorm.md` “next session” as the scoreboard. |
