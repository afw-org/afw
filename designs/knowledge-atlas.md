...
| **Open** | Umbrella **#2** still open. **Scoreboard:** [`issue-2-hold-in-inf.md`](issue-2-hold-in-inf.md) *Live status (2026-09-17)*. Isolate sitting [PR #340](https://github.com/afw-org/afw/pull/340). [#341](https://github.com/afw-org/afw/issues/341) OS backtrace leftover **closed** ([PR #354](https://github.com/afw-org/afw/pull/354); managed hexBinary; `try_catch` soak flat). Managed `xctx->p` / compiled results [#342](https://github.com/afw-org/afw/issues/342). Lab table **2026-09-17**. Thread display/workers is [#343](https://github.com/afw-org/afw/issues/343) (not a #2 close gate). |
