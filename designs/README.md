...
| [`issue-2-property-name-values.md`](issue-2-property-name-values.md) | **#2** — object property names as `const afw_value_t *` (coded on `issue-2-property-name-values`; script/JSON string-only) |
