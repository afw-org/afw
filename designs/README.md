...
| [`experiment-brainstorm.md`](experiment-brainstorm.md) | **Branch only** (`experiment/brainstorm`) — managed in `xctx->p`, unmanaged in dest `p`; object/array frames. Not `develop` truth |
