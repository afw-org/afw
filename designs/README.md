...
| [`issue-2-property-name-values.md`](issue-2-property-name-values.md) | **#2** — another feature branch: object property names as `const afw_value_t *` (discussed; script/JSON string-only) |
