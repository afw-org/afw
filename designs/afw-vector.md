...
- **Do not rewrite `afw_array` yet.** Memory-array can sit on a vector of `const afw_value_t *` later.
...
- **Hash table:** [`afw-hash-table.md`](afw-hash-table.md) (`feature/afw-hash-table`; LMDB `dbi_handles` left while #299).
