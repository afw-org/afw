...
- FRV leftover wrapping **dropped** ([PR #326](https://github.com/afw-org/afw/pull/326)): no `function_return_value`; pin on caller. Do not reopen unique consume or a call-result leftover inf. Product tests (`return_temps.as`) stay; the soak lab is [`src/afw/tests-extra/issue-2/01-rss-hard-loops/README.md`](../src/afw/tests-extra/issue-2/01-rss-hard-loops/README.md). `function_return` is under the bar. Map: [`compile-unit-and-frv-next.md`](compile-unit-and-frv-next.md).
