...
|------|---------------------|
| **Evidence** | **2026-09-16** (this branch). Lab table rewritten. `function_return` **flat**. `try_catch` ~0.25 MiB/s in_use is OS backtrace leftover, not the engine. Server soaks not remeasured this sitting (`02` / `07` / `07b` still 2026-09-15). |
