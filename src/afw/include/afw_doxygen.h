 ...
 *
 * This is the Adaptive Framework Base Package which includes the Adaptive
 * Framework core library (libafw) plus applications, commands, and extensions.
 * @{
 */
 ...
 * 
 * Adaptive Framework interface implementation support.
 */
 ...
 *
 * Adaptive Framework Commands.
 */

/** @defgroup afw_included_extensions Extensions
 *
 * Adaptive Framework Extensions.
 */
