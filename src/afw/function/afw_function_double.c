    ...
    afw_function_execute_t *x)
{
    ...
    return afw_value_create_double_unmanaged(fabs(arg->internal), x->p, x->xctx);
}
    ...
    afw_function_execute_t *x)
{
    ...
    return afw_value_create_double_unmanaged(sum, x->p, x->xctx);
}
    ...
    afw_function_execute_t *x)
{
    ...
    return afw_value_create_double_unmanaged(ceil(arg->internal), x->p, x->xctx);
}
    ...
    afw_function_execute_t *x)
{
    ...
    return afw_value_create_double_unmanaged(floor(arg->internal), x->p, x->xctx);
}
    ...
    afw_function_execute_t *x)
{
    ...
    return afw_value_create_double_unmanaged(result, x->p, x->xctx);
}
    ...
    afw_function_execute_t *x)
{
    ...
    return afw_value_create_double_unmanaged(round(arg->internal), x->p, x->xctx);
}
    ...
    afw_function_execute_t *x)
{
    ...
    return afw_value_create_double_unmanaged(arg1->internal - arg2->internal,
        x->p, x->xctx);
}
    ...
    afw_function_execute_t *x)
{
    ...
    return afw_value_create_integer_unmanaged((afw_integer_t)d, x->p, x->xctx);
}
    ...
    afw_function_execute_t *x)
{
    ...
    return afw_value_create_double_unmanaged(-arg->internal, x->p, x->xctx);
}
