    ...
    afw_function_execute_t *x)
{
    ...
    return afw_value_create_string_unmanaged(uuid, x->p, x->xctx);
}
    ...
    afw_function_execute_t *x)
{
    ...
    return afw_value_create_object_unmanaged(parsed, x->p, x->xctx);
}
    ...
    afw_function_execute_t *x)
{
    ...
    response = afw_action_perform(request->internal, NULL, NULL,
        x->p, x->xctx);
    return afw_value_create_object_unmanaged(response, x->p, x->xctx);
}
...
afw_function_execute_execution_start_time_local(
    afw_function_execute_t *x)
{
    return afw_value_create_dateTime_unmanaged(
