...
/*
 * Interface afw_object Implementation for meta propertyTypes
 *
...
/**
 * @file afw_object_meta_propertyTypes.c
 * @brief Implementation of afw_object interface for meta propertyTypes
 */
...
#define AFW_IMPLEMENTATION_ID "afw_object_meta_propertyTypes"
