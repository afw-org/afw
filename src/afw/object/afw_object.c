    ...
    afw_xctx_t *xctx)
{
    ...
    if (!source_location) {
        ...
        if (!use_source_location) {
            use_source_location = &afw_self_s_a_empty_string;
        }
    }
    else {
    ...
    afw_xctx_t *xctx)
{
    ...
    if (value) {
        ...
        if (afw_value_is_boolean(value)) {
            ...
            if (
                afw_utf8_compare_ignore_case(string, &afw_self_s_true, xctx) == 0 ||
                (string->len == 1 &&
                    (
                    *string->s == 't' ||
                    *string->s == 'T' ||
                ...
                )
            {
                ...
                afw_utf8_compare_ignore_case(string, &afw_self_s_false, xctx)== 0 ||
                (string->len == 1 &&
                    (
                    *string->s == 'f' ||
                    *string->s == 'F' ||
