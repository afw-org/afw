...
/*
 * Interface afw_object Implementation for meta propertyType
 *
...
/**
 * @file afw_object_meta_propertyType.c
 * @brief Implementation of afw_object interface for meta propertyType
 */
...
#define AFW_IMPLEMENTATION_ID "afw_object_meta_propertyType"
