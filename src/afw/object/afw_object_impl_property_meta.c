...
{
    { &afw_self_s_dataType, impl_get_dataType, impl_set_dataType },
    { &afw_self_s_key, impl_get_key, impl_set_error_immutable },
    { &afw_self_s_value, impl_get_value, impl_set_value },
    { &afw_self_s_valueInfId, impl_get_valueInfId, impl_set_error_immutable }
};
