...
/*
 * Interface afw_object Implementation for meta properties
 *
...
/**
 * @file afw_object_meta_properties.c
 * @brief Implementation of afw_object interface for meta properties
 */
...
#define AFW_IMPLEMENTATION_ID "afw_object_meta_properties"
