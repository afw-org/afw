 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_referenced_boolean_inf;

/**
 * @brief Permanent managed (life of afw environment) value inf for data type boolean.
 *
...
/**
 * @brief Allocate function for referenced data type boolean value.
 ...
 * 'afw_boolean_t' internal value before using.
 */
AFW_DECLARE(const afw_value_t *)
afw_value_alloc_referenced_boolean(
    afw_boolean_t **internal,
    afw_xctx_t *xctx);

/**
 * @brief Allocate function for unmanaged data type boolean value.
...
/**
 * @brief Create function for referenced data type boolean value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
