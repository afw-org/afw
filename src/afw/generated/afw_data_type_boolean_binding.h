 ...
 */
#define afw_data_type_is_boolean(_A_DATA_TYPE) \
( \
    (_A_DATA_TYPE) && \
    (_A_DATA_TYPE) == afw_data_type_boolean \
)

/**
 * @brief True if _A_VALUE is an evaluated boolean value.
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(_A_VALUE, boolean, xctx)` instead.
 */
#define afw_value_is_boolean(_A_VALUE) \
( \
    (_A_VALUE) && \
...
/**
 * @brief True if _A_VALUE is an evaluated array of boolean.
 * @param _A_VALUE to test.
 * @return boolean result.
 *
 ...
 */
#define afw_value_is_array_of_boolean(_A_VALUE) \
( \
...
afw_value_boolean_allocate(
    const afw_pool_t *p,
    afw_xctx_t *xctx);
#define afw_value_allocate_unmanaged_boolean afw_value_boolean_allocate
...
afw_value_boolean_create_managed(
    ...
    const afw_pool_t *p,
    afw_xctx_t *xctx);
#define afw_value_create_managed_boolean afw_value_boolean_create_managed

/**
 * @brief Deep clone an evaluated boolean value unmanaged into p.
 * @param value evaluated boolean.
 * @param p dest pool.
 * @param xctx of caller.
...
/**
 * @brief Clone an evaluated boolean value managed in p->managed_p.
 * @param value evaluated boolean.
 * @param p dest pool (uses p->managed_p).
 * @param xctx of caller.
