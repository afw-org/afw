...
/**
 * @brief Typesafe cast to evaluated array value.
 * @param value (const afw_value_t *). Evaluated if needed.
 * @return (const afw_value_array_t *)
 *
 * Throws if missing or wrong type. Use ->internal for the C
 * payload, or afw_value_as_array_internal().
 */
...
afw_value_array_allocate(
    const afw_pool_t *p,
    afw_xctx_t *xctx);
#define afw_value_allocate_unmanaged_array afw_value_array_allocate
...
/**
 * @brief Deep clone an evaluated array value unmanaged into p.
...
#define afw_value_create_unmanaged_array afw_value_array_create
 ...
 * @param xctx of caller.
 * @return (const afw_value_array_t *) or NULL if missing.
 *
...
/**
 * @brief Get property function for data type array internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_array_t *.
...
/**
 * @brief Get next property function for data type array internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
...
/**
 * @brief Set property as array value.
 * @param object of property to set.
 * @param property_name of property to set.
 * @param value to set.
 * @param xctx of caller.
 *
 * Compile-time type check for const afw_value_array_t *.
 */
AFW_DECLARE(void)
...
/**
 * @brief Set property as array internal.
 * @param object of property to set.
 * @param property_name of property to set.
 ...
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_value_array_t *) or NULL.
 *
...
/**
 * @brief Add a array value to array of array.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Add a array internal to array of array.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove a array value from array of array.
 * @param instance of array.
...
/**
 * @brief Remove a array internal from array of array.
 * @param instance of array.
 * @param value to remove.
 * @param xctx of caller.
 */
