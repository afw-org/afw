...
/**
 * @addtogroup afw_authorization_handler_impl_declares afw_authorization_handler
 * @{
 *
 ...
 * generated/interface_closet/skeleton_afw_authorization_handler.c.
 *
 ...
 *    impl_afw_authorization_handler_ followed by the method name.
 * 2. rti will be defined with a name of impl_afw_authorization_handler_rti.
 * 3. inf will be defined with a name of impl_afw_authorization_handler_inf.
 *
 ...
 *
 * A second #include "afw_authorization_handler_impl_declares.h" can be specified if
" *   #define "AFW_AUTHORIZATION_HANDLER_INF_ONLY" is specified to generate inf only."
 *~~~~~~~~~~~~~~~
 */
...
#ifdef __AFW_AUTHORIZATION_HANDLER_IMPL_DECLARES_H__
#ifndef AFW_AUTHORIZATION_HANDLER_INF_ONLY
#error "afw_authorization_handler_impl_declares.h already included."
#endif
#endif
#ifndef __AFW_AUTHORIZATION_HANDLER_IMPL_DECLARES_H__
#ifdef AFW_AUTHORIZATION_HANDLER_INF_ONLY
#error "afw_authorization_handler_impl_declares.h must be included before AFW_AUTHORIZATION_HANDLER_INF_ONLY."
#endif
#define __AFW_AUTHORIZATION_HANDLER_IMPL_DECLARES_H__ 1
#endif
...
#ifndef impl_afw_authorization_handler_check
...
/* inf for interface afw_authorization_handler */
#ifdef __BASE_FILE__
...
AFW_IMPLEMENTATION_INF_SPECIFIER(afw_authorization_handler_inf_t)
#else
static const afw_authorization_handler_inf_t
#endif
