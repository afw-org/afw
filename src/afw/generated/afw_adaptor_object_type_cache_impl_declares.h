 ...
 * 2. rti will be defined with a name of impl_afw_adaptor_object_type_cache_rti.
 * 3. inf will be defined with a name of impl_afw_adaptor_object_type_cache_inf.
 *
