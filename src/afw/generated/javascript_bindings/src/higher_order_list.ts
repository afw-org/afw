...
/*
 * Javascript Bindings for higher_order_list
 *
 ...
 * 
 * @returns {list} This is the resulting filtered list.
 */
 ...
 */
export function afwReduce(client : any, functor : any, accumulator : any, list : any[]) : any {
 ...
 * 
 * @returns {list} This the the resulting sorted list.
 */
export function afwSort(client : any, compareFunction : any, list : any[]) : any {
