...
/**
 * @brief Macro to determine if value is evaluated list of null.
 * @param A_VALUE to test.
 * @return boolean result.
 */
...
/**
 * @brief Allocate function for permanent data type null value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_null_t with appropriate inf set.
 */
...
/**
 * @brief Get next value from list of null.
 ...
 */
#define afw_list_of_null_get_next( \
    list, iterator, xctx) \
...
/**
 * @brief Add value from list of null.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of null.
 * @param instance of list.
