...
/* This is the inf for unmanaged rfc822Name values. For this one */
/* optional_release is NULL and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "rfc822Name"
#define AFW_IMPLEMENTATION_INF_SPECIFIER AFW_DEFINE_CONST_DATA
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_evaluated_rfc822Name_inf
...
afw_data_type_rfc822Name_direct = {
    ...
    sizeof(afw_utf8_t),
    (const afw_list_t *)&impl_empty_list_of_rfc822Name,
    (const afw_value_t *)&impl_value_empty_list_of_rfc822Name,
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_rfc822Name(internal, object->p, xctx);
...
/* Allocate function for unmanaged data type rfc822Name values. */
...
afw_value_allocate_rfc822Name(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_rfc822Name_t),
        xctx);
    result->inf = &afw_value_evaluated_rfc822Name_inf;
    return result;
}

/* Create function for unmanaged data type rfc822Name value. */
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_rfc822Name(p, xctx);
    if (internal) {
...
/* Allocate function for managed data type rfc822Name values. */
AFW_DEFINE(afw_value_rfc822Name_t *)
afw_value_allocate_managed_rfc822Name(const afw_pool_t *p, afw_xctx_t *xctx)
{
    afw_value_rfc822Name_t *result;
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_managed_rfc822Name(p, xctx);
    if (internal) {
        memcpy(&v->internal, internal, sizeof(afw_utf8_t));
    }
    return (const afw_value_t *)v;
...
/* Allocate function for permanent data type rfc822Name values. */
AFW_DEFINE(afw_value_rfc822Name_t *)
afw_value_allocate_permanent_rfc822Name(const afw_pool_t *p, afw_xctx_t *xctx)
{
    afw_value_rfc822Name_t *result;

    result = afw_pool_calloc(p, sizeof(afw_value_rfc822Name_t),
        xctx);
    result->inf = &afw_value_permanent_rfc822Name_inf;
    return result;
}
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_permanent_rfc822Name(p, xctx);
    if (internal) {
        memcpy(&v->internal, internal, sizeof(afw_utf8_t));
    }
    return (const afw_value_t *)v;
    ...
    afw_xctx_t *xctx)
{
    ...
    info->optimized_value_data_type = afw_data_type_rfc822Name;
}


/* Get next value from list of rfc822Name. */
AFW_DEFINE(const afw_utf8_t *)
...
/* Add value from list of rfc822Name */
AFW_DEFINE(void)
...
/* Remove value from list of rfc822Name */
AFW_DEFINE(void)
