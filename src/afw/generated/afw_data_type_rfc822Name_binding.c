    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_pool_calloc(xctx->p, sizeof(afw_value_rfc822Name_managed_slice_t), xctx);
...
/* Clone evaluated rfc822Name managed in xctx->p. */
AFW_DEFINE(const afw_value_t *)
afw_value_clone_rfc822Name_managed(
    const afw_value_t *value,
    afw_xctx_t *xctx)
...
/* Get property function for data type rfc822Name internal. */
AFW_DEFINE(const afw_utf8_t *)
...
/* Get next property function for data type rfc822Name internal. */
AFW_DEFINE(const afw_utf8_t *)
