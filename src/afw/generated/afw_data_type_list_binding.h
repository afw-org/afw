...
#ifndef __AFW_DATA_TYPE_LIST_BINDING_H__
#define __AFW_DATA_TYPE_LIST_BINDING_H__


/**
 * @file afw_data_type_list_binding.h
 * @brief Adaptive data type list header.
 */
...
/**
 * @addtogroup afw_c_api_data_type_list list
 *
 * Adaptive Data Type list
 *
 * @{
...
/** @brief Quoted data type id for list */
#define AFW_DATA_TYPE_ID_Q_list "list"

/** @brief Unquoted data type id for list */
#define AFW_DATA_TYPE_ID_U_list list

/** @brief String for data type id list */
#define AFW_DATA_TYPE_ID_S_list afw_s_list

/** @brief Quoted c type for data type id list */
#define AFW_DATA_TYPE_CTYPE_Q_list "const afw_list_t *"

/** @brief Adaptive string value for "list". */
AFW_DECLARE_CONST_DATA(afw_value_t *)
afw_data_type_list_id_value;

/** @brief Data type struct for list. */
AFW_DECLARE_CONST_DATA(afw_data_type_t *)
afw_data_type_list;

/**
 * @brief Unmanaged evaluated value inf for data type list.
 *
...
/**
 * @brief Managed evaluated value inf for data type list.
 *
 * The lifetime of the value is managed by reference.
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_managed_list_inf;

/**
 * @brief Permanent managed (life of afw environment) value inf for data type list.
 *
...
/**
 * @brief Macro to determine if data type is list.
...
( \
    (A_DATA_TYPE) && \
    (A_DATA_TYPE) == afw_data_type_list \
)

/**
 * @brief Macro to determine if value is evaluated list.
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_list\
)

/**
 * @brief Macro to determine if value is evaluated list of list.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_list(A_VALUE) \
( \
    afw_value_is_list(A_VALUE) && \
    afw_list_get_data_type( \
        ((const afw_value_list_t *)(A_VALUE))->internal, \
        xctx) == afw_data_type_list \
)

/**
 * @brief Convert data type list string to const afw_list_t * *.
 * @param to_internal place to return result.  Must be sizeof(const afw_list_t *).
...
/**
 * @brief Convert data type list internal representation to utf-8.
 * @param internal (const afw_list_t *) to convert.
...
/** @brief struct for data type list values. */
struct afw_value_list_s {
    const afw_value_inf_t *inf;
    const afw_list_t * internal;
};

/**
 * @brief Typesafe cast of data type list.
 * @param value (const afw_value_t *).
 * @return (const afw_list_t *)
 */
AFW_DECLARE(const afw_list_t *)
afw_value_as_list(const afw_value_t *value, afw_xctx_t *xctx);

/**
 * @brief Allocate function for unmanaged data type list value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_list_t with appropriate inf set.
 */
AFW_DECLARE(afw_value_list_t *)
afw_value_allocate_list(const afw_pool_t *p, afw_xctx_t *xctx);

/**
 * @brief Create function for unmanaged data type list value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
...
/**
 * @brief Allocate function for managed data type list value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_list_t with appropriate inf set.
 */
...
/**
 * @brief Create function for managed data type list value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
...
/**
 * @brief Allocate function for permanent data type list value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_list_t with appropriate inf set.
 */
...
/**
 * @brief Create function for permanent data type list value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
...
/**
 * @brief Get property function for data type list value.
 * @deprecated
 ...
 *
 */
#define afw_object_old_get_property_as_list( \
 ...
 * @return const afw_list_t *.
 */
#define afw_object_get_property_as_list( \
...
/**
 * @brief Get next property function for data type list value.
 * @deprecated
 * @param object of property to get.
 ...
 *
 */
#define afw_object_old_get_next_property_as_list( \
 ...
 * @return const afw_list_t *.
 */
#define afw_object_get_next_property_as_list( \
...
/**
 * @brief Set property function for data type list values.
...
/**
 * @brief Add value from list of list.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of list.
 * @param instance of list.
...
/**
 * @brief extern for data type list struct.
 *
 * This should only be referenced in the linkage unit the extern is
 * defined in.  Use afw_data_type_list when not referencing in
 * a static.
 */
...
/**
 * @brief extern for data type list inf.
 *
 * This should only be referenced in the linkage unit the extern is
 * defined in.
 *
...
#endif /* __AFW_DATA_TYPE_LIST_BINDING_H__ */
