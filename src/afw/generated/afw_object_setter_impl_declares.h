...
/**
 * @addtogroup afw_object_setter_impl_declares afw_object_setter
 * @{
 *
 ...
 * generated/interface_closet/skeleton_afw_object_setter.c.
 *
 ...
 *    impl_afw_object_setter_ followed by the method name.
...
#ifdef __AFW_OBJECT_SETTER_IMPL_DECLARES_H__
#ifndef AFW_OBJECT_SETTER_INF_ONLY
#error "afw_object_setter_impl_declares.h already included."
#endif
#endif
#ifndef __AFW_OBJECT_SETTER_IMPL_DECLARES_H__
#ifdef AFW_OBJECT_SETTER_INF_ONLY
#error "afw_object_setter_impl_declares.h must be included before AFW_OBJECT_SETTER_INF_ONLY."
#endif
...
#ifndef impl_afw_object_setter_set_property
...
AFW_IMPLEMENTATION_INF_SPECIFIER(afw_object_setter_inf_t)
#else
static const afw_object_setter_inf_t
#endif
#ifdef AFW_IMPLEMENTATION_INF_LABEL
AFW_IMPLEMENTATION_INF_LABEL = {
#else
impl_afw_object_setter_inf = {
#endif
    {
