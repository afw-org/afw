...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_any\
)

/**
 * @brief Macro to determine if value is evaluated array of any.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_array_of_any(A_VALUE) \
( \
...
/**
 * @brief Get next value from array of any.
 ...
 */
#define afw_array_of_any_get_next( \
    array, iterator, xctx) \
...
/**
 * @brief Add value from array of any.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from array of any.
 * @param instance of array.
