...
/**
 * @addtogroup afw_c_api_data_type_any any
 *
 * Adaptive Data Type any
 *
 * @{
...
/**
 * @brief Unmanaged evaluated value inf for data type any.
 *
...
/**
 * @brief Managed evaluated value inf for data type any.
 *
 * The lifetime of the value is managed by reference.
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_managed_any_inf;

/**
 * @brief Permanent managed (life of afw environment) value inf for data type any.
 *
...
/**
 * @brief Macro to determine if value is evaluated any.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_any(A_VALUE) \
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_any\
)

/**
 * @brief Macro to determine if value is evaluated list of any.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_any(A_VALUE) \
( \
    afw_value_is_list(A_VALUE) && \
    afw_list_get_data_type( \
        ((const afw_value_list_t *)(A_VALUE))->internal, \
        xctx) == afw_data_type_any \
)

/**
 * @brief Convert data type any string to const afw_value_t * *.
...
/**
 * @brief Convert data type any internal representation to utf-8.
...
/**
 * @brief Typesafe cast of data type any.
...
/**
 * @brief Allocate function for unmanaged data type any value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_any_t with appropriate inf set.
 */
AFW_DECLARE(afw_value_any_t *)
afw_value_allocate_any(const afw_pool_t *p, afw_xctx_t *xctx);

/**
 * @brief Create function for unmanaged data type any value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
...
/**
 * @brief Allocate function for managed data type any value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_any_t with appropriate inf set.
 */
...
/**
 * @brief Create function for managed data type any value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
...
/**
 * @brief Allocate function for permanent data type any value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_any_t with appropriate inf set.
 */
...
/**
 * @brief Create function for permanent data type any value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
...
/**
 * @brief Get property function for data type any value.
 * @deprecated
 ...
 *
 */
#define afw_object_old_get_property_as_any( \
 ...
 * @return const afw_value_t *.
 */
#define afw_object_get_property_as_any( \
...
/**
 * @brief Get next property function for data type any value.
 * @deprecated
 * @param object of property to get.
 ...
 *
 */
#define afw_object_old_get_next_property_as_any( \
 ...
 * @return const afw_value_t *.
 */
#define afw_object_get_next_property_as_any( \
...
/**
 * @brief Set property function for data type any values.
...
/**
 * @brief Get next value from list of any.
 ...
 */
#define afw_list_of_any_get_next( \
    list, iterator, xctx) \
...
/**
 * @brief Add value from list of any.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of any.
 * @param instance of list.
