...
/* Value for empty list of yearMonthDuration. */
AFW_DEFINE_INTERNAL_CONST_DATA(afw_list_wrapper_for_array_self_t)
impl_empty_list_of_yearMonthDuration;

/* Value for empty list of yearMonthDuration. */
AFW_DEFINE_INTERNAL_CONST_DATA(afw_value_list_t)
impl_value_empty_list_of_yearMonthDuration;
...
afw_data_type_yearMonthDuration_direct = {
    ...
    (const afw_list_t *)&impl_empty_list_of_yearMonthDuration,
    (const afw_value_t *)&impl_value_empty_list_of_yearMonthDuration,
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_yearMonthDuration(internal, object->p, xctx);
...
afw_value_allocate_yearMonthDuration(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_yearMonthDuration_t),
        xctx);
    result->inf = &afw_value_evaluated_yearMonthDuration_inf;
    return result;
}
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_yearMonthDuration(p, xctx);
    if (internal) {
...
/* Allocate function for managed data type yearMonthDuration values. */
AFW_DEFINE(afw_value_yearMonthDuration_t *)
afw_value_allocate_managed_yearMonthDuration(const afw_pool_t *p, afw_xctx_t *xctx)
{
    afw_value_yearMonthDuration_t *result;
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_managed_yearMonthDuration(p, xctx);
    if (internal) {
        memcpy(&v->internal, internal, sizeof(afw_yearMonthDuration_t));
    }
    return (const afw_value_t *)v;
...
/* Allocate function for permanent data type yearMonthDuration values. */
AFW_DEFINE(afw_value_yearMonthDuration_t *)
afw_value_allocate_permanent_yearMonthDuration(const afw_pool_t *p, afw_xctx_t *xctx)
{
    afw_value_yearMonthDuration_t *result;

    result = afw_pool_calloc(p, sizeof(afw_value_yearMonthDuration_t),
        xctx);
    result->inf = &afw_value_permanent_yearMonthDuration_inf;
    return result;
}

/* Create function for data type yearMonthDuration value. */
AFW_DEFINE(const afw_value_t *)
afw_value_create_permanent_yearMonthDuration(const afw_yearMonthDuration_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    afw_value_yearMonthDuration_t *v;

    v = afw_value_allocate_permanent_yearMonthDuration(p, xctx);
    if (internal) {
        memcpy(&v->internal, internal, sizeof(afw_yearMonthDuration_t));
    }
    return (const afw_value_t *)v;
    ...
    afw_xctx_t *xctx)
{
    ...
    info->optimized_value_data_type = afw_data_type_yearMonthDuration;
}


/* Get next value from list of yearMonthDuration. */
AFW_DEFINE(const afw_yearMonthDuration_t *)
afw_list_of_yearMonthDuration_get_next_source(
...
/* Add value from list of yearMonthDuration */
AFW_DEFINE(void)
afw_list_of_yearMonthDuration_add(
    const afw_list_t *instance,
...
/* Remove value from list of yearMonthDuration */
AFW_DEFINE(void)
afw_list_of_yearMonthDuration_remove(
    const afw_list_t *instance,
    const afw_yearMonthDuration_t *value,
    afw_xctx_t *xctx)
{
