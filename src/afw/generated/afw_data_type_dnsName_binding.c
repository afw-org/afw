...
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_evaluated_dnsName_inf
...
afw_data_type_dnsName_direct = {
    ...
    sizeof(afw_utf8_t),
    (const afw_list_t *)&impl_empty_list_of_dnsName,
    (const afw_value_t *)&impl_value_empty_list_of_dnsName,
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_dnsName(internal, object->p, xctx);
...
afw_value_allocate_dnsName(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_dnsName_t),
        xctx);
    result->inf = &afw_value_evaluated_dnsName_inf;
    return result;
}
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_dnsName(p, xctx);
    if (internal) {
...
/* Allocate function for permanent data type dnsName values. */
AFW_DEFINE(afw_value_dnsName_t *)
afw_value_allocate_permanent_dnsName(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_dnsName_t),
        xctx);
    result->inf = &afw_value_permanent_dnsName_inf;
    return result;
}
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_permanent_dnsName(p, xctx);
    if (internal) {
        memcpy(&v->internal, internal, sizeof(afw_utf8_t));
    }
    return (const afw_value_t *)v;
    ...
    afw_xctx_t *xctx)
{
    ...
    info->optimized_value_data_type = afw_data_type_dnsName;
}


/* Get next value from list of dnsName. */
AFW_DEFINE(const afw_utf8_t *)
...
/* Add value from list of dnsName */
AFW_DEFINE(void)
...
/* Remove value from list of dnsName */
AFW_DEFINE(void)
