    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_unmanaged_dnsName(internal, object->p, xctx);
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_xctx_calloc(sizeof(afw_value_dnsName_managed_slice_t), xctx);
    v->inf = &afw_value_managed_slice_dnsName_inf;
    v->internal.s = base->s + offset;
    v->internal.len = len;
    v->containing_value = containing;
    ((afw_value_dnsName_managed_t *)containing)->reference_count++;
    return &v->pub;
}
    ...
    afw_xctx_t *xctx)
{
    ...
    (void)p;
    boxed = afw_value_create_managed_dnsName(
        &self->internal, xctx);
