...
/**
 * @addtogroup afw_c_api_data_type_regexp regexp
 *
 * Adaptive Data Type regexp
 *
 * @{
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_regexp\
)

/**
 * @brief Macro to determine if value is evaluated list of regexp.
 * @param A_VALUE to test.
 * @return boolean result.
 */
...
/**
 * @brief Get next value from list of regexp.
 ...
 */
#define afw_list_of_regexp_get_next( \
    list, iterator, xctx) \
...
/**
 * @brief Add value from list of regexp.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of regexp.
 * @param instance of list.
