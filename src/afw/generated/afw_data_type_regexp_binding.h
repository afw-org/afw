 ...
 */
#define afw_data_type_is_regexp(_A_DATA_TYPE) \
( \
    (_A_DATA_TYPE) && \
    (_A_DATA_TYPE) == afw_data_type_regexp \
)

/**
 * @brief True if _A_VALUE is an evaluated regexp value.
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(_A_VALUE, regexp, xctx)` instead.
 */
#define afw_value_is_regexp(_A_VALUE) \
( \
    (_A_VALUE) && \
    (_A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_regexp\
)

/**
 * @brief True if _A_VALUE is an evaluated array of regexp.
 * @param _A_VALUE to test.
 * @return boolean result.
 *
 ...
 */
#define afw_value_is_array_of_regexp(_A_VALUE) \
( \
...
/**
 * @brief Typesafe cast to evaluated regexp value.
 * @param value (const afw_value_t *). Evaluated if needed.
 * @return (const afw_value_regexp_t *)
 *
 * Throws if missing or wrong type. Use ->internal for the C
 * payload, or afw_value_as_regexp_internal().
 */
AFW_DECLARE(const afw_value_regexp_t *)
afw_value_as_regexp(
    const afw_value_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Typesafe peel of data type regexp internal.
 * @param value (const afw_value_t *).
 * @return (const afw_utf8_t *)
 */
AFW_DECLARE(const afw_utf8_t *)
afw_value_as_regexp_internal(
    const afw_value_t *value,
    afw_xctx_t *xctx);
...
/**
 * @brief Clone an evaluated regexp value managed in p->managed_p.
 * @param value evaluated regexp.
 * @param p dest pool (uses p->managed_p).
 * @param xctx of caller.
...
/**
 * @brief Get property as regexp value.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return (const afw_value_regexp_t *) or NULL if missing.
 *
 * Does not evaluate. Throws if present but not regexp.
 */
...
/**
 * @brief Get property as regexp internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_utf8_t *.
 */
#define afw_object_get_property_as_regexp_internal( \
    _object, _property_name, _xctx) \
...
/**
 * @brief Get next property as regexp internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
 * @return const afw_utf8_t *.
 */
#define afw_object_get_next_property_as_regexp_internal( \
    _object, _iterator, _property_name, _xctx) \
...
/**
 * @brief Set property as regexp value.
 * @param object of property to set.
 * @param property_name of property to set.
 * @param value to set.
 * @param xctx of caller.
 *
 * Compile-time type check for const afw_value_regexp_t *.
 */
AFW_DECLARE(void)
...
/**
 * @brief Set property as regexp internal.
 * @param object of property to set.
 * @param property_name of property to set.
...
/**
 * @brief Get next regexp value from array of regexp.
 * @param instance of array.
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_value_regexp_t *) or NULL.
 *
...
/**
 * @brief Get next regexp internal from array of regexp.
 * @param instance of array.
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_utf8_t *) or NULL.
 */
#define afw_array_of_regexp_get_next_internal( \
    _array, _iterator, _xctx) \
...
/**
 * @brief Add a regexp value to array of regexp.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Add a regexp internal to array of regexp.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove a regexp value from array of regexp.
 * @param instance of array.
...
/**
 * @brief Remove a regexp internal from array of regexp.
 * @param instance of array.
 * @param value to remove.
 * @param xctx of caller.
 */
