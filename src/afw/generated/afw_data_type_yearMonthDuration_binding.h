...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_yearMonthDuration\
)

/**
 * @brief Macro to determine if value is evaluated list of yearMonthDuration.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_yearMonthDuration(A_VALUE) \
( \
...
/**
 * @brief Allocate function for unmanaged data type yearMonthDuration value.
...
/**
 * @brief Allocate function for permanent data type yearMonthDuration value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_yearMonthDuration_t with appropriate inf set.
 */
...
/**
 * @brief Create function for permanent data type yearMonthDuration value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
...
/**
 * @brief Get next value from list of yearMonthDuration.
 ...
 */
#define afw_list_of_yearMonthDuration_get_next( \
    list, iterator, xctx) \
...
/**
 * @brief Add value from list of yearMonthDuration.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of yearMonthDuration.
 * @param instance of list.
