 ...
 * `const afw_value_yearMonthDuration_t *` (e.g. to read `.internal`).
 * Same as `AFW_VALUE_IS_DATA_TYPE(A_VALUE, yearMonthDuration)`.
 * Not the same as "will evaluate to yearMonthDuration" — see
