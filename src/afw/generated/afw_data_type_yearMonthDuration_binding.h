 ...
 */
#define afw_data_type_is_yearMonthDuration(_A_DATA_TYPE) \
( \
    (_A_DATA_TYPE) && \
    (_A_DATA_TYPE) == afw_data_type_yearMonthDuration \
)

/**
 * @brief True if _A_VALUE is an evaluated yearMonthDuration value.
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(_A_VALUE, yearMonthDuration, xctx)` instead.
 */
#define afw_value_is_yearMonthDuration(_A_VALUE) \
( \
    (_A_VALUE) && \
    (_A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_yearMonthDuration\
)

/**
 * @brief True if _A_VALUE is an evaluated array of yearMonthDuration.
 * @param _A_VALUE to test.
 * @return boolean result.
 *
 ...
 */
#define afw_value_is_array_of_yearMonthDuration(_A_VALUE) \
( \
 ...
 * @param xctx of caller.
 * @return Allocated afw_value_yearMonthDuration_t with unmanaged inf set.
 *
...
afw_value_yearMonthDuration_allocate(
    const afw_pool_t *p,
    afw_xctx_t *xctx);
#define afw_value_allocate_unmanaged_yearMonthDuration afw_value_yearMonthDuration_allocate
...
afw_value_yearMonthDuration_create_managed(
    ...
    const afw_pool_t *p,
    afw_xctx_t *xctx);
#define afw_value_create_managed_yearMonthDuration afw_value_yearMonthDuration_create_managed

/**
 * @brief Deep clone an evaluated yearMonthDuration value unmanaged into p.
 * @param value evaluated yearMonthDuration.
 * @param p dest pool.
 * @param xctx of caller.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_clone_yearMonthDuration_unmanaged(
    const afw_value_t *value,
    const afw_pool_t *p,
    afw_xctx_t *xctx);

/**
 * @brief Clone an evaluated yearMonthDuration value managed in p->managed_p.
 * @param value evaluated yearMonthDuration.
 * @param p dest pool (uses p->managed_p).
 * @param xctx of caller.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_clone_yearMonthDuration_managed(
    const afw_value_t *value,
    const afw_pool_t *p,
    afw_xctx_t *xctx);
...
#define afw_value_create_unmanaged_yearMonthDuration afw_value_yearMonthDuration_create

/**
 * @brief Get property as yearMonthDuration value.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return (const afw_value_yearMonthDuration_t *) or NULL if missing.
 *
 * Does not evaluate. Throws if present but not yearMonthDuration.
 */
 ...
 * @return const afw_yearMonthDuration_t *.
 */
#define afw_object_get_property_as_yearMonthDuration_internal( \
    _object, _property_name, _xctx) \
 ...
 * @return const afw_yearMonthDuration_t *.
 */
#define afw_object_get_next_property_as_yearMonthDuration_internal( \
    _object, _iterator, _property_name, _xctx) \
...
/**
 * @brief Set property as yearMonthDuration value.
 * @param object of property to set.
 * @param property_name of property to set.
 * @param value to set.
 * @param xctx of caller.
 *
 * Compile-time type check for const afw_value_yearMonthDuration_t *.
 */
AFW_DECLARE(void)
...
/**
 * @brief Set property as yearMonthDuration internal.
 * @param object of property to set.
 * @param property_name of property to set.
...
/**
 * @brief Get next yearMonthDuration value from array of yearMonthDuration.
 * @param instance of array.
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_value_yearMonthDuration_t *) or NULL.
 *
...
/**
 * @brief Get next yearMonthDuration internal from array of yearMonthDuration.
 * @param instance of array.
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_yearMonthDuration_t *) or NULL.
 */
#define afw_array_of_yearMonthDuration_get_next_internal( \
    _array, _iterator, _xctx) \
    afw_array_of_yearMonthDuration_get_next_internal_source( \
    _array, _iterator, AFW__FILE_LINE__, _xctx)
...
/**
 * @brief Add a yearMonthDuration value to array of yearMonthDuration.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Add a yearMonthDuration internal to array of yearMonthDuration.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_array_of_yearMonthDuration_add_internal(
    const afw_array_t *instance,
...
/**
 * @brief Public data type yearMonthDuration struct instance.
 *
 * Prefer afw_data_type_yearMonthDuration when a pointer is enough and you are not
...
/**
 * @brief Public data type yearMonthDuration inf.
 *
