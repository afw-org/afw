...
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_script_inf
...
/* Declares and rti/inf defines for interface afw_value */
/* This is the inf for referenced script values. For this one */
/* optional_release releases value and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "referenced_script"
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_referenced_script_inf
...
afw_value_allocate_script(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_script_t),
        xctx);
    result->inf = &afw_value_script_inf;
    return result;
}

/* Create function for referenced data type script value. */
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_pool_calloc(p, sizeof(afw_value_script_t),
        xctx);
    v->inf = &afw_value_referenced_script_inf;
    if (internal) {
...
/* Create function for referenced data type script slice value. */
AFW_DEFINE(const afw_value_t *)
