 ...
 */
#define afw_data_type_is_x500Name(_A_DATA_TYPE) \
( \
    (_A_DATA_TYPE) && \
    (_A_DATA_TYPE) == afw_data_type_x500Name \
)

/**
 * @brief True if _A_VALUE is an evaluated x500Name value.
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(_A_VALUE, x500Name, xctx)` instead.
 */
#define afw_value_is_x500Name(_A_VALUE) \
( \
    (_A_VALUE) && \
    (_A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_x500Name\
)

/**
 * @brief True if _A_VALUE is an evaluated array of x500Name.
 * @param _A_VALUE to test.
 * @return boolean result.
 *
 ...
 */
#define afw_value_is_array_of_x500Name(_A_VALUE) \
( \
...
/**
 * @brief Clone an evaluated x500Name value managed in p->managed_p.
 * @param value evaluated x500Name.
 * @param p dest pool (uses p->managed_p).
 * @param xctx of caller.
...
/**
 * @brief Get property as x500Name internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_utf8_t *.
...
/**
 * @brief Get next property as x500Name internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
