...
#ifndef __AFW_DATA_TYPE_X500NAME_BINDING_H__
#define __AFW_DATA_TYPE_X500NAME_BINDING_H__
...
/**
 * @defgroup afw_c_api_data_type_x500Name x500Name
...
/** @brief Quoted data type id for x500Name */
#define AFW_DATA_TYPE_ID_Q_x500Name "x500Name"

/** @brief Unquoted data type id for x500Name */
#define AFW_DATA_TYPE_ID_U_x500Name x500Name

/** @brief String for data type id x500Name */
#define AFW_DATA_TYPE_ID_S_x500Name afw_s_x500Name

/** @brief Quoted c type for data type id x500Name */
#define AFW_DATA_TYPE_CTYPE_Q_x500Name "afw_utf8_t"

/** @brief Adaptive string value for "x500Name". */
AFW_DECLARE_CONST_DATA(afw_value_t *)
afw_data_type_x500Name_id_value;

/** @brief Data type struct for x500Name. */
AFW_DECLARE_CONST_DATA(afw_data_type_t *)
afw_data_type_x500Name;

/**
 * @brief Unmanaged evaluated value inf for data type x500Name.
 *
...
/**
 * @brief Managed evaluated value inf for data type x500Name.
 *
 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_managed_x500Name_inf;

/**
 * @brief Managed slice value inf for data type x500Name.
 *
 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_managed_slice_x500Name_inf;

/**
 * @brief Permanent (life of afw environment) value inf for data type x500Name.
 *
 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_permanent_x500Name_inf;

/**
 * @brief Macro to determine if data type is x500Name.
 * @param A_DATA_TYPE to test.
 * @return boolean result.
 */
#define afw_data_type_is_x500Name(A_DATA_TYPE) \
( \
    (A_DATA_TYPE) && \
    (A_DATA_TYPE) == afw_data_type_x500Name \
)

/**
 * @brief True if A_VALUE is an evaluated x500Name value.
 * @param A_VALUE to test.
 * @return boolean result.
 *
 * For evaluated values only. When true, it is safe to cast A_VALUE to
 * `const afw_value_x500Name_t *`.
 * If you want to know if the value will be x500Name when fully
 * evaluated (not necessarily cast-safe yet), use
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(A_VALUE, x500Name, xctx)` instead.
 */
#define afw_value_is_x500Name(A_VALUE) \
( \
    (A_VALUE) && \
    (A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_x500Name\
)

/**
 * @brief True if A_VALUE is an evaluated array of x500Name.
 * @param A_VALUE to test.
 * @return boolean result.
 *
 * When true, A_VALUE is an evaluated array (`const afw_value_array_t *`)
 * whose element data type is x500Name.
 */
#define afw_value_is_array_of_x500Name(A_VALUE) \
( \
    afw_value_is_array(A_VALUE) && \
    afw_array_get_data_type( \
        ((const afw_value_array_t *)(A_VALUE))->internal, \
        xctx) == afw_data_type_x500Name \
)

/**
 * @brief Convert data type x500Name string to afw_utf8_t *.
 ...
 */
AFW_DECLARE(void)
afw_data_type_x500Name_to_internal(
...
/**
 * @brief Convert data type x500Name internal representation to utf-8.
...
afw_data_type_x500Name_to_utf8(
    const afw_utf8_t * internal,
    const afw_pool_t *p,
    afw_xctx_t *xctx);

/** @brief struct for data type x500Name values. */
struct afw_value_x500Name_s {
...
/** @brief struct for managed data type x500Name values.
 *
 * This is the same as afw_value_x500Name_s with the addition of a
 * reference count. This is intended for internal use only.
 */
struct afw_value_x500Name_managed_s {
    /** @brief  Value inf union with afw_value_t pub to reduce casting needed. */
    union {
        const afw_value_inf_t *inf;
        afw_value_t pub;
...
/** @brief struct for managed slice data type x500Name values.
 *
 * A view into a containing managed value. Holds that value.
 */
struct afw_value_x500Name_managed_slice_s {
    /** @brief  Value inf union with afw_value_t pub to reduce casting needed. */
    union {
        const afw_value_inf_t *inf;
        afw_value_t pub;
    ...
    const afw_value_x500Name_managed_t *containing_value;
...
/**
 * @brief Typesafe cast to evaluated x500Name value.
 * @param value (const afw_value_t *). Evaluated if needed.
 * @return (const afw_value_x500Name_t *)
 *
 * Throws if missing or wrong type. Use ->internal for the C
 * payload, or afw_value_as_x500Name_internal().
 */
AFW_DECLARE(const afw_value_x500Name_t *)
afw_value_as_x500Name(
    const afw_value_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Typesafe peel of data type x500Name internal.
 * @param value (const afw_value_t *).
 * @return (const afw_utf8_t *)
 */
AFW_DECLARE(const afw_utf8_t *)
afw_value_as_x500Name_internal(
    const afw_value_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Allocate function for data type x500Name value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_x500Name_t with unmanaged inf set.
 *
 * Unmanaged: lifetime is pool p; no value refcount.
 * Caller fills internal after allocate.
 */
AFW_DECLARE(afw_value_x500Name_t *)
afw_value_x500Name_allocate(
    const afw_pool_t *p,
    afw_xctx_t *xctx);
#define afw_value_allocate_unmanaged_x500Name afw_value_x500Name_allocate
...
afw_value_x500Name_create_managed(
    const afw_utf8_t * internal,
    afw_xctx_t *xctx);
#define afw_value_create_managed_x500Name afw_value_x500Name_create_managed

/**
 * @brief Deep clone an evaluated x500Name value unmanaged into p.
 * @param value evaluated x500Name.
 * @param p dest pool.
 * @param xctx of caller.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_clone_x500Name_unmanaged(
    const afw_value_t *value,
    const afw_pool_t *p,
    afw_xctx_t *xctx);

/**
 * @brief Clone an evaluated x500Name value managed in xctx->p.
 * @param value evaluated x500Name.
 * @param xctx of caller.
...
/**
 * @brief Create a managed slice of a managed data type x500Name value.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_x500Name_create_managed_slice(
    const afw_value_t *containing_value,
    afw_size_t offset,
    afw_size_t len,
    afw_xctx_t *xctx);
#define afw_value_create_managed_x500Name_slice afw_value_x500Name_create_managed_slice

/**
 * @brief Create function for unmanaged data type x500Name value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_x500Name_create(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx);
#define afw_value_create_unmanaged_x500Name afw_value_x500Name_create

/**
 * @brief Get property as x500Name value.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return (const afw_value_x500Name_t *) or NULL if missing.
 *
 * Does not evaluate. Throws if present but not x500Name.
 */
#define afw_object_get_property_as_x500Name( \
    object, property_name, xctx) \
afw_object_get_property_as_x500Name_source( \
...
/**
 * @brief Get property function for data type x500Name internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_utf8_t *.
 */
#define afw_object_get_property_as_x500Name_internal( \
    object, property_name, xctx) \
afw_object_get_property_as_x500Name_internal_source( \
    object, property_name, AFW__FILE_LINE__, xctx)

/**
 * @brief Get property function for data type x500Name value.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param source_z file:line.
 * @param xctx of caller.
...
/**
 * @brief Get next property as x500Name value.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
 * @return (const afw_value_x500Name_t *) or NULL if no more.
 */
#define afw_object_get_next_property_as_x500Name( \
    object, iterator, property_name, xctx) \
afw_object_get_next_property_as_x500Name_source( \
...
/**
 * @brief Get next property function for data type x500Name internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
 * @return const afw_utf8_t *.
 */
#define afw_object_get_next_property_as_x500Name_internal( \
    object, iterator, property_name, xctx) \
afw_object_get_next_property_as_x500Name_internal_source( \
    object, iterator, property_name, AFW__FILE_LINE__, xctx)

/**
 * @brief Get next property function for data type x500Name value.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param source_z file:line.
...
/**
 * @brief Set property as x500Name value.
 * @param object of property to set.
 * @param property_name of property to set.
 * @param value to set.
 * @param xctx of caller.
 *
 * Compile-time type check for const afw_value_x500Name_t *.
 */
AFW_DECLARE(void)
afw_object_set_property_as_x500Name(
    const afw_object_t *object,
    const afw_value_t *property_name,
    const afw_value_x500Name_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Set property as x500Name internal.
 * @param object of property to set.
 * @param property_name of property to set.
...
/**
 * @brief Get next x500Name value from array of x500Name.
 * @param instance of array.
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_value_x500Name_t *) or NULL.
 *
 * Set the iterator to NULL before the first call and anytime
 * you want to start from the first value again.
 */
#define afw_array_of_x500Name_get_next( \
    array, iterator, xctx) \
    afw_array_of_x500Name_get_next_source( \
...
/**
 * @brief Get next x500Name internal from array of x500Name.
 * @param instance of array.
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_utf8_t *) or NULL.
 */
#define afw_array_of_x500Name_get_next_internal( \
    array, iterator, xctx) \
    afw_array_of_x500Name_get_next_internal_source( \
    array, iterator, AFW__FILE_LINE__, xctx)
...
/**
 * @brief Add a x500Name value to array of x500Name.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_array_of_x500Name_add(
    const afw_array_t *instance,
    const afw_value_x500Name_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Add a x500Name internal to array of x500Name.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_array_of_x500Name_add_internal(
    const afw_array_t *instance,
    const afw_utf8_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Remove a x500Name value from array of x500Name.
 * @param instance of array.
 * @param value to remove.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_array_of_x500Name_remove(
    const afw_array_t *instance,
    const afw_value_x500Name_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Remove a x500Name internal from array of x500Name.
 * @param instance of array.
 * @param value to remove.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_array_of_x500Name_remove_internal(
    const afw_array_t *instance,
    const afw_utf8_t *value,
    afw_xctx_t *xctx);
...
#endif /* __AFW_DATA_TYPE_X500NAME_BINDING_H__ */
