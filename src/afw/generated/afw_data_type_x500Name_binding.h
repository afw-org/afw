 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_referenced_x500Name_inf;

/**
 * @brief Permanent managed (life of afw environment) value inf for data type x500Name.
 *
...
/**
 * @brief Macro to determine if value is evaluated x500Name.
...
/**
 * @brief Macro to determine if value is evaluated array of x500Name.
 * @param A_VALUE to test.
 * @return boolean result.
 */
...
/**
 * @brief Allocate function for referenced data type x500Name value.
 * @param s place to put pointer to allocated memory for internal->s.
 * @param len of memory to allocate for internal->s.
 * @param xctx of caller.
 * @return Allocated afw_value_x500Name_t with appropriate inf set.
 *
...
afw_value_alloc_referenced_x500Name(
    afw_utf8_octet_t **s,
    afw_size_t len,
    afw_xctx_t *xctx);

/**
 * @brief Allocate function for unmanaged data type x500Name value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_x500Name_t with appropriate inf set.
 */
AFW_DECLARE(afw_value_x500Name_t *)
afw_value_allocate_x500Name(const afw_pool_t *p, afw_xctx_t *xctx);

/**
 * @brief Create function for referenced data type x500Name value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_referenced_x500Name(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx);

/**
 * @brief Create function for referenced data type x500Name slice value.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_referenced_x500Name_slice(
...
/**
 * @brief Create function for permanent data type x500Name value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_permanent_x500Name(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx);
