...
/* Set property from base64Binary internal via setter. */
AFW_DEFINE(void)
    ...
    afw_xctx_t *xctx)
{
    ...
    afw_object_setter_set_property_internal(setter,
        property_name, afw_data_type_base64Binary,
        internal, xctx);
}
...
afw_value_base64Binary_allocate(const afw_pool_t *p, afw_xctx_t *xctx)
{
...
/* Get property function for data type base64Binary internal. */
AFW_DEFINE(const afw_memory_t *)
...
/* Get next property function for data type base64Binary internal. */
AFW_DEFINE(const afw_memory_t *)
