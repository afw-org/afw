    ...
    afw_xctx_t *xctx)
{
    ...
    if (afw_object_is_memory_managed(object) ||
        ...
        v = afw_value_base64Binary_create_managed(internal, object->p, xctx);
    }
    else {
...
/* Clone evaluated base64Binary managed in p->managed_p. */
AFW_DEFINE(const afw_value_t *)
afw_value_clone_base64Binary_managed(
    const afw_value_t *value,
    const afw_pool_t *p,
    ...
    afw_xctx_t *xctx)
{
    ...
    if (afw_array_is_memory_managed(instance) ||
        ...
        v = afw_value_base64Binary_create_managed(value, instance->p, xctx);
    }
    else {
