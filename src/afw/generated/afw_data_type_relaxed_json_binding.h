 ...
 * @brief Adaptive data type relaxed_json header.
 */
 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_referenced_relaxed_json_inf;

/**
 * @brief Permanent managed (life of afw environment) value inf for data type relaxed_json.
 *
...
/**
 * @brief Allocate function for referenced data type relaxed_json value.
...
afw_value_alloc_referenced_relaxed_json(
    afw_utf8_octet_t **s,
    afw_size_t len,
    afw_xctx_t *xctx);
...
afw_value_allocate_relaxed_json(const afw_pool_t *p, afw_xctx_t *xctx);

/**
 * @brief Create function for referenced data type relaxed_json value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_referenced_relaxed_json(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx);

/**
 * @brief Create function for referenced data type relaxed_json slice value.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_referenced_relaxed_json_slice(
...
/**
 * @brief extern for data type relaxed_json struct.
 *
 * This should only be referenced in the linkage unit the extern is
 * defined in.  Use afw_data_type_relaxed_json when not referencing in
 * a static.
 */
...
/**
 * @brief extern for data type relaxed_json inf.
 *
 * This should only be referenced in the linkage unit the extern is
 * defined in.
 *
