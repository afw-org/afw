 ...
 */
#define afw_data_type_is_relaxed_json(A_DATA_TYPE) \
( \
    (A_DATA_TYPE) && \
    (A_DATA_TYPE) == afw_data_type_relaxed_json \
)
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(A_VALUE, relaxed_json, xctx)` instead.
 */
#define afw_value_is_relaxed_json(A_VALUE) \
( \
    (A_VALUE) && \
    (A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_relaxed_json\
)
