 ...
 */
#define afw_data_type_is_base64Binary(_A_DATA_TYPE) \
( \
    (_A_DATA_TYPE) && \
    (_A_DATA_TYPE) == afw_data_type_base64Binary \
)

/**
 * @brief True if _A_VALUE is an evaluated base64Binary value.
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(_A_VALUE, base64Binary, xctx)` instead.
 */
#define afw_value_is_base64Binary(_A_VALUE) \
( \
    (_A_VALUE) && \
    (_A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_base64Binary\
)

/**
 * @brief True if _A_VALUE is an evaluated array of base64Binary.
 * @param _A_VALUE to test.
 * @return boolean result.
 *
 ...
 */
#define afw_value_is_array_of_base64Binary(_A_VALUE) \
( \
...
/**
 * @brief Clone an evaluated base64Binary value managed in p->managed_p.
 * @param value evaluated base64Binary.
 * @param p dest pool (uses p->managed_p).
 * @param xctx of caller.
 ...
 * starts at 1 (caller must release). Header allocated in p->managed_p.
 */
AFW_DECLARE(const afw_value_t *)
...
/**
 * @brief Get property as base64Binary internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_memory_t *.
...
/**
 * @brief Get next property as base64Binary internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
