...
/**
 * @brief Typesafe cast to evaluated ia5String value.
 * @param value (const afw_value_t *). Evaluated if needed.
 * @return (const afw_value_ia5String_t *)
 *
 * Throws if missing or wrong type. Use ->internal for the C
 * payload, or afw_value_as_ia5String_internal().
 */
AFW_DECLARE(const afw_value_ia5String_t *)
afw_value_as_ia5String(
    const afw_value_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Typesafe peel of data type ia5String internal.
 * @param value (const afw_value_t *).
 * @return (const afw_utf8_t *)
 */
AFW_DECLARE(const afw_utf8_t *)
afw_value_as_ia5String_internal(
    const afw_value_t *value,
    afw_xctx_t *xctx);
...
/**
 * @brief Deep clone an evaluated ia5String value unmanaged into p.
 * @param value evaluated ia5String.
 * @param p dest pool.
 * @param xctx of caller.
...
/**
 * @brief Clone an evaluated ia5String value managed in xctx->p.
 * @param value evaluated ia5String.
 * @param xctx of caller.
 ...
 * @param xctx of caller.
 * @return (const afw_value_ia5String_t *) or NULL if missing.
 *
...
/**
 * @brief Get property function for data type ia5String internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_utf8_t *.
...
/**
 * @brief Get next property function for data type ia5String internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
...
/**
 * @brief Set property as ia5String value.
 * @param object of property to set.
 * @param property_name of property to set.
 * @param value to set.
 * @param xctx of caller.
 *
 * Compile-time type check for const afw_value_ia5String_t *.
 */
AFW_DECLARE(void)
...
/**
 * @brief Set property as ia5String internal.
 * @param object of property to set.
 * @param property_name of property to set.
 ...
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_value_ia5String_t *) or NULL.
 *
...
/**
 * @brief Add a ia5String value to array of ia5String.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Add a ia5String internal to array of ia5String.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove a ia5String value from array of ia5String.
 * @param instance of array.
...
/**
 * @brief Remove a ia5String internal from array of ia5String.
 * @param instance of array.
 * @param value to remove.
 * @param xctx of caller.
 */
