...
/**
 * @addtogroup afw_adapter_object_type_cache_impl_declares afw_adapter_object_type_cache
 * @{
 *
 ...
 * generated/interface_closet/skeleton_afw_adapter_object_type_cache.c.
 *
 * Mutiple *_impl.declares.h can be included in each c source file, but only
 * one for each interface name.
 *
 * After the #include for  afw_adapter_object_type_cache_impl_declares.h:
 *
 * 1. declarations will exist for all of the interfaces methods with names of
 *    impl_afw_adapter_object_type_cache_ followed by the method name.
 * 2. rti will be defined with a name of impl_afw_adapter_object_type_cache_rti.
 * 3. inf will be defined with a name of impl_afw_adapter_object_type_cache_inf.
 *
 ...
 *
 *   AFW_IMPLEMENTATION_INF_LABEL - (optional) defaults to 'impl_afw_adapter_object_type_cache_inf'.
 *
 *   AFW_ADAPTER_OBJECT_TYPE_CACHE_SELF_T - (optional) defaults to 'const afw_adapter_object_type_cache_t'.
 ...
 *
 * A second #include "afw_adapter_object_type_cache_impl_declares.h" can be specified if
" *   #define "AFW_ADAPTER_OBJECT_TYPE_CACHE_INF_ONLY" is specified to generate inf only."
 *~~~~~~~~~~~~~~~
 */
...
#ifndef AFW_ADAPTER_OBJECT_TYPE_CACHE_INF_ONLY
#error "afw_adapter_object_type_cache_impl_declares.h already included."
#endif
#endif
#ifndef __AFW_ADAPTER_OBJECT_TYPE_CACHE_IMPL_DECLARES_H__
#ifdef AFW_ADAPTER_OBJECT_TYPE_CACHE_INF_ONLY
#error "afw_adapter_object_type_cache_impl_declares.h must be included before AFW_ADAPTER_OBJECT_TYPE_CACHE_INF_ONLY."
#endif
#define __AFW_ADAPTER_OBJECT_TYPE_CACHE_IMPL_DECLARES_H__ 1
#endif
...
#ifndef AFW_ADAPTER_OBJECT_TYPE_CACHE_SELF_T
#define AFW_ADAPTER_OBJECT_TYPE_CACHE_SELF_T const afw_adapter_object_type_cache_t
#endif

#ifndef AFW_ADAPTER_OBJECT_TYPE_CACHE_INF_ONLY

#ifndef impl_afw_adapter_object_type_cache_get
/* Declare method get */
...
#ifndef impl_afw_adapter_object_type_cache_set
/* Declare method set */
...
/* inf for interface afw_adapter_object_type_cache */
#ifdef __BASE_FILE__
...
AFW_IMPLEMENTATION_INF_SPECIFIER(afw_adapter_object_type_cache_inf_t)
#else
static const afw_adapter_object_type_cache_inf_t
#endif
...
#endif
    {
        AFW_UTF8_LITERAL("afw_adapter_object_type_cache"),
