...
/**
 * @addtogroup afw_c_api_data_type_double double
 *
 * Adaptive Data Type double
 *
 * @{
...
/**
 * @brief Permanent managed (life of afw environment) value inf for data type double.
 *
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_double\
)

/**
 * @brief Macro to determine if value is evaluated list of double.
 * @param A_VALUE to test.
 * @return boolean result.
 */
...
/**
 * @brief Allocate function for unmanaged data type double value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_double_t with appropriate inf set.
 */
 ...
 */
AFW_DECLARE(afw_value_double_t *)
afw_value_allocate_managed_double(const afw_pool_t *p, afw_xctx_t *xctx);
...
/**
 * @brief Allocate function for permanent data type double value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_double_t with appropriate inf set.
 */
...
/**
 * @brief Create function for permanent data type double value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
...
/* Data type double not yet supported for some functions. */
...
/**
 * @brief Get next value from list of double.
 ...
 */
#define afw_list_of_double_get_next( \
    list, iterator, found, xctx) \
    afw_list_of_double_get_next_source( \
...
/**
 * @brief Add value from list of double.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_list_of_double_add(
    const afw_list_t *instance,
    const double *value,
    afw_xctx_t *xctx);

/**
 * @brief Remove value from list of double.
 * @param instance of list.
 * @param value to remove.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_list_of_double_remove(
    const afw_list_t *instance,
    const double *value,
    afw_xctx_t *xctx);
