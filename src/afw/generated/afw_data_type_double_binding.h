 ...
 */
#define afw_data_type_is_double(_A_DATA_TYPE) \
( \
    (_A_DATA_TYPE) && \
    (_A_DATA_TYPE) == afw_data_type_double \
)

/**
 * @brief True if _A_VALUE is an evaluated double value.
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(_A_VALUE, double, xctx)` instead.
 */
#define afw_value_is_double(_A_VALUE) \
( \
    (_A_VALUE) && \
    (_A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_double\
)

/**
 * @brief True if _A_VALUE is an evaluated array of double.
 * @param _A_VALUE to test.
 * @return boolean result.
 *
 ...
 */
#define afw_value_is_array_of_double(_A_VALUE) \
( \
...
/**
 * @brief Clone an evaluated double value managed in p->managed_p.
 * @param value evaluated double.
 * @param p dest pool (uses p->managed_p).
 * @param xctx of caller.
...
#define afw_object_get_property_as_double_internal( \
    _object, _property_name, _found, _xctx) \
afw_object_get_property_as_double_internal_source( \
    _object, _property_name, _found, AFW__FILE_LINE__, _xctx)
...
#define afw_object_get_next_property_as_double_internal( \
    _object, _iterator, _property_name, _found, _xctx) \
afw_object_get_next_property_as_double_internal_source( \
    _object, _iterator, _property_name, _found, AFW__FILE_LINE__, _xctx)
...
#define afw_array_of_double_get_next_internal( \
    _array, _iterator, _found, _xctx) \
    afw_array_of_double_get_next_internal_source( \
    _array, _iterator, _found, AFW__FILE_LINE__, _xctx)
