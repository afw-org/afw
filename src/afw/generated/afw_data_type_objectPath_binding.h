 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_referenced_objectPath_inf;

/**
 * @brief Permanent managed (life of afw environment) value inf for data type objectPath.
 *
...
/**
 * @brief Macro to determine if value is evaluated objectPath.
...
/**
 * @brief Macro to determine if value is evaluated array of objectPath.
 * @param A_VALUE to test.
 * @return boolean result.
 */
...
/**
 * @brief Allocate function for referenced data type objectPath value.
...
afw_value_alloc_referenced_objectPath(
    afw_utf8_octet_t **s,
    afw_size_t len,
    afw_xctx_t *xctx);
...
/**
 * @brief Create function for referenced data type objectPath value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_referenced_objectPath(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx);

/**
 * @brief Create function for referenced data type objectPath slice value.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_referenced_objectPath_slice(
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_objectPath_unmanaged(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx);

/**
 * @brief Create function for permanent data type objectPath value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_permanent_objectPath(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx);
