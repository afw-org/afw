...
/**
 * @addtogroup afw_c_api_data_type_objectPath objectPath
 *
 * Adaptive Data Type objectPath
 *
 * @{
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_objectPath\
)

/**
 * @brief Macro to determine if value is evaluated list of objectPath.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_objectPath(A_VALUE) \
( \
...
/**
 * @brief Get next value from list of objectPath.
 ...
 */
#define afw_list_of_objectPath_get_next( \
    list, iterator, xctx) \
    afw_list_of_objectPath_get_next_source( \
...
/**
 * @brief Add value from list of objectPath.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_list_of_objectPath_add(
    const afw_list_t *instance,
    const afw_utf8_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Remove value from list of objectPath.
 * @param instance of list.
 * @param value to remove.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_list_of_objectPath_remove(
    const afw_list_t *instance,
    const afw_utf8_t *value,
    afw_xctx_t *xctx);
