...
/* This is the inf for unmanaged objectId values. For this one */
/* optional_release is NULL and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "objectId"
#define AFW_IMPLEMENTATION_INF_SPECIFIER AFW_DEFINE_CONST_DATA
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_evaluated_objectId_inf
...
afw_data_type_objectId_direct = {
    ...
    sizeof(afw_utf8_t),
    (const afw_list_t *)&impl_empty_list_of_objectId,
    (const afw_value_t *)&impl_value_empty_list_of_objectId,
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_objectId(internal, object->p, xctx);
...
/* Allocate function for unmanaged data type objectId values. */
...
afw_value_allocate_objectId(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_objectId_t),
        xctx);
    result->inf = &afw_value_evaluated_objectId_inf;
    return result;
}
...
/* Allocate function for managed data type objectId values. */
AFW_DEFINE(afw_value_objectId_t *)
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_managed_objectId(p, xctx);
    if (internal) {
        memcpy(&v->internal, internal, sizeof(afw_utf8_t));
    }
    return (const afw_value_t *)v;
...
/* Allocate function for permanent data type objectId values. */
AFW_DEFINE(afw_value_objectId_t *)
afw_value_allocate_permanent_objectId(const afw_pool_t *p, afw_xctx_t *xctx)
{
    afw_value_objectId_t *result;

    result = afw_pool_calloc(p, sizeof(afw_value_objectId_t),
        xctx);
    result->inf = &afw_value_permanent_objectId_inf;
    return result;
}
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_permanent_objectId(p, xctx);
    if (internal) {
        memcpy(&v->internal, internal, sizeof(afw_utf8_t));
    }
    return (const afw_value_t *)v;
    ...
    afw_xctx_t *xctx)
{
    ...
    info->optimized_value_data_type = afw_data_type_objectId;
}


/* Get next value from list of objectId. */
AFW_DEFINE(const afw_utf8_t *)
afw_list_of_objectId_get_next_source(
...
/* Add value from list of objectId */
AFW_DEFINE(void)
afw_list_of_objectId_add(
    const afw_list_t *instance,
...
/* Remove value from list of objectId */
AFW_DEFINE(void)
afw_list_of_objectId_remove(
    const afw_list_t *instance,
    const afw_utf8_t *value,
    afw_xctx_t *xctx)
{
