...
/* Get property function for data type objectId values. */
AFW_DEFINE(const afw_utf8_t *)
    ...
    afw_xctx_t *xctx)
{
    ...
    return &(((const afw_value_objectId_t *)value)->internal);
}

/* Get next property function for data type objectId values. */
AFW_DEFINE(const afw_utf8_t *)
