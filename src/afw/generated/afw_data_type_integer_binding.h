...
/**
 * @brief True if A_VALUE is an evaluated integer value.
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(A_VALUE, integer, xctx)` instead.
 */
...
/**
 * @brief True if A_VALUE is an evaluated array of integer.
 * @param A_VALUE to test.
 * @return boolean result.
 *
