...
/**
 * @addtogroup afw_c_api_data_type_integer integer
 *
 * Adaptive Data Type integer
 *
 * @{
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_integer\
)

/**
 * @brief Macro to determine if value is evaluated list of integer.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_integer(A_VALUE) \
( \
...
/**
 * @brief Get next value from list of integer.
 ...
 */
#define afw_list_of_integer_get_next( \
...
/**
 * @brief Add value from list of integer.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of integer.
 * @param instance of list.
