...
/* unmanaged objectPath: get_reference/release throw; */
...
/* Declares and rti/inf defines for interface afw_value */
/* managed objectPath: optional_release drops RC; */
...
/* Declares and rti/inf defines for interface afw_value */
/* managed_slice objectPath: own RC; holds containing; */
...
/* Permanent empty array of objectPath. */
const afw_array_from_values_self_t
impl_empty_array_of_objectPath;

/* Permanent empty array value of objectPath. */
...
/* Set property from objectPath value. */
AFW_DEFINE(void)
...
/* Set property from objectPath internal. */
AFW_DEFINE(void)
    ...
    afw_xctx_t *xctx)
{
    ...
    if (afw_object_is_memory_managed(object) ||
        ...
        v = afw_value_objectPath_create_managed(internal, xctx);
    }
    else {
...
/* Typesafe cast to evaluated objectPath value. */
AFW_DEFINE(const afw_value_objectPath_t *)
afw_value_as_objectPath(const afw_value_t *value, afw_xctx_t *xctx)
{
    ...
    return (const afw_value_objectPath_t *)value;
}

/* Typesafe peel of data type objectPath internal. */
AFW_DEFINE(const afw_utf8_t *)
afw_value_as_objectPath_internal(const afw_value_t *value, afw_xctx_t *xctx)
{
    return &afw_value_as_objectPath(value, xctx)->internal;
}
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_pool_calloc(xctx->p, sizeof(afw_value_objectPath_managed_slice_t), xctx);
...
/* Deep clone evaluated objectPath unmanaged into p. */
AFW_DEFINE(const afw_value_t *)
afw_value_clone_objectPath_unmanaged(
    ...
    afw_xctx_t *xctx)
{
    ...
    if (value->inf == &afw_value_permanent_objectPath_inf) {
        return value;
    }
    cloned = afw_value_common_allocate(
        afw_data_type_objectPath, p, xctx);
    afw_data_type_clone_internal(afw_data_type_objectPath,
        (void *)&cloned->internal,
        (const void *)&((const afw_value_objectPath_t *)value)->internal,
        p, xctx);
    return &cloned->pub;
}

/* Clone evaluated objectPath managed in xctx->p. */
AFW_DEFINE(const afw_value_t *)
afw_value_clone_objectPath_managed(
    const afw_value_t *value,
    afw_xctx_t *xctx)
{
    ...
    return afw_value_objectPath_create_managed(
        &((const afw_value_objectPath_t *)value)->internal,
        xctx);
}
...
/* Get property as objectPath value. */
AFW_DEFINE(const afw_value_objectPath_t *)
...
/* Get property function for data type objectPath internal. */
AFW_DEFINE(const afw_utf8_t *)
    ...
    afw_xctx_t *xctx)
{
    ...
    value = afw_object_get_property_as_objectPath_source(object, property_name, source_z, xctx);
    if (!value) {
        return NULL;
    }
...
/* Get next property as objectPath value. */
AFW_DEFINE(const afw_value_objectPath_t *)
...
/* Get next property function for data type objectPath internal. */
AFW_DEFINE(const afw_utf8_t *)
    ...
    afw_xctx_t *xctx)
{
    ...
    value = afw_object_get_next_property_as_objectPath_source(object, iterator, property_name, source_z, xctx);
    if (!value) {
        return NULL;
    }
    return &value->internal;
...
/* Get next objectPath value from array of objectPath. */
AFW_DEFINE(const afw_value_objectPath_t *)
...
/* Get next objectPath internal from array of objectPath. */
AFW_DEFINE(const afw_utf8_t *)
    ...
    afw_xctx_t *xctx)
{
    ...
    value = afw_array_of_objectPath_get_next_source(instance, iterator, source_z, xctx);
    if (!value) {
        return NULL;
    }
    return &value->internal;
...
/* Add a objectPath value to array of objectPath. */
AFW_DEFINE(void)
...
/* Add a objectPath internal to array of objectPath. */
AFW_DEFINE(void)
    ...
    afw_xctx_t *xctx)
{
    ...
    if (afw_array_is_memory_managed(instance) ||
        ...
        v = afw_value_objectPath_create_managed(value, xctx);
    }
    else {
        v = afw_value_objectPath_create(value, instance->p, xctx);
    }
    afw_array_push_value(instance, v, xctx);
}

/* Remove a objectPath value from array of objectPath. */
AFW_DEFINE(void)
afw_array_of_objectPath_remove(
    ...
    afw_xctx_t *xctx)
{
    afw_array_of_objectPath_remove_internal(instance, &value->internal, xctx);
}

/* Remove a objectPath internal from array of objectPath. */
AFW_DEFINE(void)
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_objectPath_create(value, xctx->p, xctx);
