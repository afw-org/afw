...
/**
 * @addtogroup afw_c_api_data_type_time time
 *
 * Adaptive Data Type time
 *
 * @{
...
/**
 * @brief Macro to determine if value is evaluated list of time.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_time(A_VALUE) \
( \
...
/**
 * @brief Allocate function for managed data type time value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_time_t with appropriate inf set.
 */
...
/**
 * @brief Allocate function for permanent data type time value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_time_t with appropriate inf set.
 */
...
/**
 * @brief Get next value from list of time.
 ...
 */
#define afw_list_of_time_get_next( \
    list, iterator, xctx) \
...
/**
 * @brief Add value from list of time.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of time.
 * @param instance of list.
