...
/* unmanaged x500Name: optional_release NULL; */
...
/* Declares and rti/inf defines for interface afw_value */
/* managed x500Name: optional_release frees header at RC 0; */
...
/* Declares and rti/inf defines for interface afw_value */
/* managed_slice x500Name: RC on containing managed value; */
    ...
    afw_xctx_t *xctx)
{
    ...
    (void)p;
    boxed = afw_value_create_managed_x500Name(
        &self->internal, xctx);
