...
/* This is the inf for unmanaged x500Name values. For this one */
/* optional_release is NULL and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "x500Name"
#define AFW_IMPLEMENTATION_INF_SPECIFIER AFW_DEFINE_CONST_DATA
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_evaluated_x500Name_inf
...
afw_data_type_x500Name_direct = {
    ...
    sizeof(afw_utf8_t),
    (const afw_list_t *)&impl_empty_list_of_x500Name,
    (const afw_value_t *)&impl_value_empty_list_of_x500Name,
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_x500Name(internal, object->p, xctx);
...
/* Allocate function for unmanaged data type x500Name values. */
...
afw_value_allocate_x500Name(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_x500Name_t),
        xctx);
    result->inf = &afw_value_evaluated_x500Name_inf;
    return result;
}

/* Create function for unmanaged data type x500Name value. */
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_managed_x500Name(p, xctx);
    if (internal) {
        memcpy(&v->internal, internal, sizeof(afw_utf8_t));
    }
    return (const afw_value_t *)v;
...
afw_value_allocate_permanent_x500Name(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_x500Name_t),
        xctx);
    result->inf = &afw_value_permanent_x500Name_inf;
    return result;
}
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_permanent_x500Name(p, xctx);
    if (internal) {
        memcpy(&v->internal, internal, sizeof(afw_utf8_t));
    }
    return (const afw_value_t *)v;
    ...
    afw_xctx_t *xctx)
{
    ...
    info->optimized_value_data_type = afw_data_type_x500Name;
}


/* Get next value from list of x500Name. */
AFW_DEFINE(const afw_utf8_t *)
...
/* Add value from list of x500Name */
AFW_DEFINE(void)
...
/* Remove value from list of x500Name */
AFW_DEFINE(void)
