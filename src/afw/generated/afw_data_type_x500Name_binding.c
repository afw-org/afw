...
/* This is the inf for x500Name values. For this one */
...
/* Declares and rti/inf defines for interface afw_value */
/* This is the inf for managed x500Name values. For this one */
...
/* Declares and rti/inf defines for interface afw_value */
/* This is the inf for managed_slice x500Name values. */
...
/* Declares and rti/inf defines for interface afw_value */
/* This is the inf for permanent x500Name values. For this one */
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_unmanaged_x500Name(internal, object->p, xctx);
    afw_object_set_property(object, property_name, v, xctx);
}

/* Typesafe cast of data type x500Name. */
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_xctx_calloc(sizeof(afw_value_x500Name_managed_slice_t), xctx);
    v->inf = &afw_value_managed_slice_x500Name_inf;
    v->internal.s = base->s + offset;
    v->internal.len = len;
    v->containing_value = containing;
    ((afw_value_x500Name_managed_t *)containing)->reference_count++;
    return &v->pub;
}
    ...
    afw_xctx_t *xctx)
{
    ...
    afw_value_x500Name_managed_t *containing =
        (afw_value_x500Name_managed_t *)self->containing_value;
...
impl_afw_value_managed_slice_get_reference(
    ...
    afw_xctx_t *xctx)
{
    const afw_value_x500Name_managed_slice_t *self =
        (const afw_value_x500Name_managed_slice_t *)instance;
    afw_value_x500Name_managed_t *containing =
        (afw_value_x500Name_managed_t *)self->containing_value;
    afw_value_x500Name_managed_slice_t *v;
...
/* Get next value from array of x500Name. */
AFW_DEFINE(const afw_utf8_t *)
    ...
    afw_xctx_t *xctx)
{
    ...
    if (data_type != afw_data_type_x500Name) {
        const afw_utf8_t *data_type_id;
...
/* Add value from array of x500Name */
AFW_DEFINE(void)
...
/* Remove value from array of x500Name */
AFW_DEFINE(void)
