...
/**
 * @addtogroup afw_c_api_data_type_dnsName dnsName
 *
 * Adaptive Data Type dnsName
 *
 * @{
...
/**
 * @brief Permanent managed (life of afw environment) value inf for data type dnsName.
 *
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_dnsName\
)

/**
 * @brief Macro to determine if value is evaluated list of dnsName.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_dnsName(A_VALUE) \
( \
...
/**
 * @brief Allocate function for permanent data type dnsName value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_dnsName_t with appropriate inf set.
 */
AFW_DECLARE(afw_value_dnsName_t *)
afw_value_allocate_permanent_dnsName(const afw_pool_t *p, afw_xctx_t *xctx);
...
/**
 * @brief Get next value from list of dnsName.
 ...
 */
#define afw_list_of_dnsName_get_next( \
    list, iterator, xctx) \
    afw_list_of_dnsName_get_next_source( \
...
/**
 * @brief Add value from list of dnsName.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_list_of_dnsName_add(
    const afw_list_t *instance,
    const afw_utf8_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Remove value from list of dnsName.
 * @param instance of list.
 * @param value to remove.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_list_of_dnsName_remove(
    const afw_list_t *instance,
    const afw_utf8_t *value,
    afw_xctx_t *xctx);
