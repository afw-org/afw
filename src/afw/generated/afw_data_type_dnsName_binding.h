 ...
 */
#define afw_data_type_is_dnsName(A_DATA_TYPE) \
( \
    (A_DATA_TYPE) && \
    (A_DATA_TYPE) == afw_data_type_dnsName \
)
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_dnsName\
)
...
/**
 * @brief Clone an evaluated dnsName value managed in xctx->p.
 * @param value evaluated dnsName.
 * @param xctx of caller.
...
/**
 * @brief Get property function for data type dnsName internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_utf8_t *.
...
/**
 * @brief Get property function for data type dnsName value.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param source_z file:line.
 * @param xctx of caller.
...
/**
 * @brief Get next property function for data type dnsName internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
...
/**
 * @brief Get next property function for data type dnsName value.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param source_z file:line.
