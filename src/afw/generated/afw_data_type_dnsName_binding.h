...
#ifndef __AFW_DATA_TYPE_DNSNAME_BINDING_H__
#define __AFW_DATA_TYPE_DNSNAME_BINDING_H__
...
/**
 * @defgroup afw_c_api_data_type_dnsName dnsName
...
/** @brief Quoted data type id for dnsName */
#define AFW_DATA_TYPE_ID_Q_dnsName "dnsName"

/** @brief Unquoted data type id for dnsName */
#define AFW_DATA_TYPE_ID_U_dnsName dnsName

/** @brief String for data type id dnsName */
#define AFW_DATA_TYPE_ID_S_dnsName afw_s_dnsName

/** @brief Quoted c type for data type id dnsName */
#define AFW_DATA_TYPE_CTYPE_Q_dnsName "afw_utf8_t"

/** @brief Adaptive string value for "dnsName". */
AFW_DECLARE_CONST_DATA(afw_value_t *)
afw_data_type_dnsName_id_value;

/** @brief Data type struct for dnsName. */
AFW_DECLARE_CONST_DATA(afw_data_type_t *)
afw_data_type_dnsName;

/**
 * @brief Unmanaged evaluated value inf for data type dnsName.
 *
 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_managed_dnsName_inf;

/**
 * @brief Managed slice value inf for data type dnsName.
 *
 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_managed_slice_dnsName_inf;

/**
 * @brief Permanent (life of afw environment) value inf for data type dnsName.
 *
 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_permanent_dnsName_inf;

/**
 * @brief Macro to determine if data type is dnsName.
 * @param _A_DATA_TYPE to test.
 * @return boolean result.
 */
#define afw_data_type_is_dnsName(_A_DATA_TYPE) \
( \
    (_A_DATA_TYPE) && \
    (_A_DATA_TYPE) == afw_data_type_dnsName \
)

/**
 * @brief True if _A_VALUE is an evaluated dnsName value.
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(_A_VALUE, dnsName, xctx)` instead.
 */
#define afw_value_is_dnsName(_A_VALUE) \
( \
    (_A_VALUE) && \
    (_A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_dnsName\
)

/**
 * @brief True if _A_VALUE is an evaluated array of dnsName.
 * @param _A_VALUE to test.
 * @return boolean result.
 *
 ...
 */
#define afw_value_is_array_of_dnsName(_A_VALUE) \
( \
    afw_value_is_array(_A_VALUE) && \
    afw_array_get_data_type( \
        ((const afw_value_array_t *)(_A_VALUE))->internal, \
        xctx) == afw_data_type_dnsName \
)

/**
 * @brief Convert data type dnsName string to afw_utf8_t *.
 ...
 */
AFW_DECLARE(void)
afw_data_type_dnsName_to_internal(
...
/**
 * @brief Convert data type dnsName internal representation to utf-8.
...
afw_data_type_dnsName_to_utf8(
    const afw_utf8_t * internal,
    const afw_pool_t *p,
    afw_xctx_t *xctx);

/** @brief struct for data type dnsName values. */
struct afw_value_dnsName_s {
...
/** @brief struct for managed data type dnsName values.
 *
 * This is the same as afw_value_dnsName_s with the addition of a
 * reference count. This is intended for internal use only.
 */
struct afw_value_dnsName_managed_s {
    /** @brief  Value inf union with afw_value_t pub to reduce casting needed. */
    union {
        const afw_value_inf_t *inf;
        afw_value_t pub;
...
/** @brief struct for managed slice data type dnsName values.
 *
 * A view into a containing managed value. Holds that value.
 */
struct afw_value_dnsName_managed_slice_s {
    /** @brief  Value inf union with afw_value_t pub to reduce casting needed. */
    union {
        const afw_value_inf_t *inf;
        afw_value_t pub;
...
/**
 * @brief Typesafe cast to evaluated dnsName value.
 * @param value (const afw_value_t *). Evaluated if needed.
 * @return (const afw_value_dnsName_t *)
 *
 * Throws if missing or wrong type. Use ->internal for the C
 * payload, or afw_value_as_dnsName_internal().
 */
AFW_DECLARE(const afw_value_dnsName_t *)
afw_value_as_dnsName(
    const afw_value_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Typesafe peel of data type dnsName internal.
 * @param value (const afw_value_t *).
 * @return (const afw_utf8_t *)
 */
AFW_DECLARE(const afw_utf8_t *)
afw_value_as_dnsName_internal(
    const afw_value_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Allocate function for data type dnsName value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_dnsName_t with unmanaged inf set.
 *
 * Unmanaged: lifetime is pool p; no value refcount.
 * Caller fills internal after allocate.
 */
AFW_DECLARE(afw_value_dnsName_t *)
afw_value_dnsName_allocate(
    const afw_pool_t *p,
    afw_xctx_t *xctx);
#define afw_value_allocate_unmanaged_dnsName afw_value_dnsName_allocate

/**
 * @brief Create function for managed data type dnsName value.
 * @param internal.
...
afw_value_dnsName_create_managed(
    ...
    const afw_pool_t *p,
    afw_xctx_t *xctx);
#define afw_value_create_managed_dnsName afw_value_dnsName_create_managed

/**
 * @brief Deep clone an evaluated dnsName value unmanaged into p.
 * @param value evaluated dnsName.
 * @param p dest pool.
 * @param xctx of caller.
...
/**
 * @brief Clone an evaluated dnsName value managed in p->managed_p.
 * @param value evaluated dnsName.
 * @param p dest pool (uses p->managed_p).
 * @param xctx of caller.
...
/**
 * @brief Create a managed slice of a managed data type dnsName value.
...
afw_value_dnsName_create_managed_slice(
    ...
    const afw_pool_t *p,
    afw_xctx_t *xctx);
#define afw_value_create_managed_dnsName_slice afw_value_dnsName_create_managed_slice

/**
 * @brief Create function for unmanaged data type dnsName value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
...
#define afw_value_create_unmanaged_dnsName afw_value_dnsName_create

/**
 * @brief Get property as dnsName value.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return (const afw_value_dnsName_t *) or NULL if missing.
 *
 * Does not evaluate. Throws if present but not dnsName.
 */
#define afw_object_get_property_as_dnsName( \
...
/**
 * @brief Get property as dnsName internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_utf8_t *.
 */
#define afw_object_get_property_as_dnsName_internal( \
    _object, _property_name, _xctx) \
...
/**
 * @brief Get next property as dnsName value.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
 * @return (const afw_value_dnsName_t *) or NULL if no more.
 */
#define afw_object_get_next_property_as_dnsName( \
...
/**
 * @brief Get next property as dnsName internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
 * @return const afw_utf8_t *.
 */
#define afw_object_get_next_property_as_dnsName_internal( \
    _object, _iterator, _property_name, _xctx) \
...
/**
 * @brief Set property as dnsName value.
 * @param object of property to set.
 * @param property_name of property to set.
 * @param value to set.
 * @param xctx of caller.
 *
 * Compile-time type check for const afw_value_dnsName_t *.
 */
AFW_DECLARE(void)
...
/**
 * @brief Set property as dnsName internal.
 * @param object of property to set.
 * @param property_name of property to set.
...
/**
 * @brief Get next dnsName value from array of dnsName.
 * @param instance of array.
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_value_dnsName_t *) or NULL.
 *
 * Set the iterator to NULL before the first call and anytime
 * you want to start from the first value again.
 */
#define afw_array_of_dnsName_get_next( \
...
/**
 * @brief Get next dnsName internal from array of dnsName.
 * @param instance of array.
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_utf8_t *) or NULL.
 */
#define afw_array_of_dnsName_get_next_internal( \
    _array, _iterator, _xctx) \
...
/**
 * @brief Add a dnsName value to array of dnsName.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Add a dnsName internal to array of dnsName.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove a dnsName value from array of dnsName.
 * @param instance of array.
...
/**
 * @brief Remove a dnsName internal from array of dnsName.
 * @param instance of array.
 * @param value to remove.
 * @param xctx of caller.
 */
...
/**
 * @brief Public data type dnsName struct instance.
 *
 * Prefer afw_data_type_dnsName when a pointer is enough and you are not
...
/**
 * @brief Public data type dnsName inf.
 *
...
#endif /* __AFW_DATA_TYPE_DNSNAME_BINDING_H__ */
