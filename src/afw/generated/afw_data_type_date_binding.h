 ...
 */
#define afw_data_type_is_date(_A_DATA_TYPE) \
( \
    (_A_DATA_TYPE) && \
    (_A_DATA_TYPE) == afw_data_type_date \
)

/**
 * @brief True if _A_VALUE is an evaluated date value.
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(_A_VALUE, date, xctx)` instead.
 */
#define afw_value_is_date(_A_VALUE) \
( \
    (_A_VALUE) && \
    (_A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_date\
)

/**
 * @brief True if _A_VALUE is an evaluated array of date.
 * @param _A_VALUE to test.
 * @return boolean result.
 *
 ...
 */
#define afw_value_is_array_of_date(_A_VALUE) \
( \
...
/**
 * @brief Clone an evaluated date value managed in p->managed_p.
 * @param value evaluated date.
 * @param p dest pool (uses p->managed_p).
 * @param xctx of caller.
...
/**
 * @brief Get property as date value.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return (const afw_value_date_t *) or NULL if missing.
 *
 * Does not evaluate. Throws if present but not date.
 */
...
/**
 * @brief Get property as date internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_date_t *.
...
/**
 * @brief Get next property as date internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
...
/**
 * @brief Set property as date value.
 * @param object of property to set.
 * @param property_name of property to set.
 * @param value to set.
 * @param xctx of caller.
 *
 * Compile-time type check for const afw_value_date_t *.
 */
AFW_DECLARE(void)
...
/**
 * @brief Set property as date internal.
 * @param object of property to set.
 * @param property_name of property to set.
...
/**
 * @brief Get next date value from array of date.
 * @param instance of array.
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_value_date_t *) or NULL.
 *
...
/**
 * @brief Get next date internal from array of date.
 * @param instance of array.
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_date_t *) or NULL.
 */
#define afw_array_of_date_get_next_internal( \
    _array, _iterator, _xctx) \
    afw_array_of_date_get_next_internal_source( \
    _array, _iterator, AFW__FILE_LINE__, _xctx)
...
/**
 * @brief Add a date value to array of date.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Add a date internal to array of date.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_array_of_date_add_internal(
    const afw_array_t *instance,
    const afw_date_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Remove a date value from array of date.
 * @param instance of array.
...
/**
 * @brief Remove a date internal from array of date.
 * @param instance of array.
 * @param value to remove.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_array_of_date_remove_internal(
    const afw_array_t *instance,
    const afw_date_t *value,
    afw_xctx_t *xctx);
