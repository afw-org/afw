...
/**
 * @addtogroup afw_c_api_data_type_hexBinary hexBinary
 *
 * Adaptive Data Type hexBinary
 *
 * @{
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_hexBinary\
)

/**
 * @brief Macro to determine if value is evaluated list of hexBinary.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_hexBinary(A_VALUE) \
( \
...
/**
 * @brief Allocate function for permanent data type hexBinary value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_hexBinary_t with appropriate inf set.
 */
...
/**
 * @brief Get next value from list of hexBinary.
 ...
 */
#define afw_list_of_hexBinary_get_next( \
    list, iterator, xctx) \
...
/**
 * @brief Add value from list of hexBinary.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of hexBinary.
 * @param instance of list.
