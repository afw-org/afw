...
/**
 * @addtogroup afw_c_api_data_type_string string
 *
 * Adaptive Data Type string
 *
 * @{
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_string\
)

/**
 * @brief Macro to determine if value is evaluated list of string.
 * @param A_VALUE to test.
 * @return boolean result.
 */
...
/**
 * @brief Get next value from list of string.
 ...
 */
#define afw_list_of_string_get_next( \
    list, iterator, xctx) \
...
/**
 * @brief Add value from list of string.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of string.
 * @param instance of list.
