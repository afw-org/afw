 ...
 */
#define afw_data_type_is_template(A_DATA_TYPE) \
( \
    (A_DATA_TYPE) && \
    (A_DATA_TYPE) == afw_data_type_template \
)
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(A_VALUE, template, xctx)` instead.
 */
...
/**
 * @brief Clone an evaluated template value managed in xctx->p.
 * @param value evaluated template.
 * @param xctx of caller.
...
/**
 * @brief Get property function for data type template internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_utf8_t *.
...
/**
 * @brief Get next property function for data type template internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
