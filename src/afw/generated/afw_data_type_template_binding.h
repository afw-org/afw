...
/**
 * @addtogroup afw_c_api_data_type_template template
 *
 * Adaptive Data Type template
 *
 * @{
...
/**
 * @brief Permanent managed (life of afw environment) value inf for data type template.
 *
...
/**
 * @brief Macro to determine if value is evaluated list of template.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_template(A_VALUE) \
( \
...
/**
 * @brief Allocate function for unmanaged data type template value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_template_t with appropriate inf set.
 */
...
/**
 * @brief Allocate function for managed data type template value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_template_t with appropriate inf set.
 */
...
/**
 * @brief Allocate function for permanent data type template value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_template_t with appropriate inf set.
 */
...
/**
 * @brief Create function for permanent data type template value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
...
/**
 * @brief Get next value from list of template.
 ...
 */
#define afw_list_of_template_get_next( \
    list, iterator, xctx) \
...
/**
 * @brief Add value from list of template.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of template.
 * @param instance of list.
...
/**
 * @brief extern for data type template struct.
 *
 * This should only be referenced in the linkage unit the extern is
 * defined in.  Use afw_data_type_template when not referencing in
 * a static.
 */
...
/**
 * @brief extern for data type template inf.
 *
 * This should only be referenced in the linkage unit the extern is
 * defined in.
 *
