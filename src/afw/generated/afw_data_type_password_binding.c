    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_unmanaged_password(internal, object->p, xctx);
...
afw_value_allocate_unmanaged_password(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    afw_xctx_t *xctx)
{
    ...
    (void)p;
    boxed = afw_value_create_managed_password(
        &self->internal, xctx);
