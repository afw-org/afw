...
/* Declares and rti/inf defines for interface afw_value */
/* This is the inf for referenced password values. For this one */
/* optional_release releases value and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "referenced_password"
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_referenced_password_inf
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_password_unmanaged(internal, object->p, xctx);
...
/* Create function for referenced data type password value. */
AFW_DEFINE(const afw_value_t *)
afw_value_create_referenced_password(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_pool_calloc(p, sizeof(afw_value_password_t),
        xctx);
    v->inf = &afw_value_referenced_password_inf;
    if (internal) {
...
/* Create function for referenced data type password slice value. */
AFW_DEFINE(const afw_value_t *)
afw_value_create_referenced_password_slice(
...
AFW_DEFINE(const afw_value_t *)
afw_value_create_password_unmanaged(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    afw_value_password_t *v;
