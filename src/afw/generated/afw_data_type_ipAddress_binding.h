...
/**
 * @brief Allocate function for managed data type ipAddress value.
...
afw_value_allocate_managed_ipAddress(
    afw_utf8_octet_t **s,
    afw_size_t len,
    afw_xctx_t *xctx);
...
/**
 * @brief Create function for managed data type ipAddress slice value.
...
/**
 * @brief Create function for permanent data type ipAddress value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
