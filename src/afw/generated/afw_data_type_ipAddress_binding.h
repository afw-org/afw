...
/**
 * @addtogroup afw_c_api_data_type_ipAddress ipAddress
 *
 * Adaptive Data Type ipAddress
 *
 * @{
...
/**
 * @brief Permanent managed (life of afw environment) value inf for data type ipAddress.
 *
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_ipAddress\
)

/**
 * @brief Macro to determine if value is evaluated list of ipAddress.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_ipAddress(A_VALUE) \
( \
...
/**
 * @brief Allocate function for permanent data type ipAddress value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_ipAddress_t with appropriate inf set.
 */
...
/**
 * @brief Get next value from list of ipAddress.
 ...
 */
#define afw_list_of_ipAddress_get_next( \
    list, iterator, xctx) \
    afw_list_of_ipAddress_get_next_source( \
...
/**
 * @brief Add value from list of ipAddress.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_list_of_ipAddress_add(
    const afw_list_t *instance,
    const afw_utf8_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Remove value from list of ipAddress.
 * @param instance of list.
 * @param value to remove.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_list_of_ipAddress_remove(
    const afw_list_t *instance,
    const afw_utf8_t *value,
    afw_xctx_t *xctx);
