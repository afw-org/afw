 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_referenced_ipAddress_inf;
...
/**
 * @brief Allocate function for referenced data type ipAddress value.
...
afw_value_alloc_referenced_ipAddress(
    afw_utf8_octet_t **s,
    afw_size_t len,
    afw_xctx_t *xctx);
...
/**
 * @brief Create function for referenced data type ipAddress value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_referenced_ipAddress(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx);

/**
 * @brief Create function for referenced data type ipAddress slice value.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_referenced_ipAddress_slice(
