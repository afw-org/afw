...
#ifndef __AFW_DATA_TYPE_IPADDRESS_BINDING_H__
#define __AFW_DATA_TYPE_IPADDRESS_BINDING_H__
...
/**
 * @defgroup afw_c_api_data_type_ipAddress ipAddress
...
/** @brief Quoted data type id for ipAddress */
#define AFW_DATA_TYPE_ID_Q_ipAddress "ipAddress"

/** @brief Unquoted data type id for ipAddress */
#define AFW_DATA_TYPE_ID_U_ipAddress ipAddress

/** @brief String for data type id ipAddress */
#define AFW_DATA_TYPE_ID_S_ipAddress afw_s_ipAddress

/** @brief Quoted c type for data type id ipAddress */
#define AFW_DATA_TYPE_CTYPE_Q_ipAddress "afw_utf8_t"

/** @brief Adaptive string value for "ipAddress". */
AFW_DECLARE_CONST_DATA(afw_value_t *)
afw_data_type_ipAddress_id_value;

/** @brief Data type struct for ipAddress. */
AFW_DECLARE_CONST_DATA(afw_data_type_t *)
afw_data_type_ipAddress;

/**
 * @brief Unmanaged evaluated value inf for data type ipAddress.
 *
...
/**
 * @brief Managed evaluated value inf for data type ipAddress.
 *
 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_managed_ipAddress_inf;

/**
 * @brief Managed slice value inf for data type ipAddress.
 *
 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_managed_slice_ipAddress_inf;

/**
 * @brief Permanent (life of afw environment) value inf for data type ipAddress.
 *
 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_permanent_ipAddress_inf;
...
/**
 * @brief Convert data type ipAddress string to afw_utf8_t *.
 ...
 */
AFW_DECLARE(void)
afw_data_type_ipAddress_to_internal(
...
/**
 * @brief Convert data type ipAddress internal representation to utf-8.
...
afw_data_type_ipAddress_to_utf8(
    const afw_utf8_t * internal,
    const afw_pool_t *p,
    afw_xctx_t *xctx);

/** @brief struct for data type ipAddress values. */
struct afw_value_ipAddress_s {
...
/** @brief struct for managed data type ipAddress values.
 *
 * This is the same as afw_value_ipAddress_s with the addition of a
 * reference count. This is intended for internal use only.
 */
struct afw_value_ipAddress_managed_s {
    /** @brief  Value inf union with afw_value_t pub to reduce casting needed. */
    union {
        const afw_value_inf_t *inf;
        afw_value_t pub;
...
/** @brief struct for managed slice data type ipAddress values.
 *
 * A view into a containing managed value. Holds that value.
 */
struct afw_value_ipAddress_managed_slice_s {
    /** @brief  Value inf union with afw_value_t pub to reduce casting needed. */
    union {
        const afw_value_inf_t *inf;
        afw_value_t pub;
    ...
    const afw_value_ipAddress_managed_t *containing_value;
...
/**
 * @brief Typesafe cast to evaluated ipAddress value.
 * @param value (const afw_value_t *). Evaluated if needed.
 * @return (const afw_value_ipAddress_t *)
 *
 * Throws if missing or wrong type. Use ->internal for the C
 * payload, or afw_value_as_ipAddress_internal().
 */
AFW_DECLARE(const afw_value_ipAddress_t *)
 ...
 * @param xctx of caller.
 * @return Allocated afw_value_ipAddress_t with unmanaged inf set.
 *
 * Unmanaged: lifetime is pool p; no value refcount.
 * Caller fills internal after allocate.
 */
AFW_DECLARE(afw_value_ipAddress_t *)
afw_value_ipAddress_allocate(
    const afw_pool_t *p,
    afw_xctx_t *xctx);
#define afw_value_allocate_unmanaged_ipAddress afw_value_ipAddress_allocate

/**
 * @brief Create function for managed data type ipAddress value.
 * @param internal.
 * @param xctx of caller.
...
afw_value_ipAddress_create_managed(
    const afw_utf8_t * internal,
    afw_xctx_t *xctx);
#define afw_value_create_managed_ipAddress afw_value_ipAddress_create_managed

/**
 * @brief Deep clone an evaluated ipAddress value unmanaged into p.
 * @param value evaluated ipAddress.
 * @param p dest pool.
 * @param xctx of caller.
...
/**
 * @brief Clone an evaluated ipAddress value managed in xctx->p.
 * @param value evaluated ipAddress.
 * @param xctx of caller.
...
/**
 * @brief Create a managed slice of a managed data type ipAddress value.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_ipAddress_create_managed_slice(
    const afw_value_t *containing_value,
    afw_size_t offset,
    afw_size_t len,
    afw_xctx_t *xctx);
#define afw_value_create_managed_ipAddress_slice afw_value_ipAddress_create_managed_slice
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_ipAddress_create(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx);
#define afw_value_create_unmanaged_ipAddress afw_value_ipAddress_create
 ...
 * @param xctx of caller.
 * @return (const afw_value_ipAddress_t *) or NULL if missing.
 *
...
/**
 * @brief Get property function for data type ipAddress internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_utf8_t *.
...
/**
 * @brief Get property function for data type ipAddress value.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param source_z file:line.
 * @param xctx of caller.
...
/**
 * @brief Get next property function for data type ipAddress internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
...
/**
 * @brief Get next property function for data type ipAddress value.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param source_z file:line.
...
/**
 * @brief Set property as ipAddress value.
 * @param object of property to set.
 * @param property_name of property to set.
 * @param value to set.
 * @param xctx of caller.
 *
 * Compile-time type check for const afw_value_ipAddress_t *.
 */
AFW_DECLARE(void)
...
/**
 * @brief Set property as ipAddress internal.
 * @param object of property to set.
 * @param property_name of property to set.
 ...
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_value_ipAddress_t *) or NULL.
 *
...
/**
 * @brief Add a ipAddress value to array of ipAddress.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Add a ipAddress internal to array of ipAddress.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove a ipAddress value from array of ipAddress.
 * @param instance of array.
...
/**
 * @brief Remove a ipAddress internal from array of ipAddress.
 * @param instance of array.
 * @param value to remove.
 * @param xctx of caller.
 */
...
#endif /* __AFW_DATA_TYPE_IPADDRESS_BINDING_H__ */
