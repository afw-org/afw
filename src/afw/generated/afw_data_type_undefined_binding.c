...
/**
 * @file afw_data_type_undefined_binding.c
...
{
    (const afw_value_t *)&impl_data_type_undefined_id_value
};

static const afw_utf8_t
impl_data_type_path_undefined =
    AFW_UTF8_LITERAL("/afw/_AdaptiveDataType_/undefined");
...
impl_data_type_object_undefined = {
    {
    ...
    (void *)&afw_data_type_undefined_direct
};
...
/* Data type undefined instance. */
AFW_DEFINE_INTERNAL_CONST_DATA(afw_data_type_t)
afw_data_type_undefined_direct = {
    &afw_data_type_undefined_inf,
    (const afw_object_t *)&impl_data_type_object_undefined,
    AFW_UTF8_LITERAL("undefined"),
    AFW_UTF8_LITERAL("An undefined value"),
    AFW_UTF8_LITERAL("This is a special data type that is used for the single internal value used to represent undefined values.  It is not a valid data type for any other purpose."),
    AFW_UTF8_LITERAL(""),
    afw_data_type_number_undefined,
    AFW_UTF8_LITERAL(""),
...
/* Data type struct for undefined. */
...
impl_afw_value_get_data_type(
    ...
    afw_xctx_t *xctx)
{
    return afw_data_type_undefined;
}
    ...
    afw_xctx_t *xctx)
{
    ...
    info->evaluated_data_type = afw_data_type_undefined;
