...
/**
 * @addtogroup afw_c_api_data_type_xpathExpression xpathExpression
 *
 * Adaptive Data Type xpathExpression
 *
 * @{
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_xpathExpression\
)

/**
 * @brief Macro to determine if value is evaluated list of xpathExpression.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_xpathExpression(A_VALUE) \
( \
...
/**
 * @brief Get next value from list of xpathExpression.
 ...
 */
#define afw_list_of_xpathExpression_get_next( \
    list, iterator, xctx) \
...
/**
 * @brief Add value from list of xpathExpression.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of xpathExpression.
 * @param instance of list.
