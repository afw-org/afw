 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_referenced_xpathExpression_inf;

/**
 * @brief Permanent managed (life of afw environment) value inf for data type xpathExpression.
 *
...
/**
 * @brief Macro to determine if value is evaluated xpathExpression.
...
/**
 * @brief Macro to determine if value is evaluated array of xpathExpression.
 * @param A_VALUE to test.
 * @return boolean result.
 */
...
/**
 * @brief Allocate function for referenced data type xpathExpression value.
 * @param s place to put pointer to allocated memory for internal->s.
 * @param len of memory to allocate for internal->s.
 * @param xctx of caller.
 * @return Allocated afw_value_xpathExpression_t with appropriate inf set.
 *
...
afw_value_alloc_referenced_xpathExpression(
    afw_utf8_octet_t **s,
    afw_size_t len,
    afw_xctx_t *xctx);
...
/**
 * @brief Create function for referenced data type xpathExpression value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_referenced_xpathExpression(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx);

/**
 * @brief Create function for referenced data type xpathExpression slice value.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_referenced_xpathExpression_slice(
...
/**
 * @brief Create function for data type xpathExpression value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
...
/**
 * @brief Create function for permanent data type xpathExpression value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
...
/**
 * @brief extern for data type xpathExpression struct.
 *
 * This should only be referenced in the linkage unit the extern is
 * defined in.  Use afw_data_type_xpathExpression when not referencing in
 * a static.
 */
...
/**
 * @brief extern for data type xpathExpression inf.
 *
 * This should only be referenced in the linkage unit the extern is
 * defined in.
 *
