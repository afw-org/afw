 ...
 * `const afw_value_xpathExpression_t *` (e.g. to read `.internal`).
 * Same as `AFW_VALUE_IS_DATA_TYPE(A_VALUE, xpathExpression)`.
 * Not the same as "will evaluate to xpathExpression" — see
