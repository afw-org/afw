 ...
 */
#define afw_data_type_is_xpathExpression(_A_DATA_TYPE) \
( \
    (_A_DATA_TYPE) && \
    (_A_DATA_TYPE) == afw_data_type_xpathExpression \
)

/**
 * @brief True if _A_VALUE is an evaluated xpathExpression value.
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(_A_VALUE, xpathExpression, xctx)` instead.
 */
#define afw_value_is_xpathExpression(_A_VALUE) \
( \
    (_A_VALUE) && \
    (_A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_xpathExpression\
)

/**
 * @brief True if _A_VALUE is an evaluated array of xpathExpression.
 * @param _A_VALUE to test.
 * @return boolean result.
 *
 ...
 */
#define afw_value_is_array_of_xpathExpression(_A_VALUE) \
( \
...
/**
 * @brief Clone an evaluated xpathExpression value managed in p->managed_p.
 * @param value evaluated xpathExpression.
 * @param p dest pool (uses p->managed_p).
 * @param xctx of caller.
