...
/**
 * @brief True if A_VALUE is an evaluated password value.
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(A_VALUE, password, xctx)` instead.
 */
...
/**
 * @brief True if A_VALUE is an evaluated array of password.
 * @param A_VALUE to test.
 * @return boolean result.
 *
