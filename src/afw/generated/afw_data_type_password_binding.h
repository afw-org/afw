...
/**
 * @addtogroup afw_c_api_data_type_password password
 *
 * Adaptive Data Type password
 *
 * @{
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_password\
)

/**
 * @brief Macro to determine if value is evaluated list of password.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_password(A_VALUE) \
( \
...
/**
 * @brief Allocate function for unmanaged data type password value.
...
/**
 * @brief Allocate function for permanent data type password value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_password_t with appropriate inf set.
 */
...
/**
 * @brief Get next value from list of password.
 ...
 */
#define afw_list_of_password_get_next( \
    list, iterator, xctx) \
...
/**
 * @brief Add value from list of password.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of password.
 * @param instance of list.
