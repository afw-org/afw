    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_pool_calloc(xctx->p->managed_p, sizeof(afw_value_ia5String_managed_slice_t), xctx);
...
/* Get property as ia5String internal. */
AFW_DEFINE(const afw_utf8_t *)
...
/* Get next property as ia5String internal. */
AFW_DEFINE(const afw_utf8_t *)
