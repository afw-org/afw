...
/**
 * @addtogroup afw_adapter_session_impl_declares afw_adapter_session
 * @{
 *
 ...
 * generated/interface_closet/skeleton_afw_adapter_session.c.
 *
 * Mutiple *_impl.declares.h can be included in each c source file, but only
 * one for each interface name.
 *
 * After the #include for  afw_adapter_session_impl_declares.h:
 *
 * 1. declarations will exist for all of the interfaces methods with names of
 *    impl_afw_adapter_session_ followed by the method name.
 * 2. rti will be defined with a name of impl_afw_adapter_session_rti.
 * 3. inf will be defined with a name of impl_afw_adapter_session_inf.
 *
 ...
 *
 *   AFW_IMPLEMENTATION_INF_LABEL - (optional) defaults to 'impl_afw_adapter_session_inf'.
 *
 *   AFW_ADAPTER_SESSION_SELF_T - (optional) defaults to 'const afw_adapter_session_t'.
 ...
 *
 * A second #include "afw_adapter_session_impl_declares.h" can be specified if
" *   #define "AFW_ADAPTER_SESSION_INF_ONLY" is specified to generate inf only."
 *~~~~~~~~~~~~~~~
 */


/**
 * @file afw_adapter_session_impl_declares.h
 * @brief Interface afw_interface implementation declares.
 */

#ifdef __AFW_ADAPTER_SESSION_IMPL_DECLARES_H__
#ifndef AFW_ADAPTER_SESSION_INF_ONLY
#error "afw_adapter_session_impl_declares.h already included."
#endif
#endif
#ifndef __AFW_ADAPTER_SESSION_IMPL_DECLARES_H__
#ifdef AFW_ADAPTER_SESSION_INF_ONLY
#error "afw_adapter_session_impl_declares.h must be included before AFW_ADAPTER_SESSION_INF_ONLY."
#endif
#define __AFW_ADAPTER_SESSION_IMPL_DECLARES_H__ 1
#endif
...
#ifndef AFW_ADAPTER_SESSION_SELF_T
#define AFW_ADAPTER_SESSION_SELF_T const afw_adapter_session_t
#endif

#ifndef AFW_ADAPTER_SESSION_INF_ONLY

#ifndef impl_afw_adapter_session_destroy
...
#ifndef impl_afw_adapter_session_retrieve_objects
...
#ifndef impl_afw_adapter_session_get_object
...
#ifndef impl_afw_adapter_session_add_object
...
#ifndef impl_afw_adapter_session_modify_object
...
#ifndef impl_afw_adapter_session_replace_object
...
#ifndef impl_afw_adapter_session_delete_object
...
#ifndef impl_afw_adapter_session_begin_transaction
/* Declare method begin_transaction */
AFW_DECLARE_STATIC(const afw_adapter_transaction_t *)
impl_afw_adapter_session_begin_transaction(
    AFW_ADAPTER_SESSION_SELF_T *self,
    afw_xctx_t * xctx);
#endif

#ifndef impl_afw_adapter_session_get_journal_interface
/* Declare method get_journal_interface */
AFW_DECLARE_STATIC(const afw_adapter_journal_t *)
impl_afw_adapter_session_get_journal_interface(
    AFW_ADAPTER_SESSION_SELF_T *self,
    afw_xctx_t * xctx);
#endif

#ifndef impl_afw_adapter_session_get_key_value_interface
/* Declare method get_key_value_interface */
AFW_DECLARE_STATIC(const afw_adapter_key_value_t *)
impl_afw_adapter_session_get_key_value_interface(
    AFW_ADAPTER_SESSION_SELF_T *self,
    afw_xctx_t * xctx);
#endif

#ifndef impl_afw_adapter_session_get_index_interface
/* Declare method get_index_interface */
AFW_DECLARE_STATIC(const afw_adapter_impl_index_t *)
impl_afw_adapter_session_get_index_interface(
    AFW_ADAPTER_SESSION_SELF_T *self,
    afw_xctx_t * xctx);
#endif

#ifndef impl_afw_adapter_session_get_object_type_cache_interface
/* Declare method get_object_type_cache_interface */
AFW_DECLARE_STATIC(const afw_adapter_object_type_cache_t *)
...
/* inf for interface afw_adapter_session */
#ifdef __BASE_FILE__
...
AFW_IMPLEMENTATION_INF_SPECIFIER(afw_adapter_session_inf_t)
#else
static const afw_adapter_session_inf_t
#endif
#ifdef AFW_IMPLEMENTATION_INF_LABEL
AFW_IMPLEMENTATION_INF_LABEL = {
#else
impl_afw_adapter_session_inf = {
#endif
    {
        AFW_UTF8_LITERAL("afw_adapter_session"),
