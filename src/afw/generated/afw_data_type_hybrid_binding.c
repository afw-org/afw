...
afw_data_type_hybrid_direct = {
    ...
    sizeof(afw_utf8_t),
    (const afw_list_t *)&impl_empty_list_of_hybrid,
    (const afw_value_t *)&impl_value_empty_list_of_hybrid,
    ...
    afw_xctx_t *xctx)
{
    ...
    info->optimized_value_data_type = afw_data_type_hybrid;
}


/* Get next value from list of hybrid. */
AFW_DEFINE(const afw_utf8_t *)
afw_list_of_hybrid_get_next_source(
...
/* Add value from list of hybrid */
AFW_DEFINE(void)
afw_list_of_hybrid_add(
    const afw_list_t *instance,
...
/* Remove value from list of hybrid */
AFW_DEFINE(void)
afw_list_of_hybrid_remove(
    const afw_list_t *instance,
    const afw_utf8_t *value,
    afw_xctx_t *xctx)
{
