...
/**
 * @brief True if A_VALUE is an evaluated dateTime value.
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(A_VALUE, dateTime, xctx)` instead.
 */
...
/**
 * @brief True if A_VALUE is an evaluated array of dateTime.
 * @param A_VALUE to test.
 * @return boolean result.
 *
...
/**
 * @brief Clone an evaluated dateTime value managed in xctx->p.
 * @param value evaluated dateTime.
 * @param xctx of caller.
...
/**
 * @brief Get property function for data type dateTime internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_dateTime_t *.
...
/**
 * @brief Get next property function for data type dateTime internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
