 ...
 */
#define afw_data_type_is_dateTime(_A_DATA_TYPE) \
( \
    (_A_DATA_TYPE) && \
    (_A_DATA_TYPE) == afw_data_type_dateTime \
)

/**
 * @brief True if _A_VALUE is an evaluated dateTime value.
 * @param _A_VALUE to test.
 * @return boolean result.
 *
 * For evaluated values only. When true, it is safe to cast _A_VALUE to
 * `const afw_value_dateTime_t *`.
 * If you want to know if the value will be dateTime when fully
 * evaluated (not necessarily cast-safe yet), use
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(_A_VALUE, dateTime, xctx)` instead.
 */
#define afw_value_is_dateTime(_A_VALUE) \
( \
    (_A_VALUE) && \
    (_A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_dateTime\
)

/**
 * @brief True if _A_VALUE is an evaluated array of dateTime.
 * @param _A_VALUE to test.
 * @return boolean result.
 *
 * When true, _A_VALUE is an evaluated array (`const afw_value_array_t *`)
 * whose element data type is dateTime.
 */
#define afw_value_is_array_of_dateTime(_A_VALUE) \
( \
...
afw_value_as_dateTime_internal(
    const afw_value_t *value,
    afw_xctx_t *xctx);
...
afw_value_dateTime_allocate(
    const afw_pool_t *p,
    afw_xctx_t *xctx);
#define afw_value_allocate_unmanaged_dateTime afw_value_dateTime_allocate
...
/**
 * @brief Deep clone an evaluated dateTime value unmanaged into p.
 * @param value evaluated dateTime.
 * @param p dest pool.
 * @param xctx of caller.
...
/**
 * @brief Clone an evaluated dateTime value managed in p->managed_p.
 * @param value evaluated dateTime.
 * @param p dest pool (uses p->managed_p).
 * @param xctx of caller.
...
#define afw_value_create_unmanaged_dateTime afw_value_dateTime_create

/**
 * @brief Get property as dateTime value.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return (const afw_value_dateTime_t *) or NULL if missing.
 *
 * Does not evaluate. Throws if present but not dateTime.
 */
...
/**
 * @brief Get property as dateTime internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_dateTime_t *.
 */
#define afw_object_get_property_as_dateTime_internal( \
    _object, _property_name, _xctx) \
...
/**
 * @brief Get next property as dateTime internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
 * @return const afw_dateTime_t *.
 */
#define afw_object_get_next_property_as_dateTime_internal( \
    _object, _iterator, _property_name, _xctx) \
...
/**
 * @brief Set property as dateTime value.
 * @param object of property to set.
 * @param property_name of property to set.
 * @param value to set.
 * @param xctx of caller.
 *
 * Compile-time type check for const afw_value_dateTime_t *.
 */
AFW_DECLARE(void)
...
/**
 * @brief Set property as dateTime internal.
 * @param object of property to set.
 * @param property_name of property to set.
...
/**
 * @brief Get next dateTime value from array of dateTime.
 * @param instance of array.
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_value_dateTime_t *) or NULL.
 *
...
/**
 * @brief Get next dateTime internal from array of dateTime.
 * @param instance of array.
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_dateTime_t *) or NULL.
 */
#define afw_array_of_dateTime_get_next_internal( \
    _array, _iterator, _xctx) \
...
/**
 * @brief Add a dateTime value to array of dateTime.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Add a dateTime internal to array of dateTime.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove a dateTime value from array of dateTime.
 * @param instance of array.
...
/**
 * @brief Remove a dateTime internal from array of dateTime.
 * @param instance of array.
 * @param value to remove.
 * @param xctx of caller.
 */
...
/**
 * @brief Public data type dateTime struct instance.
 *
 * Prefer afw_data_type_dateTime when a pointer is enough and you are not
...
/**
 * @brief Public data type dateTime inf.
 *
