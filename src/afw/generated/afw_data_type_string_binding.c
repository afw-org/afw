...
/* Declares and rti/inf defines for interface afw_value */
/* This is the inf for referenced string values. For this one */
/* optional_release releases value and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "referenced_string"
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_referenced_string_inf
...
/* Create function for referenced data type string value. */
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_pool_calloc(p, sizeof(afw_value_string_t),
        xctx);
    v->inf = &afw_value_referenced_string_inf;
    if (internal) {
...
/* Create function for referenced data type string slice value. */
AFW_DEFINE(const afw_value_t *)
