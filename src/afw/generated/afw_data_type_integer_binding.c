...
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_evaluated_integer_inf
...
afw_data_type_integer_direct = {
    ...
    (const afw_list_t *)&impl_empty_list_of_integer,
    (const afw_value_t *)&impl_value_empty_list_of_integer,
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_integer(internal, object->p, xctx);
...
afw_value_allocate_integer(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_integer_t),
        xctx);
    result->inf = &afw_value_evaluated_integer_inf;
    return result;
}
...
afw_value_allocate_permanent_integer(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_integer_t),
        xctx);
    result->inf = &afw_value_permanent_integer_inf;
    return result;
}
    ...
    afw_xctx_t *xctx)
{
    ...
    info->optimized_value_data_type = afw_data_type_integer;
}


/* Get next value from list of integer. */
AFW_DEFINE(afw_integer_t)
afw_list_of_integer_get_next_source(
...
/* Add value from list of integer */
AFW_DEFINE(void)
afw_list_of_integer_add(
    const afw_list_t *instance,
...
/* Remove value from list of integer */
AFW_DEFINE(void)
afw_list_of_integer_remove(
    const afw_list_t *instance,
    const afw_integer_t *value,
    afw_xctx_t *xctx)
{
