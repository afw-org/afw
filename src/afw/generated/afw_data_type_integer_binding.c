...
impl_data_type_object_integer__value;
...
impl_data_type_object_integer = {
    {
        ...
        NULL,
        (const afw_value_t *)&impl_data_type_object_integer__value,
        {
            NULL,
            NULL,
            &afw_self_s_integer,
...
afw_value_integer_allocate(const afw_pool_t *p, afw_xctx_t *xctx)
{
...
/* Clone evaluated integer managed in p->managed_p. */
AFW_DEFINE(const afw_value_t *)
afw_value_clone_integer_managed(
    const afw_value_t *value,
    const afw_pool_t *p,
...
/* Get next integer value from array of integer. */
AFW_DEFINE(const afw_value_integer_t *)
...
/* Get next integer internal from array of integer. */
AFW_DEFINE(afw_integer_t)
    ...
    afw_xctx_t *xctx)
{
    ...
    value = afw_array_of_integer_get_next_source(instance, iterator, source_z, xctx);
    if (!value) {
        *found = false;
        return 0;
    }
...
/* Add a integer value to array of integer. */
AFW_DEFINE(void)
...
/* Add a integer internal to array of integer. */
AFW_DEFINE(void)
