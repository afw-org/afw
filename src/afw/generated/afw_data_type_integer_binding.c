...
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_integer_inf
...
/* Declares and rti/inf defines for interface afw_value */
/* This is the inf for referenced integer values. For this one */
/* optional_release releases value and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "referenced_integer"
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_referenced_integer_inf
...
afw_value_allocate_integer(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_integer_t),
        xctx);
    result->inf = &afw_value_integer_inf;
    return result;
}

/* Create function for referenced data type integer value. */
AFW_DEFINE(const afw_value_t *)
afw_value_create_referenced_integer(afw_integer_t internal,
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_pool_calloc(p, sizeof(afw_value_integer_t),
        xctx);
    v->inf = &afw_value_referenced_integer_inf;
    v->internal = internal;
    return &v->pub;
}
