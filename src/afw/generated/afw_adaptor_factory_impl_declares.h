...
/**
 * @addtogroup afw_adaptor_factory_impl_declares afw_adaptor_factory
 * @{
 *
 ...
 * generated/interface_closet/skeleton_afw_adaptor_factory.c.
 *
 * Mutiple *_impl.declares.h can be included in each c source file, but only
 * one for each interface name.
 *
 * After the #include for  afw_adaptor_factory_impl_declares.h:
 *
 * 1. declarations will exist for all of the interfaces methods with names of
 *    impl_afw_adaptor_factory_ followed by the method name.
 * 2. rti will be defined with a name of impl_afw_adaptor_factory_rti.
 * 3. inf will be defined with a name of impl_afw_adaptor_factory_inf.
 *
 ...
 *
 *   AFW_IMPLEMENTATION_INF_LABEL - (optional) defaults to 'impl_afw_adaptor_factory_inf'.
 *
 *   AFW_ADAPTOR_FACTORY_SELF_T - (optional) defaults to 'const afw_adaptor_factory_t'.
 ...
 *
 * A second #include "afw_adaptor_factory_impl_declares.h" can be specified if
" *   #define "AFW_ADAPTOR_FACTORY_INF_ONLY" is specified to generate inf only."
 *~~~~~~~~~~~~~~~
 */


/**
 * @file afw_adaptor_factory_impl_declares.h
 * @brief Interface afw_interface implementation declares.
 */

#ifdef __AFW_ADAPTOR_FACTORY_IMPL_DECLARES_H__
#ifndef AFW_ADAPTOR_FACTORY_INF_ONLY
#error "afw_adaptor_factory_impl_declares.h already included."
#endif
#endif
#ifndef __AFW_ADAPTOR_FACTORY_IMPL_DECLARES_H__
#ifdef AFW_ADAPTOR_FACTORY_INF_ONLY
#error "afw_adaptor_factory_impl_declares.h must be included before AFW_ADAPTOR_FACTORY_INF_ONLY."
#endif
#define __AFW_ADAPTOR_FACTORY_IMPL_DECLARES_H__ 1
#endif
...
#ifndef AFW_ADAPTOR_FACTORY_SELF_T
#define AFW_ADAPTOR_FACTORY_SELF_T const afw_adaptor_factory_t
#endif

#ifndef AFW_ADAPTOR_FACTORY_INF_ONLY

#ifndef impl_afw_adaptor_factory_create_adaptor_cede_p
/* Declare method create_adaptor_cede_p */
AFW_DECLARE_STATIC(const afw_adaptor_t *)
impl_afw_adaptor_factory_create_adaptor_cede_p(
    AFW_ADAPTOR_FACTORY_SELF_T *self,
...
/* inf for interface afw_adaptor_factory */
#ifdef __BASE_FILE__
...
AFW_IMPLEMENTATION_INF_SPECIFIER(afw_adaptor_factory_inf_t)
#else
static const afw_adaptor_factory_inf_t
#endif
