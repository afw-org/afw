...
/* Typesafe cast of data type hexBinary. */
...
/* Get next value from array of hexBinary. */
AFW_DEFINE(const afw_memory_t *)
    ...
    afw_xctx_t *xctx)
{
    ...
    if (data_type != afw_data_type_hexBinary) {
        const afw_utf8_t *data_type_id;
...
/* Add value from array of hexBinary */
AFW_DEFINE(void)
...
/* Remove value from array of hexBinary */
AFW_DEFINE(void)
