    ...
    afw_xctx_t *xctx)
{
    ...
    if (afw_object_is_memory_managed(object) ||
        ...
        v = afw_value_hexBinary_create_managed(internal, xctx);
    }
    else {
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_pool_calloc(xctx->p->managed_p, sizeof(afw_value_hexBinary_managed_slice_t), xctx);
...
/* Clone evaluated hexBinary managed in xctx->p. */
AFW_DEFINE(const afw_value_t *)
afw_value_clone_hexBinary_managed(
    const afw_value_t *value,
    afw_xctx_t *xctx)
    ...
    afw_xctx_t *xctx)
{
    ...
    if (afw_array_is_memory_managed(instance) ||
        ...
        v = afw_value_hexBinary_create_managed(value, xctx);
    }
    else {
