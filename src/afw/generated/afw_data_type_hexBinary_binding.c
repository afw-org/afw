...
/* This is the inf for unmanaged hexBinary values. For this one */
/* optional_release is NULL and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "hexBinary"
#define AFW_IMPLEMENTATION_INF_SPECIFIER AFW_DEFINE_CONST_DATA
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_evaluated_hexBinary_inf
...
afw_data_type_hexBinary_direct = {
    ...
    sizeof(afw_memory_t),
    (const afw_list_t *)&impl_empty_list_of_hexBinary,
    (const afw_value_t *)&impl_value_empty_list_of_hexBinary,
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_hexBinary(internal, object->p, xctx);
...
/* Allocate function for unmanaged data type hexBinary values. */
...
afw_value_allocate_hexBinary(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_hexBinary_t),
        xctx);
    result->inf = &afw_value_evaluated_hexBinary_inf;
    return result;
}

/* Create function for unmanaged data type hexBinary value. */
...
/* Allocate function for managed data type hexBinary values. */
AFW_DEFINE(afw_value_hexBinary_t *)
afw_value_allocate_managed_hexBinary(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_hexBinary_t),
        xctx);
    result->inf = &afw_value_managed_hexBinary_inf;
    return result;
}
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_managed_hexBinary(p, xctx);
    if (internal) {
        memcpy(&v->internal, internal, sizeof(afw_memory_t));
    }
    return (const afw_value_t *)v;
...
/* Allocate function for permanent data type hexBinary values. */
AFW_DEFINE(afw_value_hexBinary_t *)
afw_value_allocate_permanent_hexBinary(const afw_pool_t *p, afw_xctx_t *xctx)
{
    afw_value_hexBinary_t *result;

    result = afw_pool_calloc(p, sizeof(afw_value_hexBinary_t),
        xctx);
    result->inf = &afw_value_permanent_hexBinary_inf;
    return result;
}
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_permanent_hexBinary(p, xctx);
    if (internal) {
        memcpy(&v->internal, internal, sizeof(afw_memory_t));
    }
    return (const afw_value_t *)v;
    ...
    afw_xctx_t *xctx)
{
    ...
    info->optimized_value_data_type = afw_data_type_hexBinary;
}


/* Get next value from list of hexBinary. */
AFW_DEFINE(const afw_memory_t *)
afw_list_of_hexBinary_get_next_source(
...
/* Add value from list of hexBinary */
AFW_DEFINE(void)
afw_list_of_hexBinary_add(
    const afw_list_t *instance,
...
/* Remove value from list of hexBinary */
AFW_DEFINE(void)
afw_list_of_hexBinary_remove(
    const afw_list_t *instance,
    const afw_memory_t *value,
    afw_xctx_t *xctx)
{
