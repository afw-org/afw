...
/*
 * Interface afw_iterator_with_key implementation for <afwdev {implementation_id}>
 *
...
/**
 * @brief Self typedef for <afwdev {implementation_id}> implementation of afw_iterator_with_key.
 */
typedef struct
<afwdev {prefixed_interface_name}>_self_s {
    afw_iterator_with_key_t pub;
