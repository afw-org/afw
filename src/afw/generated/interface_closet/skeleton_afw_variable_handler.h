...
/*
 * Interface afw_variable_handler implementation for <afwdev {implementation_id}>
 *
...
/**
 * @brief Self typedef for <afwdev {implementation_id}> implementation of afw_variable_handler.
 */
typedef struct
<afwdev {prefixed_interface_name}>_self_s {
    afw_variable_handler_t pub;
