 ...
 *
 * This is the implementation of afw_adapter_factory for <afwdev {implementation_id}>.
 */
...
#define AFW_ADAPTER_FACTORY_SELF_T <afwdev {prefixed_interface_name}>_self_t
...
/* Singleton instance of afw_adapter_factory for <afwdev {implementation_id}> */
<afwdev {srcdir_prefix.upper()}>DEFINE_CONST_DATA(afw_adapter_factory_t)
...
/* Get singleton instance of afw_adapter_factory for <afwdev {implementation_id}> */
<afwdev {srcdir_prefix.upper()}>DEFINE(const afw_adapter_factory_t *)
<afwdev {prefix}>get_afw_adapter_factory(
...
/*
 * Implementation of method create_adapter_cede_p for interface
 * afw_adapter_factory.
 */
const afw_adapter_t *
