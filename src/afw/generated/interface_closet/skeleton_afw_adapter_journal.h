...
/*
 * Interface afw_adapter_journal implementation for <afwdev {implementation_id}>
 *
 ...
 * @brief <afwdev {brief}>
 *
 * This is the implementation of afw_adapter_journal for <afwdev {implementation_id}>.
 */
...
/**
 * @brief Self typedef for <afwdev {implementation_id}> implementation of afw_adapter_journal.
 */
typedef struct
