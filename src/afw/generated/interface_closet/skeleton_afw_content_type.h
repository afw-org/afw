...
/*
 * Interface afw_content_type implementation for <afwdev {implementation_id}>
 *
...
/**
 * @brief Self typedef for <afwdev {implementation_id}> implementation of afw_content_type.
 */
typedef struct
