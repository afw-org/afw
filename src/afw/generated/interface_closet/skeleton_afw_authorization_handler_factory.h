...
/*
 * Interface afw_authorization_handler_factory implementation for <afwdev {implementation_id}>
 *
...
/**
 * @brief Self typedef for <afwdev {implementation_id}> implementation of afw_authorization_handler_factory.
 */
typedef struct
<afwdev {prefixed_interface_name}>_self_s {
    afw_authorization_handler_factory_t pub;
...
/**
 * @brief Singleton instance of afw_authorization_handler_factory for <afwdev {implementation_id}>.
 */
<afwdev {srcdir_prefix.upper()}>DECLARE_CONST_DATA(afw_authorization_handler_factory_t)
<afwdev {prefixed_interface_name}>;

/**
 * @brief Get singleton instance of afw_authorization_handler_factory for <afwdev {implementation_id}>.
 */
<afwdev {srcdir_prefix.upper()}>DECLARE(const afw_authorization_handler_factory_t *)
