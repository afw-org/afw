 ...
 *
 * This is the implementation of afw_adapter_key_value for <afwdev {implementation_id}>.
 */

#include "afw.h"
#include "<afwdev {prefixed_interface_name}>.h"

/* Declares and rti/inf defines for interface afw_adapter_key_value */
#define AFW_IMPLEMENTATION_ID "<afwdev {implementation_id}>"
/* Change this to the name of the self typedef for this implementation */
#define AFW_ADAPTER_KEY_VALUE_SELF_T <afwdev {prefixed_interface_name}>_self_t
#include "afw_adapter_key_value_impl_declares.h"

/*
 * Implementation of method add for interface afw_adapter_key_value.
 */
void
...
/*
 * Implementation of method delete for interface afw_adapter_key_value.
 */
void
...
/*
 * Implementation of method replace for interface afw_adapter_key_value.
 */
void
...
/*
 * Implementation of method get for interface afw_adapter_key_value.
 */
const afw_memory_t *
