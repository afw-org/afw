...
/*
 * Interface afw_adaptor_transaction implementation for <afwdev {implementation_id}>
 *
...
/**
 * @brief Self typedef for <afwdev {implementation_id}> implementation of afw_adaptor_transaction.
 */
typedef struct
