...
/*
 * Interface afw_adaptor_object_type_cache implementation for <afwdev {implementation_id}>
 *
...
/**
 * @brief Self typedef for <afwdev {implementation_id}> implementation of afw_adaptor_object_type_cache.
 */
typedef struct
<afwdev {prefixed_interface_name}>_self_s {
    afw_adaptor_object_type_cache_t pub;
