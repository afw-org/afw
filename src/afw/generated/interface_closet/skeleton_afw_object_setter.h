...
/*
 * Interface afw_object_setter implementation for <afwdev {implementation_id}>
 *
...
/**
 * @brief Self typedef for <afwdev {implementation_id}> implementation of afw_object_setter.
 */
typedef struct
<afwdev {prefixed_interface_name}>_self_s {
    afw_object_setter_t pub;
