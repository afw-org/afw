...
/*
 * Interface afw_adapter_factory implementation for <afwdev {implementation_id}>
 *
...
/**
 * @brief Self typedef for <afwdev {implementation_id}> implementation of afw_adapter_factory.
 */
typedef struct
<afwdev {prefixed_interface_name}>_self_s {
    afw_adapter_factory_t pub;
