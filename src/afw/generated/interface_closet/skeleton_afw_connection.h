...
/*
 * Interface afw_connection implementation for <afwdev {implementation_id}>
 *
...
/**
 * @brief Self typedef for <afwdev {implementation_id}> implementation of afw_connection.
 */
typedef struct
<afwdev {prefixed_interface_name}>_self_s {
    afw_connection_t pub;
