...
#define AFW_ADAPTOR_FACTORY_SELF_T <afwdev {prefixed_interface_name}>_self_t
...
/* Singleton instance of afw_adaptor_factory for <afwdev {implementation_id}> */
<afwdev {srcdir_prefix.upper()}>DEFINE_CONST_DATA(afw_adaptor_factory_t)
...
/* Get singleton instance of afw_adaptor_factory for <afwdev {implementation_id}> */
<afwdev {srcdir_prefix.upper()}>DEFINE(const afw_adaptor_factory_t *)
<afwdev {prefix}>get_afw_adaptor_factory(
...
/*
 * Implementation of method create_adaptor_cede_p for interface
 * afw_adaptor_factory.
 */
const afw_adaptor_t *
