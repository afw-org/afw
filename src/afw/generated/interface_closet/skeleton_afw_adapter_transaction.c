 ...
 *
 * This is the implementation of afw_adapter_transaction for <afwdev {implementation_id}>.
 */

#include "afw.h"
#include "<afwdev {prefixed_interface_name}>.h"

/* Declares and rti/inf defines for interface afw_adapter_transaction */
#define AFW_IMPLEMENTATION_ID "<afwdev {implementation_id}>"
/* Change this to the name of the self typedef for this implementation */
#define AFW_ADAPTER_TRANSACTION_SELF_T <afwdev {prefixed_interface_name}>_self_t
#include "afw_adapter_transaction_impl_declares.h"

/*
 * Implementation of method release for interface afw_adapter_transaction.
 */
void
...
/*
 * Implementation of method commit for interface afw_adapter_transaction.
 */
void
