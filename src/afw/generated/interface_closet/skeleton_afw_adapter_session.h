...
/*
 * Interface afw_adapter_session implementation for <afwdev {implementation_id}>
 *
 ...
 * @brief <afwdev {brief}>
 *
 * This is the implementation of afw_adapter_session for <afwdev {implementation_id}>.
 */
...
/**
 * @brief Self typedef for <afwdev {implementation_id}> implementation of afw_adapter_session.
 */
typedef struct
...
/**
 * @brief Create for <afwdev {implementation_id}> implementation of afw_adapter_session
 * @param xctx
