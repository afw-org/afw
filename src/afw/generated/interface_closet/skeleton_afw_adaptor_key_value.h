...
/*
 * Interface afw_adaptor_key_value implementation for <afwdev {implementation_id}>
 *
...
/**
 * @brief Self typedef for <afwdev {implementation_id}> implementation of afw_adaptor_key_value.
 */
typedef struct
