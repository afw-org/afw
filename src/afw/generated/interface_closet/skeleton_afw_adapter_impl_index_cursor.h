...
/*
 * Interface afw_adapter_impl_index_cursor implementation for <afwdev {implementation_id}>
 *
...
/**
 * @brief Self typedef for <afwdev {implementation_id}> implementation of afw_adapter_impl_index_cursor.
 */
typedef struct
