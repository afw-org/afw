...
/**
 * @brief Unmanaged evaluated value inf for data type unknown.
 *
...
/**
 * @brief Managed evaluated value inf for data type unknown.
 *
 * The lifetime of the value is managed by reference.
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_managed_unknown_inf;
...
/**
 * @brief Macro to determine if value is evaluated unknown.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_unknown(A_VALUE) \
( \
    (A_VALUE) && \
    (A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_unknown\
)

/**
 * @brief Macro to determine if value is evaluated array of unknown.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_array_of_unknown(A_VALUE) \
( \
    afw_value_is_array(A_VALUE) && \
    afw_array_get_data_type( \
        ((const afw_value_array_t *)(A_VALUE))->internal, \
        xctx) == afw_data_type_unknown \
)

/**
 * @brief Convert data type unknown string to const afw_value_t * *.
...
/**
 * @brief Convert data type unknown internal representation to utf-8.
...
/**
 * @brief Typesafe cast of data type unknown.
...
/**
 * @brief Allocate function for unmanaged data type unknown value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_unknown_t with appropriate inf set.
 */
AFW_DECLARE(afw_value_unknown_t *)
afw_value_allocate_unknown(const afw_pool_t *p, afw_xctx_t *xctx);

/**
 * @brief Create function for unmanaged data type unknown value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
...
/**
 * @brief Allocate function for managed data type unknown value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_unknown_t with appropriate inf set.
 */
...
/**
 * @brief Create function for managed data type unknown value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
...
/**
 * @brief Allocate function for permanent data type unknown value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_unknown_t with appropriate inf set.
 */
...
/**
 * @brief Create function for permanent data type unknown value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
...
/**
 * @brief Get property function for data type unknown value.
 * @deprecated
 ...
 *
 */
#define afw_object_old_get_property_as_unknown( \
 ...
 * @return const afw_value_t *.
 */
#define afw_object_get_property_as_unknown( \
...
/**
 * @brief Get next property function for data type unknown value.
 * @deprecated
 * @param object of property to get.
 ...
 *
 */
#define afw_object_old_get_next_property_as_unknown( \
 ...
 * @return const afw_value_t *.
 */
#define afw_object_get_next_property_as_unknown( \
...
/**
 * @brief Set property function for data type unknown values.
...
/**
 * @brief Get next value from array of unknown.
 ...
 */
#define afw_array_of_unknown_get_next( \
    array, iterator, xctx) \
...
/**
 * @brief Add value from array of unknown.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from array of unknown.
 * @param instance of array.
