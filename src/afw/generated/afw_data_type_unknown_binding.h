 ...
 * @brief Generated header for adaptive data type `unknown`.
 */
...
/** @brief struct for managed data type unknown values.
 *
 * This is the same as afw_value_unknown_s with the addition of a
 * reference count. This is intended for internal use only.
 */
struct afw_value_unknown_managed_s {
    /** @brief  Value inf union with afw_value_t pub to reduce casting needed. */
    union {
        const afw_value_inf_t *inf;
        afw_value_t pub;
...
/**
 * @brief Public data type unknown struct instance.
 *
 * Prefer afw_data_type_unknown when a pointer is enough and you are not
...
/**
 * @brief Public data type unknown inf.
 *
