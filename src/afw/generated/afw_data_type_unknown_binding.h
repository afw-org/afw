...
/**
 * @brief Macro to determine if value is evaluated list of unknown.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_unknown(A_VALUE) \
( \
...
/**
 * @brief Get next value from list of unknown.
 ...
 */
#define afw_list_of_unknown_get_next( \
    list, iterator, xctx) \
...
/**
 * @brief Add value from list of unknown.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of unknown.
 * @param instance of list.
