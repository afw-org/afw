...
/* Typesafe cast of data type template. */
...
/* Get next value from array of template. */
AFW_DEFINE(const afw_utf8_t *)
    ...
    afw_xctx_t *xctx)
{
    ...
    if (data_type != afw_data_type_template) {
        const afw_utf8_t *data_type_id;
...
/* Add value from array of template */
AFW_DEFINE(void)
...
/* Remove value from array of template */
AFW_DEFINE(void)
