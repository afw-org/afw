...
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_template_inf
...
/* Declares and rti/inf defines for interface afw_value */
/* This is the inf for referenced template values. For this one */
/* optional_release releases value and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "referenced_template"
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_referenced_template_inf
...
afw_value_allocate_template(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_template_t),
        xctx);
    result->inf = &afw_value_template_inf;
    return result;
}

/* Create function for referenced data type template value. */
AFW_DEFINE(const afw_value_t *)
afw_value_create_referenced_template(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_pool_calloc(p, sizeof(afw_value_template_t),
        xctx);
    v->inf = &afw_value_referenced_template_inf;
    if (internal) {
...
/* Create function for referenced data type template slice value. */
AFW_DEFINE(const afw_value_t *)
afw_value_create_referenced_template_slice(
