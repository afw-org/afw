    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_pool_calloc(xctx->p->managed_p, sizeof(afw_value_template_managed_slice_t), xctx);
...
/* Get property as template internal. */
AFW_DEFINE(const afw_utf8_t *)
...
/* Get next property as template internal. */
AFW_DEFINE(const afw_utf8_t *)
