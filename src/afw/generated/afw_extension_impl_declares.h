...
/**
 * @addtogroup afw_extension_impl_declares afw_extension
 * @{
 *
 ...
 *
 * After the #include for  afw_extension_impl_declares.h:
 *
 * 1. declarations will exist for all of the interfaces methods with names of
 *    impl_afw_extension_ followed by the method name.
 * 2. rti will be defined with a name of impl_afw_extension_rti.
 * 3. inf will be defined with a name of impl_afw_extension_inf.
 *
 ...
 *
 * A second #include "afw_extension_impl_declares.h" can be specified if
" *   #define "AFW_EXTENSION_INF_ONLY" is specified to generate inf only."
 *~~~~~~~~~~~~~~~
 */


/**
 * @file afw_extension_impl_declares.h
 * @brief Interface afw_interface implementation declares.
 */

#ifdef __AFW_EXTENSION_IMPL_DECLARES_H__
#ifndef AFW_EXTENSION_INF_ONLY
#error "afw_extension_impl_declares.h already included."
#endif
#endif
#ifndef __AFW_EXTENSION_IMPL_DECLARES_H__
#ifdef AFW_EXTENSION_INF_ONLY
#error "afw_extension_impl_declares.h must be included before AFW_EXTENSION_INF_ONLY."
#endif
#define __AFW_EXTENSION_IMPL_DECLARES_H__ 1
#endif
...
#ifndef impl_afw_extension_release
...
/* inf for interface afw_extension */
#ifdef __BASE_FILE__
...
AFW_IMPLEMENTATION_INF_SPECIFIER(afw_extension_inf_t)
#else
static const afw_extension_inf_t
#endif
