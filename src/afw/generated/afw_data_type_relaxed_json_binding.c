...
/* This is the inf for unmanaged relaxed_json values. For this one */
/* optional_release is NULL and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "relaxed_json"
#define AFW_IMPLEMENTATION_INF_SPECIFIER AFW_DEFINE_CONST_DATA
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_relaxed_json_inf
...
/* Declares and rti/inf defines for interface afw_value */
/* This is the inf for referenced relaxed_json values. For this one */
/* optional_release releases value and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "referenced_relaxed_json"
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_referenced_relaxed_json_inf
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_relaxed_json(internal, object->p, xctx);
...
/* Allocate function for unmanaged data type relaxed_json values. */
...
afw_value_allocate_relaxed_json(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_relaxed_json_t),
        xctx);
    result->inf = &afw_value_relaxed_json_inf;
    return result;
}

/* Create function for referenced data type relaxed_json value. */
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_pool_calloc(p, sizeof(afw_value_relaxed_json_t),
        xctx);
    v->inf = &afw_value_referenced_relaxed_json_inf;
    if (internal) {
...
/* Create function for referenced data type relaxed_json slice value. */
AFW_DEFINE(const afw_value_t *)
...
/* Create function for unmanaged data type relaxed_json value. */
AFW_DEFINE(const afw_value_t *)
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_pool_calloc(p, sizeof(afw_value_relaxed_json_t),
        xctx);
    v->inf = &afw_value_relaxed_json_inf;
    if (internal) {
        memcpy(&v->internal, internal, sizeof(afw_utf8_t));
    }
    return &v->pub;
