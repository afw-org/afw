...
/**
 * @brief True if A_VALUE is an evaluated objectId value.
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(A_VALUE, objectId, xctx)` instead.
 */
...
/**
 * @brief True if A_VALUE is an evaluated array of objectId.
 * @param A_VALUE to test.
 * @return boolean result.
 *
