...
/**
 * @addtogroup afw_c_api_data_type_objectId objectId
 *
 * Adaptive Data Type objectId
 *
 * @{
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_objectId\
)

/**
 * @brief Macro to determine if value is evaluated list of objectId.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_objectId(A_VALUE) \
( \
...
/**
 * @brief Allocate function for permanent data type objectId value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_objectId_t with appropriate inf set.
 */
...
/**
 * @brief Get next value from list of objectId.
 ...
 */
#define afw_list_of_objectId_get_next( \
    list, iterator, xctx) \
...
/**
 * @brief Add value from list of objectId.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of objectId.
 * @param instance of list.
