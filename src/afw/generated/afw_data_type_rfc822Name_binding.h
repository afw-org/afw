...
/**
 * @brief Typesafe cast to evaluated rfc822Name value.
 * @param value (const afw_value_t *). Evaluated if needed.
 * @return (const afw_value_rfc822Name_t *)
 *
 * Throws if missing or wrong type. Use ->internal for the C
 * payload, or afw_value_as_rfc822Name_internal().
 */
AFW_DECLARE(const afw_value_rfc822Name_t *)
afw_value_as_rfc822Name(
    const afw_value_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Typesafe peel of data type rfc822Name internal.
 * @param value (const afw_value_t *).
 * @return (const afw_utf8_t *)
 */
AFW_DECLARE(const afw_utf8_t *)
afw_value_as_rfc822Name_internal(
    const afw_value_t *value,
    afw_xctx_t *xctx);
 ...
 * @param xctx of caller.
 * @return (const afw_value_rfc822Name_t *) or NULL if missing.
 *
...
/**
 * @brief Get property function for data type rfc822Name internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_utf8_t *.
...
/**
 * @brief Get next property function for data type rfc822Name internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
...
/**
 * @brief Set property as rfc822Name value.
 * @param object of property to set.
 * @param property_name of property to set.
 * @param value to set.
 * @param xctx of caller.
 *
 * Compile-time type check for const afw_value_rfc822Name_t *.
 */
AFW_DECLARE(void)
...
/**
 * @brief Set property as rfc822Name internal.
 * @param object of property to set.
 * @param property_name of property to set.
 ...
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_value_rfc822Name_t *) or NULL.
 *
...
/**
 * @brief Add a rfc822Name value to array of rfc822Name.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Add a rfc822Name internal to array of rfc822Name.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove a rfc822Name value from array of rfc822Name.
 * @param instance of array.
...
/**
 * @brief Remove a rfc822Name internal from array of rfc822Name.
 * @param instance of array.
 * @param value to remove.
 * @param xctx of caller.
 */
