...
/**
 * @addtogroup afw_c_api_data_type_rfc822Name rfc822Name
 *
 * Adaptive Data Type rfc822Name
 *
 * @{
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_rfc822Name\
)
...
/**
 * @brief Allocate function for permanent data type rfc822Name value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_rfc822Name_t with appropriate inf set.
 */
