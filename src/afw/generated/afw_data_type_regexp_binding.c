...
/* Declares and rti/inf defines for interface afw_value */
/* This is the inf for referenced regexp values. For this one */
/* optional_release releases value and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "referenced_regexp"
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_referenced_regexp_inf
...
/* Create function for referenced data type regexp value. */
AFW_DEFINE(const afw_value_t *)
afw_value_create_referenced_regexp(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_pool_calloc(p, sizeof(afw_value_regexp_t),
        xctx);
    v->inf = &afw_value_referenced_regexp_inf;
    if (internal) {
...
/* Create function for referenced data type regexp slice value. */
AFW_DEFINE(const afw_value_t *)
afw_value_create_referenced_regexp_slice(
