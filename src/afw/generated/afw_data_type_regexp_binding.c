...
/* Allocate function for managed data type regexp value. */
...
afw_value_allocate_managed_regexp(
    ...
    afw_xctx_t *xctx)
{
    afw_value_regexp_managed_t *result;

    result = afw_xctx_malloc(sizeof(afw_value_regexp_managed_t) + len, xctx);
    result->inf = &afw_value_managed_regexp_inf;
    result->internal.len = len;
    result->internal.s = (const afw_utf8_octet_t *)result + sizeof(afw_value_regexp_managed_t);
