...
/** @addtogroup afw_functions_adapter adapter functions
 *
 * adapter adaptive functions.
 *
 * @{
 */
...
/**
 * @brief Adaptive Function `adapter_objectCallback_signature`
...
/** @brief Function definition pool_bytes_in_use */
extern const afw_value_function_definition_t
afw_function_definition_pool_bytes_in_use;

/**
 * @brief Adaptive Function `pool_bytes_in_use`
 * @param x function execute parameter.
 *
...
/** @brief Function definition process_rss */
extern const afw_value_function_definition_t
afw_function_definition_process_rss;

/**
 * @brief Adaptive Function `process_rss`
 * @param x function execute parameter.
 *
 ...
 * Supported `<dataType>`:
 *
 *   json, regexp, relaxed_json, script, template, xpathExpression.
 *
 * Declaration:
 *
 * ```
 ...
 */
#define AFW_DATA_TYPE_METHOD_ID_MAP(_XX)                                       \
    _XX(at_least_one_member_of)                                                \
    _XX(bag)                                                                   \
    _XX(bag_size)                                                              \
    _XX(ends_with)                                                             \
    _XX(eq)                                                                    \
    ...
    _XX(splice)                                                                \
    _XX(unshift)                                                               \
    _XX(decode_to_string)                                                      \
    _XX(add_dayTimeDuration)                                                   \
    _XX(add_yearMonthDuration)                                                 \
    _XX(max)                                                                   \
    _XX(min)                                                                   \
    _XX(subtract_dayTimeDuration)                                              \
    _XX(subtract_yearMonthDuration)                                            \
    _XX(abs)                                                                   \
    _XX(add)                                                                   \
    _XX(ceil)                                                                  \
    _XX(divide)                                                                \
    ...
    _XX(keys)                                                                  \
    _XX(values)                                                                \
    _XX(encode_as_base64Binary)                                                \
    _XX(encode_as_hexBinary)                                                   \
    _XX(eq_ignore_case)                                                        \
    _XX(eval)                                                                  \
    _XX(in_range)                                                              \
    _XX(match)                                                                 \
    _XX(normalize_space)                                                       \
    _XX(normalize_to_lower_case)                                               \
    _XX(to_anyURI)                                                             \
    _XX(to_boolean)                                                            \
    _XX(to_date)                                                               \
    _XX(to_dateTime)                                                           \
    _XX(to_dayTimeDuration)                                                    \
    _XX(to_dnsName)                                                            \
    _XX(to_ipAddress)                                                          \
    _XX(to_rfc822Name)                                                         \
    _XX(to_time)                                                               \
    _XX(to_x500Name)                                                           \
    _XX(to_yearMonthDuration)                                                  \
    _XX(url_decode)                                                            \
...
#define XX(_id) afw_data_type_method_number_ ## _id,
