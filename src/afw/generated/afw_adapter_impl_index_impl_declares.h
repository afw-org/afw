...
/**
 * @addtogroup afw_adapter_impl_index_impl_declares afw_adapter_impl_index
 * @{
 *
 ...
 * generated/interface_closet/skeleton_afw_adapter_impl_index.c.
 *
 * Mutiple *_impl.declares.h can be included in each c source file, but only
 * one for each interface name.
 *
 * After the #include for  afw_adapter_impl_index_impl_declares.h:
 *
 * 1. declarations will exist for all of the interfaces methods with names of
 *    impl_afw_adapter_impl_index_ followed by the method name.
 * 2. rti will be defined with a name of impl_afw_adapter_impl_index_rti.
 * 3. inf will be defined with a name of impl_afw_adapter_impl_index_inf.
 *
 ...
 *
 *   AFW_IMPLEMENTATION_INF_LABEL - (optional) defaults to 'impl_afw_adapter_impl_index_inf'.
 *
 *   AFW_ADAPTER_IMPL_INDEX_SELF_T - (optional) defaults to 'const afw_adapter_impl_index_t'.
 ...
 *
 * A second #include "afw_adapter_impl_index_impl_declares.h" can be specified if
" *   #define "AFW_ADAPTER_IMPL_INDEX_INF_ONLY" is specified to generate inf only."
 *~~~~~~~~~~~~~~~
 */


/**
 * @file afw_adapter_impl_index_impl_declares.h
 * @brief Interface afw_interface implementation declares.
 */

#ifdef __AFW_ADAPTER_IMPL_INDEX_IMPL_DECLARES_H__
#ifndef AFW_ADAPTER_IMPL_INDEX_INF_ONLY
#error "afw_adapter_impl_index_impl_declares.h already included."
#endif
#endif
#ifndef __AFW_ADAPTER_IMPL_INDEX_IMPL_DECLARES_H__
#ifdef AFW_ADAPTER_IMPL_INDEX_INF_ONLY
#error "afw_adapter_impl_index_impl_declares.h must be included before AFW_ADAPTER_IMPL_INDEX_INF_ONLY."
#endif
#define __AFW_ADAPTER_IMPL_INDEX_IMPL_DECLARES_H__ 1
#endif
...
#ifndef AFW_ADAPTER_IMPL_INDEX_SELF_T
#define AFW_ADAPTER_IMPL_INDEX_SELF_T const afw_adapter_impl_index_t
#endif

#ifndef AFW_ADAPTER_IMPL_INDEX_INF_ONLY

#ifndef impl_afw_adapter_impl_index_open
/* Declare method open */
...
#ifndef impl_afw_adapter_impl_index_release
...
#ifndef impl_afw_adapter_impl_index_get_index_definitions
...
#ifndef impl_afw_adapter_impl_index_update_index_definitions
...
#ifndef impl_afw_adapter_impl_index_open_cursor
/* Declare method open_cursor */
AFW_DECLARE_STATIC(afw_adapter_impl_index_cursor_t *)
...
#ifndef impl_afw_adapter_impl_index_get_session
...
/* inf for interface afw_adapter_impl_index */
#ifdef __BASE_FILE__
...
AFW_IMPLEMENTATION_INF_SPECIFIER(afw_adapter_impl_index_inf_t)
#else
static const afw_adapter_impl_index_inf_t
#endif
#ifdef AFW_IMPLEMENTATION_INF_LABEL
AFW_IMPLEMENTATION_INF_LABEL = {
#else
impl_afw_adapter_impl_index_inf = {
#endif
    {
        AFW_UTF8_LITERAL("afw_adapter_impl_index"),
