...
/* This is the inf for unmanaged object values. For this one */
/* optional_release is NULL and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "object"
#define AFW_IMPLEMENTATION_INF_SPECIFIER AFW_DEFINE_CONST_DATA
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_evaluated_object_inf
...
afw_data_type_object_direct = {
    ...
    (const afw_list_t *)&impl_empty_list_of_object,
    (const afw_value_t *)&impl_value_empty_list_of_object,
...
/* Allocate function for unmanaged data type object values. */
...
afw_value_allocate_object(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_object_t),
        xctx);
    result->inf = &afw_value_evaluated_object_inf;
    return result;
}
...
afw_value_allocate_permanent_object(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_object_t),
        xctx);
    result->inf = &afw_value_permanent_object_inf;
    return result;
}
    ...
    afw_xctx_t *xctx)
{
    ...
    info->optimized_value_data_type = afw_data_type_object;
}


/* Get next value from list of object. */
AFW_DEFINE(const afw_object_t *)
afw_list_of_object_get_next_source(
...
/* Add value from list of object */
AFW_DEFINE(void)
afw_list_of_object_add(
    const afw_list_t *instance,
...
/* Remove value from list of object */
AFW_DEFINE(void)
afw_list_of_object_remove(
    const afw_list_t *instance,
    const afw_object_t *value,
    afw_xctx_t *xctx)
{
