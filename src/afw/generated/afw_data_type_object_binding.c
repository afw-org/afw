...
/* Declares and rti/inf defines for interface afw_value */
/* This is the inf for referenced object values. For this one */
/* optional_release releases value and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "referenced_object"
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_referenced_object_inf
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_object_unmanaged(internal, object->p, xctx);
...
/* Create function for referenced data type object value. */
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_pool_calloc(p, sizeof(afw_value_object_t),
        xctx);
    v->inf = &afw_value_referenced_object_inf;
    v->internal = internal;
    return &v->pub;
}
