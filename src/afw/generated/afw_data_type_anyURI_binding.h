 ...
 * @brief Adaptive data type anyURI header.
 */
...
/**
 * @brief Permanent managed (life of afw environment) value inf for data type anyURI.
 *
...
/**
 * @brief Macro to determine if value is evaluated anyURI.
...
/**
 * @brief Macro to determine if value is evaluated array of anyURI.
 * @param A_VALUE to test.
 * @return boolean result.
 */
...
/**
 * @brief Allocate function for unmanaged data type anyURI value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_anyURI_t with appropriate inf set.
 */
...
afw_value_create_anyURI_unmanaged(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx);

/**
 * @brief Allocate function for managed data type anyURI value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_anyURI_t with appropriate inf set.
 */
AFW_DECLARE(afw_value_anyURI_t *)
afw_value_allocate_managed_anyURI(const afw_pool_t *p, afw_xctx_t *xctx);
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_managed_anyURI(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx);

/**
 * @brief Allocate function for permanent data type anyURI value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_anyURI_t with appropriate inf set.
 */
AFW_DECLARE(afw_value_anyURI_t *)
afw_value_allocate_permanent_anyURI(const afw_pool_t *p, afw_xctx_t *xctx);

/**
 * @brief Create function for permanent data type anyURI value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_permanent_anyURI(const afw_utf8_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx);
