...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_object\
)

/**
 * @brief Macro to determine if value is evaluated list of object.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_object(A_VALUE) \
( \
...
/**
 * @brief Get next value from list of object.
 ...
 */
#define afw_list_of_object_get_next( \
    list, iterator, xctx) \
...
/**
 * @brief Add value from list of object.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of object.
 * @param instance of list.
