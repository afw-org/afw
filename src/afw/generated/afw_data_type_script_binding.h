...
/**
 * @addtogroup afw_c_api_data_type_script script
 *
 * Adaptive Data Type script
 *
 * @{
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_script\
)

/**
 * @brief Macro to determine if value is evaluated list of script.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_script(A_VALUE) \
( \
...
/**
 * @brief Allocate function for permanent data type script value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_script_t with appropriate inf set.
 */
AFW_DECLARE(afw_value_script_t *)
afw_value_allocate_permanent_script(const afw_pool_t *p, afw_xctx_t *xctx);
...
/**
 * @brief Get next value from list of script.
 ...
 */
#define afw_list_of_script_get_next( \
    list, iterator, xctx) \
    afw_list_of_script_get_next_source( \
...
/**
 * @brief Add value from list of script.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_list_of_script_add(
    const afw_list_t *instance,
    const afw_utf8_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Remove value from list of script.
 * @param instance of list.
 * @param value to remove.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_list_of_script_remove(
    const afw_list_t *instance,
    const afw_utf8_t *value,
    afw_xctx_t *xctx);
