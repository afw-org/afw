...
/* This is the inf for unmanaged anyURI values. For this one */
/* optional_release is NULL and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "anyURI"
#define AFW_IMPLEMENTATION_INF_SPECIFIER AFW_DEFINE_CONST_DATA
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_evaluated_anyURI_inf
...
afw_data_type_anyURI_direct = {
    ...
    sizeof(afw_utf8_t),
    (const afw_list_t *)&impl_empty_list_of_anyURI,
    (const afw_value_t *)&impl_value_empty_list_of_anyURI,
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_anyURI(internal, object->p, xctx);
...
/* Allocate function for unmanaged data type anyURI values. */
...
afw_value_allocate_anyURI(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_anyURI_t),
        xctx);
    result->inf = &afw_value_evaluated_anyURI_inf;
    return result;
}
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_anyURI(p, xctx);
    if (internal) {
...
/* Allocate function for managed data type anyURI values. */
AFW_DEFINE(afw_value_anyURI_t *)
afw_value_allocate_managed_anyURI(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_anyURI_t),
        xctx);
    result->inf = &afw_value_managed_anyURI_inf;
    return result;
}
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_managed_anyURI(p, xctx);
    if (internal) {
        memcpy(&v->internal, internal, sizeof(afw_utf8_t));
    }
    return (const afw_value_t *)v;
...
/* Allocate function for permanent data type anyURI values. */
AFW_DEFINE(afw_value_anyURI_t *)
afw_value_allocate_permanent_anyURI(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_anyURI_t),
        xctx);
    result->inf = &afw_value_permanent_anyURI_inf;
    return result;
}
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_permanent_anyURI(p, xctx);
    if (internal) {
        memcpy(&v->internal, internal, sizeof(afw_utf8_t));
    }
    return (const afw_value_t *)v;
    ...
    afw_xctx_t *xctx)
{
    ...
    info->optimized_value_data_type = afw_data_type_anyURI;
}


/* Get next value from list of anyURI. */
AFW_DEFINE(const afw_utf8_t *)
...
/* Remove value from list of anyURI */
AFW_DEFINE(void)
