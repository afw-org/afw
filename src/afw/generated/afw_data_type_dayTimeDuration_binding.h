 ...
 */
AFW_DECLARE(void)
afw_data_type_dayTimeDuration_to_internal(
    afw_dayTimeDuration_t *to_internal,
...
afw_data_type_dayTimeDuration_to_utf8(
...
/** @brief struct for managed data type dayTimeDuration values.
 *
 * This is the same as afw_value_dayTimeDuration_s with the addition of a
 * reference count. This is intended for internal use only.
 */
struct afw_value_dayTimeDuration_managed_s {
    /** @brief  Value inf union with afw_value_t pub to reduce casting needed. */
    union {
        const afw_value_inf_t *inf;
        afw_value_t pub;
 ...
 * @param xctx of caller.
 * @return Allocated afw_value_dayTimeDuration_t with unmanaged inf set.
 *
...
afw_value_dayTimeDuration_allocate(
    const afw_pool_t *p,
    afw_xctx_t *xctx);
#define afw_value_allocate_unmanaged_dayTimeDuration afw_value_dayTimeDuration_allocate

/**
 * @brief Create function for managed data type dayTimeDuration value.
 * @param internal.
 * @param xctx of caller.
...
afw_value_dayTimeDuration_create_managed(
    const afw_dayTimeDuration_t * internal,
    afw_xctx_t *xctx);
#define afw_value_create_managed_dayTimeDuration afw_value_dayTimeDuration_create_managed

/**
 * @brief Deep clone an evaluated dayTimeDuration value unmanaged into p.
 * @param value evaluated dayTimeDuration.
 * @param p dest pool.
 * @param xctx of caller.
...
/**
 * @brief Clone an evaluated dayTimeDuration value managed in xctx->p.
 * @param value evaluated dayTimeDuration.
 * @param xctx of caller.
...
/**
 * @brief Get property function for data type dayTimeDuration internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_dayTimeDuration_t *.
...
/**
 * @brief Get next property function for data type dayTimeDuration internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
...
/**
 * @brief Public data type dayTimeDuration struct instance.
 *
 * Prefer afw_data_type_dayTimeDuration when a pointer is enough and you are not
...
/**
 * @brief Public data type dayTimeDuration inf.
 *
