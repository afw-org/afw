 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_referenced_dayTimeDuration_inf;
...
/**
 * @brief Allocate function for referenced data type dayTimeDuration value.
...
afw_value_alloc_referenced_dayTimeDuration(
    afw_dayTimeDuration_t **internal,
    afw_xctx_t *xctx);
...
/**
 * @brief Create function for referenced data type dayTimeDuration value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
