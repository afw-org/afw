...
/**
 * @addtogroup afw_c_api_data_type_dayTimeDuration dayTimeDuration
 *
 * Adaptive Data Type dayTimeDuration
 *
 * @{
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_dayTimeDuration\
)

/**
 * @brief Macro to determine if value is evaluated list of dayTimeDuration.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_dayTimeDuration(A_VALUE) \
( \
...
/**
 * @brief Allocate function for permanent data type dayTimeDuration value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_dayTimeDuration_t with appropriate inf set.
 */
...
/**
 * @brief Get next value from list of dayTimeDuration.
 ...
 */
#define afw_list_of_dayTimeDuration_get_next( \
    list, iterator, xctx) \
    afw_list_of_dayTimeDuration_get_next_source( \
...
/**
 * @brief Add value from list of dayTimeDuration.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_list_of_dayTimeDuration_add(
    const afw_list_t *instance,
    const afw_dayTimeDuration_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Remove value from list of dayTimeDuration.
 * @param instance of list.
 * @param value to remove.
 * @param xctx of caller.
 */
AFW_DECLARE(void)
afw_list_of_dayTimeDuration_remove(
    const afw_list_t *instance,
    const afw_dayTimeDuration_t *value,
    afw_xctx_t *xctx);
