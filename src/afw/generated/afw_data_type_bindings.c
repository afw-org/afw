    ...
    afw_xctx_t *xctx)
{
    ...
    afw_environment_register_value_inf(
        &afw_value_evaluated_anyURI_inf.rti.implementation_id,
    ...
    afw_environment_register_value_inf(
        &afw_value_evaluated_ia5String_inf.rti.implementation_id,
    ...
    afw_environment_register_value_inf(
        &afw_value_evaluated_script_inf.rti.implementation_id,
        &afw_value_evaluated_script_inf,
        xctx);

    /* Register value inf id evaluated_string */
    afw_environment_register_value_inf(
        &afw_value_evaluated_string_inf.rti.implementation_id,
        &afw_value_evaluated_string_inf,
        xctx);

    /* Register value inf id evaluated_template */
    afw_environment_register_value_inf(
        &afw_value_evaluated_template_inf.rti.implementation_id,
        &afw_value_evaluated_template_inf,
        xctx);

    /* Register value inf id evaluated_time */
    afw_environment_register_value_inf(
        &afw_value_evaluated_time_inf.rti.implementation_id,
    ...
    afw_environment_register_value_inf(
        &afw_value_evaluated_yearMonthDuration_inf.rti.implementation_id,
