...
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_function_inf
...
/* Declares and rti/inf defines for interface afw_value */
/* This is the inf for referenced function values. For this one */
/* optional_release releases value and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "referenced_function"
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_referenced_function_inf
...
afw_value_allocate_function(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_function_t),
        xctx);
    result->inf = &afw_value_function_inf;
    return result;
}

/* Create function for referenced data type function value. */
AFW_DEFINE(const afw_value_t *)
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_pool_calloc(p, sizeof(afw_value_function_t),
        xctx);
    v->inf = &afw_value_referenced_function_inf;
    v->internal = internal;
    return &v->pub;
}
