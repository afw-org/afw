...
/* This is the inf for unmanaged function values. For this one */
/* optional_release is NULL and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "function"
#define AFW_IMPLEMENTATION_INF_SPECIFIER AFW_DEFINE_CONST_DATA
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_evaluated_function_inf
...
impl_data_type_function_id_value = {
...
{
    (const afw_value_t *)&impl_data_type_function_id_value
};

static const afw_utf8_t
impl_data_type_path_function =
    AFW_UTF8_LITERAL("/afw/_AdaptiveDataType_/function");

/* Data type function object. */
static const afw_runtime_object_indirect_t
impl_data_type_object_function = {
    {
    ...
    (void *)&afw_data_type_function_direct
};

/* Value for empty list of function. */
AFW_DEFINE_INTERNAL_CONST_DATA(afw_list_wrapper_for_array_self_t)
impl_empty_list_of_function;

/* Value for empty list of function. */
AFW_DEFINE_INTERNAL_CONST_DATA(afw_value_list_t)
impl_value_empty_list_of_function;
...
afw_data_type_function_direct = {
    ...
    (const afw_list_t *)&impl_empty_list_of_function,
    (const afw_value_t *)&impl_value_empty_list_of_function,
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_function(internal, object->p, xctx);
...
/* Allocate function for unmanaged data type function values. */
AFW_DEFINE(afw_value_function_t *)
afw_value_allocate_function(const afw_pool_t *p, afw_xctx_t *xctx)
{
    afw_value_function_t *result;

    result = afw_pool_calloc(p, sizeof(afw_value_function_t),
        xctx);
    result->inf = &afw_value_evaluated_function_inf;
    return result;
}
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_function(p, xctx);
    v->internal = internal;
    return (const afw_value_t *)v;
}

/* Allocate function for managed data type function values. */
AFW_DEFINE(afw_value_function_t *)
afw_value_allocate_managed_function(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_function_t),
        xctx);
    result->inf = &afw_value_managed_function_inf;
    return result;
}

/* Create function for data type function value. */
AFW_DEFINE(const afw_value_t *)
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_managed_function(p, xctx);
    v->internal = internal;
    return (const afw_value_t *)v;
}

/* Allocate function for permanent data type function values. */
AFW_DEFINE(afw_value_function_t *)
afw_value_allocate_permanent_function(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_function_t),
        xctx);
    result->inf = &afw_value_permanent_function_inf;
    return result;
}
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    v = afw_value_allocate_permanent_function(p, xctx);
    v->internal = internal;
    return (const afw_value_t *)v;
}

/* Convert data type function string to const afw_value_t * *. */
AFW_DEFINE(void)
...
/*  Convert data type function internal representation to utf-8. */
    ...
    afw_xctx_t *xctx)
{
    ...
    info->optimized_value_data_type = afw_data_type_function;
}


/* Get next value from list of function. */
AFW_DEFINE(const afw_value_t *)
...
/* Add value from list of function */
AFW_DEFINE(void)
...
/* Remove value from list of function */
AFW_DEFINE(void)
