...
/* unmanaged json: optional_release NULL; */
...
/* Declares and rti/inf defines for interface afw_value */
/* managed json: optional_release frees header at RC 0; */
...
/* Declares and rti/inf defines for interface afw_value */
/* managed_slice json: RC on containing managed value; */
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_unmanaged_json(internal, object->p, xctx);
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_xctx_calloc(sizeof(afw_value_json_managed_slice_t), xctx);
    v->inf = &afw_value_managed_slice_json_inf;
    v->internal.s = base->s + offset;
    v->internal.len = len;
    v->containing_value = containing;
    ((afw_value_json_managed_t *)containing)->reference_count++;
    return &v->pub;
}
    ...
    afw_xctx_t *xctx)
{
    ...
    (void)p;
    boxed = afw_value_create_managed_json(
        &self->internal, xctx);
...
impl_afw_value_managed_slice_get_reference(
    ...
    afw_xctx_t *xctx)
{
    const afw_value_json_managed_slice_t *self =
        (const afw_value_json_managed_slice_t *)instance;
    afw_value_json_managed_t *containing =
        (afw_value_json_managed_t *)self->containing_value;
    afw_value_json_managed_slice_t *v;
