...
/**
 * @brief Unmanaged evaluated value inf for data type void.
 *
...
/**
 * @brief Managed evaluated value inf for data type void.
 *
 * The lifetime of the value is managed by reference.
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_managed_void_inf;

/**
 * @brief Permanent managed (life of afw environment) value inf for data type void.
 *
...
/**
 * @brief Macro to determine if value is evaluated void.
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_void\
)

/**
 * @brief Macro to determine if value is evaluated array of void.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_array_of_void(A_VALUE) \
( \
    afw_value_is_array(A_VALUE) && \
    afw_array_get_data_type( \
        ((const afw_value_array_t *)(A_VALUE))->internal, \
        xctx) == afw_data_type_void \
)

/**
 * @brief Convert data type void string to void * *.
...
/**
 * @brief Convert data type void internal representation to utf-8.
...
/**
 * @brief Typesafe cast of data type void.
...
/**
 * @brief Allocate function for unmanaged data type void value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_void_t with appropriate inf set.
 */
AFW_DECLARE(afw_value_void_t *)
afw_value_allocate_void(const afw_pool_t *p, afw_xctx_t *xctx);

/**
 * @brief Create function for unmanaged data type void value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
...
/**
 * @brief Allocate function for managed data type void value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_void_t with appropriate inf set.
 */
...
/**
 * @brief Create function for managed data type void value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
...
/**
 * @brief Allocate function for permanent data type void value.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Allocated afw_value_void_t with appropriate inf set.
 */
...
/**
 * @brief Create function for permanent data type void value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 * @return Created const afw_value_t *.
...
/**
 * @brief Get property function for data type void value.
 * @deprecated
 ...
 *
 */
#define afw_object_old_get_property_as_void( \
 ...
 * @return void *.
 */
#define afw_object_get_property_as_void( \
...
/**
 * @brief Get next property function for data type void value.
 * @deprecated
 * @param object of property to get.
 ...
 *
 */
#define afw_object_old_get_next_property_as_void( \
 ...
 * @return void *.
 */
#define afw_object_get_next_property_as_void( \
...
/**
 * @brief Set property function for data type void values.
...
/**
 * @brief Get next value from array of void.
 ...
 */
#define afw_array_of_void_get_next( \
    array, iterator, xctx) \
...
/**
 * @brief Add value from array of void.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from array of void.
 * @param instance of array.
