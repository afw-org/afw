...
/**
 * @brief Macro to determine if value is evaluated list of void.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_void(A_VALUE) \
( \
...
/**
 * @brief Get next value from list of void.
 ...
 */
#define afw_list_of_void_get_next( \
    list, iterator, xctx) \
...
/**
 * @brief Add value from list of void.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of void.
 * @param instance of list.
