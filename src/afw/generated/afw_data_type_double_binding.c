...
/* This is the inf for unmanaged double values. For this one */
/* optional_release is NULL and get_reference returns new reference. */
#define AFW_IMPLEMENTATION_ID "double"
#define AFW_IMPLEMENTATION_INF_SPECIFIER AFW_DEFINE_CONST_DATA
#define AFW_IMPLEMENTATION_INF_LABEL afw_value_evaluated_double_inf
...
afw_data_type_double_direct = {
    ...
    AFW_UTF8_LITERAL("double"),
    sizeof(double),
    (const afw_list_t *)&impl_empty_list_of_double,
    (const afw_value_t *)&impl_value_empty_list_of_double,
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_double(internal, object->p, xctx);
...
/* Allocate function for unmanaged data type double values. */
...
afw_value_allocate_double(const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    result = afw_pool_calloc(p, sizeof(afw_value_double_t),
        xctx);
    result->inf = &afw_value_evaluated_double_inf;
    return result;
}
    ...
    afw_xctx_t *xctx)
{
    ...
    info->optimized_value_data_type = afw_data_type_double;
}


/* Get next value from list of double. */
AFW_DEFINE(double)
...
/* Remove value from list of double */
AFW_DEFINE(void)
