    ...
    afw_xctx_t *xctx)
{
    ...
    info->optimized_value_data_type = afw_data_type_boolean;
}


/* Get next value from list of boolean. */
AFW_DEFINE(afw_boolean_t)
...
/* Add value from list of boolean */
AFW_DEFINE(void)
...
/* Remove value from list of boolean */
AFW_DEFINE(void)
