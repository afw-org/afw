...
/* Allocate function for managed data type boolean value. */
AFW_DEFINE(const afw_value_t *)
afw_value_allocate_managed_boolean(
    afw_boolean_t **internal,
    afw_xctx_t *xctx)
{
    afw_value_boolean_managed_t *result;

    result = afw_xctx_malloc(sizeof(afw_value_boolean_managed_t), xctx);
...
afw_value_allocate_unmanaged_boolean(const afw_pool_t *p, afw_xctx_t *xctx)
{
