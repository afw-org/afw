...
/**
 * @addtogroup afw_adaptor_journal_impl_declares afw_adaptor_journal
 * @{
 *
 ...
 * generated/interface_closet/skeleton_afw_adaptor_journal.c.
 *
 ...
 *    impl_afw_adaptor_journal_ followed by the method name.
...
#ifdef __AFW_ADAPTOR_JOURNAL_IMPL_DECLARES_H__
#ifndef AFW_ADAPTOR_JOURNAL_INF_ONLY
#error "afw_adaptor_journal_impl_declares.h already included."
#endif
#endif
#ifndef __AFW_ADAPTOR_JOURNAL_IMPL_DECLARES_H__
#ifdef AFW_ADAPTOR_JOURNAL_INF_ONLY
#error "afw_adaptor_journal_impl_declares.h must be included before AFW_ADAPTOR_JOURNAL_INF_ONLY."
#endif
...
#ifndef impl_afw_adaptor_journal_get_entry
...
#ifndef impl_afw_adaptor_journal_mark_entry_consumed
...
/* inf for interface afw_adaptor_journal */
#ifdef __BASE_FILE__
...
AFW_IMPLEMENTATION_INF_SPECIFIER(afw_adaptor_journal_inf_t)
#else
static const afw_adaptor_journal_inf_t
#endif
#ifdef AFW_IMPLEMENTATION_INF_LABEL
AFW_IMPLEMENTATION_INF_LABEL = {
#else
impl_afw_adaptor_journal_inf = {
#endif
    {
