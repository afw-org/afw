 ...
 */
AFW_DECLARE_CONST_DATA(afw_value_inf_t)
afw_value_referenced_function_inf;
...
/**
 * @brief Allocate function for referenced data type function value.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_alloc_referenced_function(
    const afw_value_t * **internal,
    afw_xctx_t *xctx);
...
/**
 * @brief Create function for referenced data type function value.
 * @param internal.
 * @param p to use for returned value.
 * @param xctx of caller.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_create_referenced_function(const afw_value_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx);
