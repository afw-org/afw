...
/**
 * @brief Typesafe cast to evaluated function value.
 * @param value (const afw_value_t *). Evaluated if needed.
 * @return (const afw_value_function_t *)
 *
 * Throws if missing or wrong type. Use ->internal for the C
 * payload, or afw_value_as_function_internal().
 */
AFW_DECLARE(const afw_value_function_t *)
afw_value_as_function(
    const afw_value_t *value,
    afw_xctx_t *xctx);

/**
 * @brief Typesafe peel of data type function internal.
 * @param value (const afw_value_t *).
 * @return (const afw_value_t *)
 */
AFW_DECLARE(const afw_value_t *)
afw_value_as_function_internal(
    const afw_value_t *value,
    afw_xctx_t *xctx);
...
afw_value_function_allocate(
    const afw_pool_t *p,
    afw_xctx_t *xctx);
#define afw_value_allocate_unmanaged_function afw_value_function_allocate
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_function_create_managed(
    const afw_value_t * internal,
    afw_xctx_t *xctx);
#define afw_value_create_managed_function afw_value_function_create_managed

/**
 * @brief Deep clone an evaluated function value unmanaged into p.
 * @param value evaluated function.
 * @param p dest pool.
 * @param xctx of caller.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_clone_function_unmanaged(
    const afw_value_t *value,
    const afw_pool_t *p,
    afw_xctx_t *xctx);

/**
 * @brief Clone an evaluated function value managed in xctx->p.
 * @param value evaluated function.
 * @param xctx of caller.
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_clone_function_managed(
    const afw_value_t *value,
    afw_xctx_t *xctx);
 ...
 */
AFW_DECLARE(const afw_value_t *)
afw_value_function_create(const afw_value_t * internal,
    const afw_pool_t *p, afw_xctx_t *xctx);
#define afw_value_create_unmanaged_function afw_value_function_create

/**
 * @brief Get property as function value.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return (const afw_value_function_t *) or NULL if missing.
 *
 * Does not evaluate. Throws if present but not function.
 */
...
/**
 * @brief Get property function for data type function internal.
 * @param object of property to get.
 * @param property_name of property to get.
 * @param xctx of caller.
 * @return const afw_value_t *.
 */
#define afw_object_get_property_as_function_internal( \
    object, property_name, xctx) \
...
/**
 * @brief Get next property function for data type function internal.
 * @param object of property to get.
 * @param iterator pointer. Set to NULL before first call.
 * @param property_name is place to return pointer to property name.
 * @param xctx of caller.
 * @return const afw_value_t *.
 */
#define afw_object_get_next_property_as_function_internal( \
    object, iterator, property_name, xctx) \
...
/**
 * @brief Get next function value from array of function.
 * @param instance of array.
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_value_function_t *) or NULL.
 *
...
/**
 * @brief Get next function internal from array of function.
 * @param instance of array.
 * @param iterator.
 * @param xctx of caller.
 * @return (const afw_value_t *) or NULL.
 */
#define afw_array_of_function_get_next_internal( \
    array, iterator, xctx) \
...
/**
 * @brief Add a function value to array of function.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Add a function internal to array of function.
 * @param instance of array.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove a function value from array of function.
 * @param instance of array.
...
/**
 * @brief Remove a function internal from array of function.
 * @param instance of array.
 * @param value to remove.
 * @param xctx of caller.
 */
...
/**
 * @brief Public data type function struct instance.
 *
 * Prefer afw_data_type_function when a pointer is enough and you are not
...
/**
 * @brief Public data type function inf.
 *
