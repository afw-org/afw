...
afw_data_type_ipAddress_direct = {
    ...
    sizeof(afw_utf8_t),
    (const afw_list_t *)&impl_empty_list_of_ipAddress,
    (const afw_value_t *)&impl_value_empty_list_of_ipAddress,
    ...
    afw_xctx_t *xctx)
{
    ...
    info->optimized_value_data_type = afw_data_type_ipAddress;
}


/* Get next value from list of ipAddress. */
AFW_DEFINE(const afw_utf8_t *)
...
/* Add value from list of ipAddress */
AFW_DEFINE(void)
...
/* Remove value from list of ipAddress */
AFW_DEFINE(void)
