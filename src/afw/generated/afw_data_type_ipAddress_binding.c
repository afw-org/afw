...
/* Declares and rti/inf defines for interface afw_value */
/* managed_slice ipAddress: RC on containing managed value; */
...
impl_afw_value_get_reference(
    ...
    afw_xctx_t *xctx)
{
    const afw_value_ipAddress_t *self =
        (const afw_value_ipAddress_t *)instance;
    const afw_value_t *boxed;

    (void)p;
    boxed = afw_value_create_managed_ipAddress(
        &self->internal, xctx);
