...
/**
 * @addtogroup afw_c_api_data_type_unevaluated unevaluated
 *
 * Adaptive Data Type unevaluated
 *
 * @{
...
( \
    (A_VALUE) && \
    (A_VALUE)->inf->fully_evaluated_data_type == afw_data_type_unevaluated\
)

/**
 * @brief Macro to determine if value is evaluated list of unevaluated.
 * @param A_VALUE to test.
 * @return boolean result.
 */
#define afw_value_is_list_of_unevaluated(A_VALUE) \
( \
...
/**
 * @brief Allocate function for unmanaged data type unevaluated value.
...
/**
 * @brief Get next value from list of unevaluated.
 ...
 */
#define afw_list_of_unevaluated_get_next( \
    list, iterator, xctx) \
...
/**
 * @brief Add value from list of unevaluated.
 * @param instance of list.
 * @param value to add.
 * @param xctx of caller.
 */
...
/**
 * @brief Remove value from list of unevaluated.
 * @param instance of list.
