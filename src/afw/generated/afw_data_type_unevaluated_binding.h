 ...
 */
#define afw_data_type_is_unevaluated(_A_DATA_TYPE) \
( \
    (_A_DATA_TYPE) && \
    (_A_DATA_TYPE) == afw_data_type_unevaluated \
)

/**
 * @brief True if _A_VALUE is an evaluated unevaluated value.
 ...
 * `AFW_VALUE_EVALUATES_TO_DATA_TYPE(_A_VALUE, unevaluated, xctx)` instead.
 */
#define afw_value_is_unevaluated(_A_VALUE) \
( \
    (_A_VALUE) && \
    (_A_VALUE)->inf->is_evaluated_of_data_type == afw_data_type_unevaluated\
)

/**
 * @brief True if _A_VALUE is an evaluated array of unevaluated.
 * @param _A_VALUE to test.
 * @return boolean result.
 *
 ...
 */
#define afw_value_is_array_of_unevaluated(_A_VALUE) \
( \
