...
/**
 * @addtogroup afw_request_handler_factory_impl_declares afw_request_handler_factory
 * @{
 *
 ...
 * generated/interface_closet/skeleton_afw_request_handler_factory.c.
 *
 * Mutiple *_impl.declares.h can be included in each c source file, but only
 * one for each interface name.
 *
 * After the #include for  afw_request_handler_factory_impl_declares.h:
 *
 * 1. declarations will exist for all of the interfaces methods with names of
 *    impl_afw_request_handler_factory_ followed by the method name.
 * 2. rti will be defined with a name of impl_afw_request_handler_factory_rti.
 * 3. inf will be defined with a name of impl_afw_request_handler_factory_inf.
 *
 ...
 *
 * A second #include "afw_request_handler_factory_impl_declares.h" can be specified if
" *   #define "AFW_REQUEST_HANDLER_FACTORY_INF_ONLY" is specified to generate inf only."
 *~~~~~~~~~~~~~~~
 */


/**
 * @file afw_request_handler_factory_impl_declares.h
 * @brief Interface afw_interface implementation declares.
 */

#ifdef __AFW_REQUEST_HANDLER_FACTORY_IMPL_DECLARES_H__
#ifndef AFW_REQUEST_HANDLER_FACTORY_INF_ONLY
#error "afw_request_handler_factory_impl_declares.h already included."
#endif
#endif
#ifndef __AFW_REQUEST_HANDLER_FACTORY_IMPL_DECLARES_H__
#ifdef AFW_REQUEST_HANDLER_FACTORY_INF_ONLY
#error "afw_request_handler_factory_impl_declares.h must be included before AFW_REQUEST_HANDLER_FACTORY_INF_ONLY."
#endif
#define __AFW_REQUEST_HANDLER_FACTORY_IMPL_DECLARES_H__ 1
#endif
...
/* inf for interface afw_request_handler_factory */
#ifdef __BASE_FILE__
...
AFW_IMPLEMENTATION_INF_SPECIFIER(afw_request_handler_factory_inf_t)
#else
static const afw_request_handler_factory_inf_t
#endif
