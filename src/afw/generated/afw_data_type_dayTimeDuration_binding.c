...
/* unmanaged dayTimeDuration: optional_release NULL; */
...
/* Declares and rti/inf defines for interface afw_value */
/* managed dayTimeDuration: optional_release frees header at RC 0; */
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_create_unmanaged_dayTimeDuration(internal, object->p, xctx);
...
afw_value_allocate_unmanaged_dayTimeDuration(const afw_pool_t *p, afw_xctx_t *xctx)
{
...
afw_value_create_managed_dayTimeDuration(
    const afw_dayTimeDuration_t * internal,
    afw_xctx_t *xctx)
{
...
AFW_DEFINE(const afw_value_t *)
afw_value_create_unmanaged_dayTimeDuration(const afw_dayTimeDuration_t * internal,
    ...
    afw_xctx_t *xctx)
{
    ...
    (void)p;
    boxed = afw_value_create_managed_dayTimeDuration(
        &self->internal, xctx);
