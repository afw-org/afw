...
/* Value for empty list of dayTimeDuration. */
AFW_DEFINE_INTERNAL_CONST_DATA(afw_list_wrapper_for_array_self_t)
impl_empty_list_of_dayTimeDuration;

/* Value for empty list of dayTimeDuration. */
AFW_DEFINE_INTERNAL_CONST_DATA(afw_value_list_t)
impl_value_empty_list_of_dayTimeDuration;
...
afw_data_type_dayTimeDuration_direct = {
    ...
    (const afw_list_t *)&impl_empty_list_of_dayTimeDuration,
    (const afw_value_t *)&impl_value_empty_list_of_dayTimeDuration,
...
/* Get next value from list of dayTimeDuration. */
AFW_DEFINE(const afw_dayTimeDuration_t *)
...
/* Add value from list of dayTimeDuration */
AFW_DEFINE(void)
...
/* Remove value from list of dayTimeDuration */
AFW_DEFINE(void)
