...
/* Declares and rti/inf defines for interface afw_value */
/* permanent dayTimeDuration: optional_release NULL; */
...
impl_data_type_object_dayTimeDuration__value;
...
impl_data_type_object_dayTimeDuration = {
    {
        ...
        NULL,
        (const afw_value_t *)&impl_data_type_object_dayTimeDuration__value,
        {
            NULL,
            NULL,
...
/* Permanent empty array of dayTimeDuration. */
const afw_array_from_values_self_t
impl_empty_array_of_dayTimeDuration;

/* Permanent empty array value of dayTimeDuration. */
...
afw_data_type_dayTimeDuration_direct = {
    ...
    afw_value_clone_dayTimeDuration_unmanaged,
...
/* Typesafe peel of data type dayTimeDuration internal. */
AFW_DEFINE(const afw_dayTimeDuration_t *)
afw_value_as_dayTimeDuration_internal(const afw_value_t *value, afw_xctx_t *xctx)
{
    return &afw_value_as_dayTimeDuration(value, xctx)->internal;
}

/* Allocate function for data type dayTimeDuration values. */
AFW_DEFINE(afw_value_dayTimeDuration_t *)
afw_value_dayTimeDuration_allocate(const afw_pool_t *p, afw_xctx_t *xctx)
{
...
/* Deep clone evaluated dayTimeDuration unmanaged into p. */
AFW_DEFINE(const afw_value_t *)
afw_value_clone_dayTimeDuration_unmanaged(
    ...
    afw_xctx_t *xctx)
{
    ...
    cloned = afw_value_common_allocate(
        afw_data_type_dayTimeDuration, p, xctx);
    afw_data_type_clone_internal(afw_data_type_dayTimeDuration,
        (void *)&cloned->internal,
        (const void *)&((const afw_value_dayTimeDuration_t *)value)->internal,
        p, xctx);
    return &cloned->pub;
}
...
impl_afw_value_managed_optional_release(
    ...
    afw_xctx_t *xctx)
{
    afw_value_dayTimeDuration_managed_t *self =
        (afw_value_dayTimeDuration_managed_t *)instance;
...
/* Get next dayTimeDuration value from array of dayTimeDuration. */
AFW_DEFINE(const afw_value_dayTimeDuration_t *)
...
/* Get next dayTimeDuration internal from array of dayTimeDuration. */
AFW_DEFINE(const afw_dayTimeDuration_t *)
    ...
    afw_xctx_t *xctx)
{
    ...
    value = afw_array_of_dayTimeDuration_get_next_source(instance, iterator, source_z, xctx);
    if (!value) {
        return NULL;
    }
    return &value->internal;
...
/* Add a dayTimeDuration value to array of dayTimeDuration. */
AFW_DEFINE(void)
...
/* Add a dayTimeDuration internal to array of dayTimeDuration. */
AFW_DEFINE(void)
...
afw_array_of_dayTimeDuration_remove(
    ...
    afw_xctx_t *xctx)
{
    afw_array_of_dayTimeDuration_remove_internal(instance, &value->internal, xctx);
}

/* Remove a dayTimeDuration internal from array of dayTimeDuration. */
AFW_DEFINE(void)
    ...
    afw_xctx_t *xctx)
{
    ...
    v = afw_value_dayTimeDuration_create(value, xctx->p, xctx);
