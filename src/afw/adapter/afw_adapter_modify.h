...
#ifndef __AFW_ADAPTER_MODIFY_H__
#define __AFW_ADAPTER_MODIFY_H__
...
/**
 * @brief Adapter session modify type map.
 *
...
} afw_adapter_modify_entry_type_t;



/**  @brief Adapter modify entry. */
struct afw_adapter_modify_entry_s {
 ...
 * @param adapter_id of adapter used to patch object.
 ...
 * @param adapter_id Id of adapter used to update object.
 ...
 * @return
 *
 * Update an existing adaptive object via adapter.  Existing properties will be
 ...
 * update.
 *
 * This function calls an adapter modify method after converting the update object
 * to a modify request.
 */
AFW_DECLARE(void)
 ...
 */
AFW_DECLARE(afw_adapter_modify_entry_type_t)
afw_adapter_modify_entry_type(const afw_utf8_t *mnemonic);
...
afw_adapter_modify_entry_type_mnemonic(afw_adapter_modify_entry_type_t type);
...
afw_adapter_modify_entry_type_value(afw_adapter_modify_entry_type_t type);
 ...
 *
 */
AFW_DECLARE(const afw_adapter_modify_entry_t * const *)
 ...
 *
 * The original intent of this function is for use by adapter implementations
 * that store objects without their data type. When objects are retrieved from
 * this type of adapter, they are usually normalized which will convert values
 ...
 * @param adapter_id return pointer.
 ...
 * @param xctx of caller.
 *
 * Parameters adapter_id, object_type_id, object_id, and entries are pointers
