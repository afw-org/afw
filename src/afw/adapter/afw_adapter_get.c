    ...
    afw_xctx_t *xctx)
{
    ...
    /* Process object from adapter and cache it. */
    view = object;
    if (object) {
    ...
    afw_xctx_t *xctx)
{
    ...
    {
        return afw_adapter_internal_journal_get_entry(session, object_id, journal_entry,
            xctx);
    }
