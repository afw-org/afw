 ...
 *<<<ebnf*/
        ...
        afw_utf8_equal(s, &afw_self_s_false)        ||
        afw_utf8_equal(s, &afw_self_s_INF)          ||
        afw_utf8_equal(s, &afw_self_s_Infinity)     ||
        afw_utf8_equal(s, &afw_self_s_NaN)          ||
        afw_utf8_equal(s, &afw_self_s_null)         ||
        afw_utf8_equal(s, &afw_self_s_true)         ||
        afw_utf8_equal(s, &afw_self_s_undefined)    ||
 ...
 *<<<ebnf*/
        ...
        afw_utf8_equal(s, &afw_self_s_break)        ||
        afw_utf8_equal(s, &afw_self_s_case)         ||
        afw_utf8_equal(s, &afw_self_s_catch)        ||
        afw_utf8_equal(s, &afw_self_s_const)        ||
        afw_utf8_equal(s, &afw_self_s_continue)     ||
        afw_utf8_equal(s, &afw_self_s_default)      ||
        afw_utf8_equal(s, &afw_self_s_do)           ||
        afw_utf8_equal(s, &afw_self_s_else)         ||
        afw_utf8_equal(s, &afw_self_s_finally)      ||
        afw_utf8_equal(s, &afw_self_s_for)          ||
        afw_utf8_equal(s, &afw_self_s_function)     ||
        afw_utf8_equal(s, &afw_self_s_if)           ||
        afw_utf8_equal(s, &afw_self_s_let)          ||
        afw_utf8_equal(s, &afw_self_s_return)       ||
        afw_utf8_equal(s, &afw_self_s_switch)       ||
        afw_utf8_equal(s, &afw_self_s_throw)        ||
        afw_utf8_equal(s, &afw_self_s_try)          ||
        afw_utf8_equal(s, &afw_self_s_void)         ||
        afw_utf8_equal(s, &afw_self_s_while)        ||
 ...
 *<<<ebnf*/
        ...
        afw_utf8_equal(s, &afw_self_s_as)           ||
        afw_utf8_equal(s, &afw_self_s_async)        ||
        afw_utf8_equal(s, &afw_self_s_await)        ||
        afw_utf8_equal(s, &afw_self_s_class)        ||
        afw_utf8_equal(s, &afw_self_s_delete)       ||
        afw_utf8_equal(s, &afw_self_s_export)       ||
        afw_utf8_equal(s, &afw_self_s_extends)      ||
        afw_utf8_equal(s, &afw_self_s_from)         ||
        afw_utf8_equal(s, &afw_self_s_import)       ||
        afw_utf8_equal(s, &afw_self_s_in)           ||
        afw_utf8_equal(s, &afw_self_s_instanceof)   ||
        afw_utf8_equal(s, &afw_self_s_interface)    ||
        afw_utf8_equal(s, &afw_self_s_super)        ||
        afw_utf8_equal(s, &afw_self_s_this)         ||
        afw_utf8_equal(s, &afw_self_s_type)         ||
        afw_utf8_equal(s, &afw_self_s_typeof)       ||
        afw_utf8_equal(s, &afw_self_s_var)          ||
        afw_utf8_equal(s, &afw_self_s_with)         )
    {
        return true;
    }
