...
/*
 * Adaptive Framework afw_list interface for const arrays
 *
...
/**
 * @file afw_list_const_array.c
 * @brief Adaptive Framework afw_list interface for const arrays.
 */
...
#define AFW_IMPLEMENTATION_ID "afw_list_const_array_of_values"
 ...
 */
typedef struct impl_afw_list_const_array_of_values_self_s {
    afw_list_t pub;
...
} impl_afw_list_const_array_of_values_self_t;
    ...
    afw_xctx_t *xctx)
{
    ...
    return afw_list_const_create_array_of_values(values, count, p, xctx);
}
    ...
    afw_xctx_t *xctx)
{
    ...
    return afw_list_const_create_array_of_objects(objects, count, p, xctx);
}
...
afw_list_const_create_array_of_values(
    ...
    afw_xctx_t *xctx)
{
    impl_afw_list_const_array_of_values_self_t *self;

    self = afw_pool_calloc_type(p,
        impl_afw_list_const_array_of_values_self_t, xctx);
...
{
    impl_afw_list_const_array_of_values_self_t * self = 
        (impl_afw_list_const_array_of_values_self_t *)instance;
