...
/*
 * Adaptive Framework Register Generated (afw_lmdb_)
 *
...
#include "afw_lmdb_version_info.h"
...
static const afw_utf8_z_t * impl_version_info_z[] = {
    ...
    "version", AFW_LMDB_VERSION_STRING,
    "versionWithGitInfo", AFW_LMDB_VERSION_WITH_GIT_INFO,
    NULL
};

static const afw_utf8_t impl_version_info_path =
    AFW_UTF8_LITERAL("/afw/_AdaptiveVersionInfo_/afw_lmdb");
...
void afw_lmdb_generated_register(afw_xctx_t *xctx)
{
    ...
    afw_environment_register_functions(
        afw_lmdb_function_bindings_get(), xctx);
