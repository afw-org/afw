...
/*
 * Implementation of afw_adapter_session interface for LMDB
 *
...
/**
 * @file afw_lmdb_adapter_session.c
 * @brief Implementation of afw_adapter_session interface for LMDB
 */
...
void afw_lmdb_adapter_session_dump_objects(
...
afw_lmdb_adapter_session_t *afw_lmdb_adapter_session_create(
    afw_lmdb_adapter_t *adapter,
    afw_xctx_t *xctx)
{
    afw_lmdb_adapter_session_t *self;

    self = afw_xctx_calloc_type(afw_lmdb_adapter_session_t, xctx);
    ...
    self->indexer = afw_lmdb_adapter_impl_index_create(self, 
        adapter, NULL, xctx);
    ...
    afw_xctx_t *xctx)
{
    ...
    return (afw_adapter_transaction_t *)transaction;
}
    ...
    afw_xctx_t *xctx)
{
    ...
    dbi = afw_lmdb_internal_open_database(session->adapter, txn, 
