...
#ifndef __AFW_COMPONENTS_VERSION_INFO_H__
#define __AFW_COMPONENTS_VERSION_INFO_H__
...
#define AFW_COMPONENTS_VERSION_MINOR 10
#define AFW_COMPONENTS_VERSION_PATCH 0
#define AFW_COMPONENTS_VERSION_HEX ( \
    (AFW_VERSION_MAJOR << 16) | \
    (AFW_VERSION_MINOR <<  8) | \
    (AFW_VERSION_PATCH))
#define AFW_COMPONENTS_VERSION_STRING "0.10.0"
#define AFW_COMPONENTS_VERSION_WITH_GIT_INFO "0.10.0" \
...
#endif /* __AFW_COMPONENTS_VERSION_INFO_H__ */
