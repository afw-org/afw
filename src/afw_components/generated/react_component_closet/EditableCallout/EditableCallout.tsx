...
import {IEditableCalloutProps} from "./EditableCallout.types";
 ...
 * 
 */
export const EditableCallout : React.FunctionComponent<IEditableCalloutProps> = (props) => {
...
export default React.memo(EditableCallout);
