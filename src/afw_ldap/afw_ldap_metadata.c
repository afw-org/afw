    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    return afw_ldap_internal_create_object_from_entry(session,
        &afw_ldap_self_s__AdaptiveLdapRootDse_, &afw_self_s_current,
        e, p, xctx);
    ...
    const afw_pool_t *p, afw_xctx_t *xctx)
{
    ...
    return afw_ldap_internal_create_object_from_entry(session,
        &afw_ldap_self_s__AdaptiveLdapSchema_, &afw_self_s_current,
        e, p, xctx);
}
    ...
    afw_xctx_t *xctx)
{
    ...
    for (iterator = NULL;;) {
        ...
        obj = impl_parse_schema_entry(&afw_ldap_self_s_numericoid, e,
            metadata->p, xctx);

        name_value = afw_object_get_property(obj,
            &afw_ldap_self_s_NAME, xctx);

        if (!name_value) {
            name_value = afw_object_get_property(obj,
                &afw_ldap_self_s_numericoid, xctx);
            if (!name_value) {
    ...
    afw_xctx_t *xctx)
{
        ...
        hi; hi = apr_hash_next(hi))
    {
        ...
        syntax = afw_object_old_get_property_as_string(attribute_type_object,
            &afw_ldap_self_s_SYNTAX, xctx);
        if (syntax) {

            /* Get oid part of syntax. */
            error_id = &afw_ldap_self_s_SYNTAX;
            ...
            attribute_type->is_single =
                afw_object_old_get_property_as_boolean(
                    attribute_type_object, &afw_ldap_self_s_a_single_dash_value,
                    &found, xctx);

            /* X-NDS_LOWER_BOUND. */
            attribute_type->lower_bound =
                afw_object_old_get_property_as_integer_deprecated(
                    attribute_type_object, &afw_ldap_self_s_a_X_NDS_LOWER_BOUND,
            ...
            if (!attribute_type->upper_bound_present) {
                attribute_type->upper_bound =
                    afw_object_old_get_property_as_integer_deprecated(
                        attribute_type_object, &afw_ldap_self_s_a_X_NDS_UPPER_BOUND,
            ...
            if (afw_object_old_get_property_as_boolean_deprecated(attribute_type_object,
                &afw_ldap_self_s_a_NO_USER_MODIFICATION, xctx))
            {
            ...
            if (afw_object_old_get_property_as_boolean_deprecated(attribute_type_object,
                &afw_ldap_self_s_a_X_NDS_HIDDEN, xctx))
            {
            ...
            if (afw_object_old_get_property_as_boolean_deprecated(attribute_type_object,
                &afw_ldap_self_s_a_X_NDS_NONREMOVABLE, xctx))
            {
                attribute_type->never_allow_write = true;
            }
            ...
            if (afw_object_old_get_property_as_boolean_deprecated(attribute_type_object,
                &afw_ldap_self_s_a_X_NDS_READ_FILTERED, xctx))
            {
            ...
            if (!attribute_type->never_allow_read) {
                ...
                afw_object_meta_set_ids(
                    attribute_type->property_type_object,
                    adaptor_id, &afw_self_s__AdaptiveValueMeta_, id, xctx);
                ...
                if (attribute_type->is_single) {
                    if (attribute_type->data_type_id_value) {
                        afw_object_set_property(
                            attribute_type->property_type_object,
                            &afw_self_s_dataType, attribute_type->data_type_id_value,
                            xctx);
                    }
                }
                else {
                    afw_object_set_property(
                        attribute_type->property_type_object,
                        &afw_self_s_dataType, afw_data_type_array_id_value, 
                        xctx);
                    if (attribute_type->data_type_id_value) {
                        afw_object_set_property(
                            attribute_type->property_type_object,
                ...
                if (attribute_type->lower_bound_present) {
                    ...
                    afw_object_set_property_as_string(
                        attribute_type->property_type_object,
                        &afw_self_s_minValue, string, xctx);
                ...
                if (attribute_type->upper_bound_present) {
                    ...
                    afw_object_set_property_as_string(
                        attribute_type->property_type_object,
                        &afw_self_s_maxValue, string, xctx);
                }
                ...
                afw_object_set_property_as_boolean(
                    attribute_type->property_type_object,
                    &afw_self_s_allowQuery, afw_value_true, xctx);

                /* Description. */
                value = afw_object_get_property(attribute_type_object, &afw_ldap_self_s_DESC,
                    xctx);
                if (value) {
                    afw_object_set_property(
                        attribute_type->property_type_object,
                        &afw_self_s_description, value, xctx);
                }
    ...
    afw_xctx_t *xctx)
{
    ...
    if (required) {
        afw_object_set_property(prop, &afw_self_s_required,
            afw_value_true, xctx);
    }
}
    ...
    afw_xctx_t *xctx)
{
    ...
    property_types_object = afw_object_old_get_property_as_object(
        object_type_object, &afw_self_s_propertyTypes, xctx);
    ...
    afw_xctx_t *xctx)
{
        ...
        hi; hi = apr_hash_next(hi))
    {
        ...
        afw_object_meta_set_ids(object_type_object, adaptor_id,
            &afw_ldap_self_s__AdaptiveObjectType_, id, xctx);
        afw_object_set_property_as_string(object_type_object, &afw_self_s_objectType,
            id, xctx);
        afw_object_set_property(object_type_object, &afw_self_s_allowEntity,
            (afw_object_old_get_property_as_boolean_deprecated(object_class_object,
                &afw_ldap_self_s_STRUCTURAL, xctx))
            ? afw_value_true
            : afw_value_false,
            xctx);

        afw_object_set_property(object_type_object, &afw_self_s_allowAdd,
            afw_value_true, xctx);
        afw_object_set_property(object_type_object, &afw_self_s_allowChange,
            afw_value_true, xctx);
        afw_object_set_property(object_type_object, &afw_self_s_allowDelete,
            afw_value_true, xctx);
        ...
        other_properties = afw_object_create_embedded(
            object_type_object, &afw_self_s_otherProperties, xctx);
        afw_object_set_property(other_properties,
            &afw_self_s_allowWrite, afw_value_false, xctx);
        ...
        value = afw_object_get_property(object_class_object, &afw_ldap_self_s_DESC,
            xctx);
        if (!value) {
        ...
        afw_object_set_property(object_type_object, &afw_self_s_description, value,
            xctx);
    ...
    impl_set_synthetic_object_type(metadata->object_type_objects,
        &afw_self_s__AdaptiveObjectType_, xctx);
    impl_set_synthetic_object_type(metadata->object_type_objects,
        &afw_self_s__AdaptiveValueMeta_, xctx);
    impl_set_synthetic_object_type(metadata->object_type_objects,
        &afw_ldap_self_s__AdaptiveLdapAttributeType_, xctx);
    impl_set_synthetic_object_type(metadata->object_type_objects,
        &afw_ldap_self_s__AdaptiveLdapMatchingRuleUse_, xctx);
    impl_set_synthetic_object_type(metadata->object_type_objects,
        &afw_ldap_self_s__AdaptiveLdapMatchingRuleUse_, xctx);
    impl_set_synthetic_object_type(metadata->object_type_objects,
        &afw_ldap_self_s__AdaptiveLdapMatchingRule_, xctx);
    impl_set_synthetic_object_type(metadata->object_type_objects,
        &afw_ldap_self_s__AdaptiveLdapObjectClass_, xctx);
    impl_set_synthetic_object_type(metadata->object_type_objects,
        &afw_ldap_self_s__AdaptiveLdapRootDse_, xctx);
    impl_set_synthetic_object_type(metadata->object_type_objects,
        &afw_ldap_self_s__AdaptiveLdapSchema_, xctx);
    impl_set_synthetic_object_type(metadata->object_type_objects,
        &afw_ldap_self_s__AdaptiveLdapSyntax_, xctx);
}
    ...
    afw_xctx_t *xctx)
{
    ...
    value = afw_object_get_property(new_metadata->rootdse_object,
        &afw_ldap_self_s_subschemaSubentry,
        xctx);
    if (!value) {
    ...
    new_metadata->attribute_type_objects =
        impl_parse_definition(
            ...
            &afw_ldap_self_s_attributeTypes,
            new_metadata, xctx);
    ...
    new_metadata->matching_rule_use_objects =
        impl_parse_definition(
            ...
            &afw_ldap_self_s_matchingRuleUse,
            new_metadata, xctx);
    ...
    afw_xctx_t *xctx)
{
    ...
    /* RootDSE */
    if (afw_utf8_equal(object_type_id, &afw_ldap_self_s__AdaptiveLdapRootDse_))
    {
        if (afw_utf8_equal(object_id, &afw_self_s_current)) {
            obj = self->adaptor->metadata->rootdse_object;
        }
    }
    ...
    /* ObjectType. */
    else if (afw_utf8_equal(object_type_id, &afw_self_s__AdaptiveObjectType_))
    {
    ...
    /* ValueMeta. */
    else if (afw_utf8_equal(object_type_id, &afw_self_s__AdaptiveValueMeta_))
    {
        obj = impl_get_object(self,
...
{
    if (object_type  && afw_utf8_starts_with(object_type, &afw_self_s__Adaptive))
    {
        return AFW_TRUE;
    }
