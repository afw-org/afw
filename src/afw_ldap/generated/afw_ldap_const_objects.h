...
#ifndef __AFW_LDAP_CONST_OBJECTS_H__
#define __AFW_LDAP_CONST_OBJECTS_H__


/**
 * @file afw_ldap_const_objects.h
...
/**
 * @brief Get array of afw_ldap_ const objects. 
 */
void
afw_ldap_const_objects_register(afw_xctx_t *xctx);


#endif /* __AFW_LDAP_CONST_OBJECTS_H__ */
