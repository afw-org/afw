...
#ifndef __AFW_LDAP_CONST_OBJECTS_INTERNAL_H__
#define __AFW_LDAP_CONST_OBJECTS_INTERNAL_H__


/**
 * @file afw_ldap_const_objects_internal.h
...
/**
 * @brief Register afw_ldap_ const objects (package/core init).
 */
void
afw_ldap_const_objects_register(afw_xctx_t *xctx);


#endif /* __AFW_LDAP_CONST_OBJECTS_INTERNAL_H__ */
