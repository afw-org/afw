...
def write_c_section(fd, prefix, obj):
    ...
    fd.write('\n')
    fd.write('/*\n')
    fd.write(' * Implementation of method get_evaluated_data_type for interface afw_value.\n')
    fd.write(' */\n')
    fd.write('const afw_data_type_t *\n')
    fd.write('impl_afw_value_get_evaluated_data_type(\n')
    fd.write('    const afw_value_t *instance,\n')
    fd.write('    afw_xctx_t *xctx)\n')
    fd.write('{\n')
    fd.write('    return afw_data_type_' + id + ';\n')
    ...
    fd.write('/*\n')
    fd.write(' * Implementation of method get_evaluated_data_type_parameter for interface\n')
    fd.write(' * afw_value.\n')
    fd.write(' */\n')
    fd.write('const afw_utf8_t *\n')
    fd.write('impl_afw_value_get_evaluated_data_type_parameter(\n')
    fd.write('    const afw_value_t *instance,\n')
    fd.write('    afw_xctx_t *xctx)\n')
    fd.write('{\n')
