 ...
 */
export const ServiceNewAdaptorLmdb = (props) => {
...
export const ServiceEditorAdaptorLmdbIndex = (props) => {    
    ...
    const onAddIndex = async () => {
        const adaptorId = props.serviceConf.getPropertyValue([ "conf", "adaptorId" ]);
...
/**
 * ServiceEditorAdaptorLmdb
 * 
 * Main component for displaying the editor for a LMDB Service.
 */
export const ServiceEditorAdaptorLmdb = (props) => {
    ...
    useEffect(() => {
        const loadIndexes = async () => {
            const adaptorId = serviceConf.getPropertyValue([ "conf", "adaptorId" ]);
            
            const indexDefinitions = await afwIndexList(client, adaptorId).result();            
            const indexes = [];
    ...
    const removeIndex = async (key) => {
        const adaptorId = serviceConf.getPropertyValue([ "conf", "adaptorId" ]);
        await afwIndexRemove(client, key, adaptorId).result();        
                                ...
                                <Responsive 
                                    ...
                                    items={[                                        
                                        ...
                                        },
                                        {
                                            ...
                                            contains:
                                                <PropertyResponsive 
                                                    property={conf.getProperty("journalAdaptorId")}                                                             
                                                />
                                        }                            
                                    ]}
                                /> 
...
export default ServiceEditorAdaptorLmdb;
