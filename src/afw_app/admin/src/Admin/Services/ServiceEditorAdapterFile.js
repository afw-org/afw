 ...
 */
export const ServiceNewAdapterFile = (props) => {
...
/**
 * ServiceEditorAdapterFile
 * 
 * Main component for displaying the editor for a LMDB Service.
 */
export const ServiceEditorAdapterFile = (props) => {
...
export default ServiceEditorAdapterFile;
