#ifndef __AFW_VFS_ADAPTOR_INTERNAL_H__
#define __AFW_VFS_ADAPTOR_INTERNAL_H__

/* Internal implementation header for adaptor type vfs */
...
/**
 * @file afw_vfs_adaptor_internal.h
 * @brief Internal header for adaptor type vfs.
 */
...
typedef struct afw_vfs_adaptor_internal_s
afw_vfs_adaptor_internal_t;

typedef struct afw_vfs_adaptor_internal_session_s
afw_vfs_adaptor_internal_session_t;

typedef struct afw_vfs_adaptor_internal_session_context_s
afw_vfs_adaptor_internal_session_context_t;
...
extern const afw_adaptor_t *
afw_vfs_adaptor_internal_create_cede_p(
...
extern const afw_adaptor_session_t *
...
#endif /* AFW_VFS_ADAPTOR_INTERNAL_H__ */
