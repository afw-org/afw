...
#ifndef __AFW_VFS_CONST_OBJECTS_INTERNAL_H__
#define __AFW_VFS_CONST_OBJECTS_INTERNAL_H__


/**
 * @file afw_vfs_const_objects_internal.h
...
/**
 * @brief Register afw_vfs_ const objects (package/core init).
 */
void
afw_vfs_const_objects_register(afw_xctx_t *xctx);


#endif /* __AFW_VFS_CONST_OBJECTS_INTERNAL_H__ */
