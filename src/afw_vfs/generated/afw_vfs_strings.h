 ...
 * @brief Generated string constants header for prefix `afw_vfs_`.
 */
...
/** @brief #define for string in quotes */
#define AFW_VFS_Q_contextType \
    "contextType"

/** @brief 'afw_utf8_t' for AFW_VFS_Q_contextType */
#define afw_vfs_s_contextType \
    (&afw_vfs_self_v_contextType.internal)

/** @brief 'afw_utf8_t' for AFW_VFS_Q_contextType */
#define afw_vfs_self_s_contextType \
    (afw_vfs_self_v_contextType.internal)

/** @brief 'afw_value_string_t' for AFW_VFS_Q_contextType */
extern const afw_value_string_t \
    afw_vfs_self_v_contextType;

/** @brief 'afw_utf8_z_t *' for AFW_VFS_Q_contextType */
#define afw_vfs_z_contextType \
    (afw_vfs_self_v_contextType.internal.s)

/** @brief 'const afw_value_t *' for AFW_VFS_Q_contextType */
#define afw_vfs_v_contextType \
    (&afw_vfs_self_v_contextType.pub)
...
/** @brief #define for string in quotes */
#define AFW_VFS_Q_process \
    "process"

/** @brief 'afw_utf8_t' for AFW_VFS_Q_process */
#define afw_vfs_s_process \
    (&afw_vfs_self_v_process.internal)

/** @brief 'afw_utf8_t' for AFW_VFS_Q_process */
#define afw_vfs_self_s_process \
    (afw_vfs_self_v_process.internal)

/** @brief 'afw_value_string_t' for AFW_VFS_Q_process */
extern const afw_value_string_t \
    afw_vfs_self_v_process;

/** @brief 'afw_utf8_z_t *' for AFW_VFS_Q_process */
#define afw_vfs_z_process \
    (afw_vfs_self_v_process.internal.s)

/** @brief 'const afw_value_t *' for AFW_VFS_Q_process */
#define afw_vfs_v_process \
...
/** @brief #define for string in quotes */
#define AFW_VFS_Q_template \
    "template"

/** @brief 'afw_utf8_t' for AFW_VFS_Q_template */
#define afw_vfs_s_template \
    (&afw_vfs_self_v_template.internal)

/** @brief 'afw_utf8_t' for AFW_VFS_Q_template */
#define afw_vfs_self_s_template \
    (afw_vfs_self_v_template.internal)

/** @brief 'afw_value_string_t' for AFW_VFS_Q_template */
extern const afw_value_string_t \
    afw_vfs_self_v_template;

/** @brief 'afw_utf8_z_t *' for AFW_VFS_Q_template */
#define afw_vfs_z_template \
    (afw_vfs_self_v_template.internal.s)

/** @brief 'const afw_value_t *' for AFW_VFS_Q_template */
#define afw_vfs_v_template \
...
/** @brief #define for string in quotes */
#define AFW_VFS_Q_zz__025995016701 \
    "This is the vfs path within this instance of Adaptive Framework. This property is read-only."

/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__025995016701 */
#define afw_vfs_s_zz__025995016701 \
    (&afw_vfs_self_v_zz__025995016701.internal)

/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__025995016701 */
#define afw_vfs_self_s_zz__025995016701 \
    (afw_vfs_self_v_zz__025995016701.internal)

/** @brief 'afw_value_string_t' for AFW_VFS_Q_zz__025995016701 */
extern const afw_value_string_t \
    afw_vfs_self_v_zz__025995016701;

/** @brief 'afw_utf8_z_t *' for AFW_VFS_Q_zz__025995016701 */
#define afw_vfs_z_zz__025995016701 \
    (afw_vfs_self_v_zz__025995016701.internal.s)

/** @brief 'const afw_value_t *' for AFW_VFS_Q_zz__025995016701 */
#define afw_vfs_v_zz__025995016701 \
    (&afw_vfs_self_v_zz__025995016701.pub)



/** @brief #define for string in quotes */
#define AFW_VFS_Q_zz__2f2b7390a506 \
    "If specified, only files with filenames that end with the specified suffix are included."

/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__2f2b7390a506 */
#define afw_vfs_s_zz__2f2b7390a506 \
    (&afw_vfs_self_v_zz__2f2b7390a506.internal)

/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__2f2b7390a506 */
#define afw_vfs_self_s_zz__2f2b7390a506 \
    (afw_vfs_self_v_zz__2f2b7390a506.internal)

/** @brief 'afw_value_string_t' for AFW_VFS_Q_zz__2f2b7390a506 */
extern const afw_value_string_t \
    afw_vfs_self_v_zz__2f2b7390a506;

/** @brief 'afw_utf8_z_t *' for AFW_VFS_Q_zz__2f2b7390a506 */
#define afw_vfs_z_zz__2f2b7390a506 \
    (afw_vfs_self_v_zz__2f2b7390a506.internal.s)

/** @brief 'const afw_value_t *' for AFW_VFS_Q_zz__2f2b7390a506 */
#define afw_vfs_v_zz__2f2b7390a506 \
    (&afw_vfs_self_v_zz__2f2b7390a506.pub)



/** @brief #define for string in quotes */
#define AFW_VFS_Q_zz__38304307d786 \
...
/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__38304307d786 */
#define afw_vfs_s_zz__38304307d786 \
    (&afw_vfs_self_v_zz__38304307d786.internal)

/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__38304307d786 */
#define afw_vfs_self_s_zz__38304307d786 \
    (afw_vfs_self_v_zz__38304307d786.internal)

/** @brief 'afw_value_string_t' for AFW_VFS_Q_zz__38304307d786 */
extern const afw_value_string_t \
    afw_vfs_self_v_zz__38304307d786;

/** @brief 'afw_utf8_z_t *' for AFW_VFS_Q_zz__38304307d786 */
#define afw_vfs_z_zz__38304307d786 \
    (afw_vfs_self_v_zz__38304307d786.internal.s)

/** @brief 'const afw_value_t *' for AFW_VFS_Q_zz__38304307d786 */
#define afw_vfs_v_zz__38304307d786 \
    (&afw_vfs_self_v_zz__38304307d786.pub)



/** @brief #define for string in quotes */
#define AFW_VFS_Q_zz__3dc82bfbfbc3 \
    "If true, filenames that begin with dot ('.') will be included."

/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__3dc82bfbfbc3 */
#define afw_vfs_s_zz__3dc82bfbfbc3 \
    (&afw_vfs_self_v_zz__3dc82bfbfbc3.internal)

/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__3dc82bfbfbc3 */
#define afw_vfs_self_s_zz__3dc82bfbfbc3 \
    (afw_vfs_self_v_zz__3dc82bfbfbc3.internal)

/** @brief 'afw_value_string_t' for AFW_VFS_Q_zz__3dc82bfbfbc3 */
extern const afw_value_string_t \
    afw_vfs_self_v_zz__3dc82bfbfbc3;

/** @brief 'afw_utf8_z_t *' for AFW_VFS_Q_zz__3dc82bfbfbc3 */
#define afw_vfs_z_zz__3dc82bfbfbc3 \
    (afw_vfs_self_v_zz__3dc82bfbfbc3.internal.s)

/** @brief 'const afw_value_t *' for AFW_VFS_Q_zz__3dc82bfbfbc3 */
#define afw_vfs_v_zz__3dc82bfbfbc3 \
    (&afw_vfs_self_v_zz__3dc82bfbfbc3.pub)



/** @brief #define for string in quotes */
#define AFW_VFS_Q_zz__55729e8021b7 \
    "This property is a list of vfs map entries.\n\nThe vfsPath of objects in this vfs adapter is of the form:\n\n/<adapterId>/<objectId>\n\nWhere <adapterId> is the id of this adapter and where <objectId> is the relative path from the vfs root directory ('<adapterId>/') to the associated file or directory. An <objectId> of a directory ends with a slash ('/').\n\nEach vfsMap entry is a template evaluated when the adapter is started (plain strings are unchanged; substitutions such as environment:: may be used). The evaluated string must be of the form:\n\n<objectId_prefix>=<host file system directory path>\n\n<objectId_prefix> can be empty if the entry applies to files and directories in the vfs root directory or the objectId of a directory within the vfs.\n\nThe <host file system directory path> must end in a slash ('/'). A backslash is tolerated on a Windows host. Host directories are resolved to absolute paths at adapter start. The host system file path is the <objectId> with <objectId_prefix> removed appended to the associated <host file system directory path>.\n\nThe map entry with the longest matching <objectId_prefix> is the one used for any adapter functions objectId parameter.\n\nFor retrieve_objects*() the entries are processed in longest to shortest <objectId_prefix> order. If 'subdirectory' is supplied in the retrieve_objects*() adapterSpecific parameter, only matching entries are used. Note, that depending on the vfsMap, a single physical file or directory can appear multiple times with different vfsPaths."

/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__55729e8021b7 */
#define afw_vfs_s_zz__55729e8021b7 \
    (&afw_vfs_self_v_zz__55729e8021b7.internal)

/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__55729e8021b7 */
#define afw_vfs_self_s_zz__55729e8021b7 \
    (afw_vfs_self_v_zz__55729e8021b7.internal)

/** @brief 'afw_value_string_t' for AFW_VFS_Q_zz__55729e8021b7 */
extern const afw_value_string_t \
    afw_vfs_self_v_zz__55729e8021b7;

/** @brief 'afw_utf8_z_t *' for AFW_VFS_Q_zz__55729e8021b7 */
#define afw_vfs_z_zz__55729e8021b7 \
    (afw_vfs_self_v_zz__55729e8021b7.internal.s)

/** @brief 'const afw_value_t *' for AFW_VFS_Q_zz__55729e8021b7 */
#define afw_vfs_v_zz__55729e8021b7 \
...
/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__824be34f6220 */
#define afw_vfs_s_zz__824be34f6220 \
    (&afw_vfs_self_v_zz__824be34f6220.internal)

/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__824be34f6220 */
#define afw_vfs_self_s_zz__824be34f6220 \
    (afw_vfs_self_v_zz__824be34f6220.internal)

/** @brief 'afw_value_string_t' for AFW_VFS_Q_zz__824be34f6220 */
extern const afw_value_string_t \
    afw_vfs_self_v_zz__824be34f6220;

/** @brief 'afw_utf8_z_t *' for AFW_VFS_Q_zz__824be34f6220 */
#define afw_vfs_z_zz__824be34f6220 \
    (afw_vfs_self_v_zz__824be34f6220.internal.s)

/** @brief 'const afw_value_t *' for AFW_VFS_Q_zz__824be34f6220 */
#define afw_vfs_v_zz__824be34f6220 \
    (&afw_vfs_self_v_zz__824be34f6220.pub)



/** @brief #define for string in quotes */
#define AFW_VFS_Q_zz__8ea45321d198 \
...
/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__8ea45321d198 */
#define afw_vfs_s_zz__8ea45321d198 \
    (&afw_vfs_self_v_zz__8ea45321d198.internal)

/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__8ea45321d198 */
#define afw_vfs_self_s_zz__8ea45321d198 \
    (afw_vfs_self_v_zz__8ea45321d198.internal)

/** @brief 'afw_value_string_t' for AFW_VFS_Q_zz__8ea45321d198 */
extern const afw_value_string_t \
    afw_vfs_self_v_zz__8ea45321d198;

/** @brief 'afw_utf8_z_t *' for AFW_VFS_Q_zz__8ea45321d198 */
#define afw_vfs_z_zz__8ea45321d198 \
    (afw_vfs_self_v_zz__8ea45321d198.internal.s)

/** @brief 'const afw_value_t *' for AFW_VFS_Q_zz__8ea45321d198 */
#define afw_vfs_v_zz__8ea45321d198 \
...
/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__a9c70700d89b */
#define afw_vfs_s_zz__a9c70700d89b \
    (&afw_vfs_self_v_zz__a9c70700d89b.internal)

/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__a9c70700d89b */
#define afw_vfs_self_s_zz__a9c70700d89b \
    (afw_vfs_self_v_zz__a9c70700d89b.internal)

/** @brief 'afw_value_string_t' for AFW_VFS_Q_zz__a9c70700d89b */
extern const afw_value_string_t \
    afw_vfs_self_v_zz__a9c70700d89b;

/** @brief 'afw_utf8_z_t *' for AFW_VFS_Q_zz__a9c70700d89b */
#define afw_vfs_z_zz__a9c70700d89b \
    (afw_vfs_self_v_zz__a9c70700d89b.internal.s)

/** @brief 'const afw_value_t *' for AFW_VFS_Q_zz__a9c70700d89b */
#define afw_vfs_v_zz__a9c70700d89b \
    (&afw_vfs_self_v_zz__a9c70700d89b.pub)



/** @brief #define for string in quotes */
#define AFW_VFS_Q_zz__e84b94515505 \
...
/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__e84b94515505 */
#define afw_vfs_s_zz__e84b94515505 \
    (&afw_vfs_self_v_zz__e84b94515505.internal)

/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__e84b94515505 */
#define afw_vfs_self_s_zz__e84b94515505 \
    (afw_vfs_self_v_zz__e84b94515505.internal)

/** @brief 'afw_value_string_t' for AFW_VFS_Q_zz__e84b94515505 */
extern const afw_value_string_t \
    afw_vfs_self_v_zz__e84b94515505;

/** @brief 'afw_utf8_z_t *' for AFW_VFS_Q_zz__e84b94515505 */
#define afw_vfs_z_zz__e84b94515505 \
    (afw_vfs_self_v_zz__e84b94515505.internal.s)

/** @brief 'const afw_value_t *' for AFW_VFS_Q_zz__e84b94515505 */
#define afw_vfs_v_zz__e84b94515505 \
    (&afw_vfs_self_v_zz__e84b94515505.pub)



/** @brief #define for string in quotes */
#define AFW_VFS_Q_zz__ea26965c1db6 \
...
/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__ea26965c1db6 */
#define afw_vfs_s_zz__ea26965c1db6 \
    (&afw_vfs_self_v_zz__ea26965c1db6.internal)

/** @brief 'afw_utf8_t' for AFW_VFS_Q_zz__ea26965c1db6 */
#define afw_vfs_self_s_zz__ea26965c1db6 \
    (afw_vfs_self_v_zz__ea26965c1db6.internal)

/** @brief 'afw_value_string_t' for AFW_VFS_Q_zz__ea26965c1db6 */
extern const afw_value_string_t \
    afw_vfs_self_v_zz__ea26965c1db6;

/** @brief 'afw_utf8_z_t *' for AFW_VFS_Q_zz__ea26965c1db6 */
#define afw_vfs_z_zz__ea26965c1db6 \
    (afw_vfs_self_v_zz__ea26965c1db6.internal.s)

/** @brief 'const afw_value_t *' for AFW_VFS_Q_zz__ea26965c1db6 */
#define afw_vfs_v_zz__ea26965c1db6 \
