...
#ifndef __AFW_SERVER_FCGI_VERSION_INFO_H__
#define __AFW_SERVER_FCGI_VERSION_INFO_H__
...
#define AFW_SERVER_FCGI_VERSION_MINOR 12
#define AFW_SERVER_FCGI_VERSION_PATCH 2
#define AFW_SERVER_FCGI_VERSION_HEX ( \
    (AFW_VERSION_MAJOR << 16) | \
    (AFW_VERSION_MINOR <<  8) | \
    (AFW_VERSION_PATCH))
#define AFW_SERVER_FCGI_VERSION_STRING "0.12.2"
#define AFW_SERVER_FCGI_VERSION_WITH_GIT_INFO "0.12.2" \
    AFW_GIT_INFO_BRANCH_DESCRIBE
#define AFW_SERVER_FCGI_VERSION_COMMAND_STRING "afw_server_fcgi " \
    AFW_SERVER_FCGI_VERSION_WITH_GIT_INFO


#endif /* __AFW_SERVER_FCGI_VERSION_INFO_H__ */
