    ...
    afw_xctx_t          * xctx)
{
     ...
     */
    if (options) {
        verbose = afw_object_get_property_as_boolean_internal(options, afw_curl_v_verbose, &found, xctx);
        ...
        sslVerifyPeer = afw_object_get_property_as_boolean_internal(options, afw_curl_v_sslVerifyPeer, &found, xctx);
        ...
        sslVerifyHost = afw_object_get_property_as_boolean_internal(options, afw_curl_v_sslVerifyHost, &found, xctx);
        ...
        sslVerifyStatus = afw_object_get_property_as_boolean_internal(options, afw_curl_v_sslVerifyStatus, &found, xctx);
        ...
        followLocation = afw_object_get_property_as_boolean_internal(options, afw_curl_v_followLocation, &found, xctx);
        ...
        proxy = afw_object_get_property_as_string_internal(options, afw_curl_v_proxy, xctx);
        if (proxy) {
        ...
        userPassword = afw_object_get_property_as_string_internal(options, afw_curl_v_userPassword, xctx);
        if (userPassword) {
        ...
        awsSigv4 = afw_object_get_property_as_string_internal(options, afw_curl_v_awsSigv4, xctx);
        if (awsSigv4) {
        ...
        caInfo = afw_object_get_property_as_string_internal(options, afw_curl_v_caInfo, xctx);
        if (caInfo) {
        ...
        caBlob = afw_object_get_property_as_string_internal(options, afw_curl_v_caBlob, xctx);
        if (caBlob) {
        ...
        caPath = afw_object_get_property_as_string_internal(options, afw_curl_v_caPath, xctx);
        if (caPath) {
