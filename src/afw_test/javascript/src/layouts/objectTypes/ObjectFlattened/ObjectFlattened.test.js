...
import {ObjectFlattened, useModel} from "@afw/react";
...
const Test = (wrapper) => {
    ...
    describe("General tests", () => {        
        ...
        test("Renders properly", async () => {
            ...
            const ObjectFlattenedWithProfiler = withProfiler(ObjectFlattened);
        ...
        test("Renders properly, with a simple object and objectType, editable mode", async () => {
            ...
            /*
            expect(screen.getByLabelText("prop1").value).toBe("some value");
        ...
        test("Renders every propertyType (non editable mode)", async () => {
            ...
            for (let [dataType, propertyType] of Object.entries(objectTypeObject.propertyTypes)) {
                ...
                await waitFor(() => expect(screen.getByText(dataType)).toBeInTheDocument());
