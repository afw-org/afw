...
/*
 * Adaptive Framework Register Generated (afw_ubjson_)
 *
...
static const afw_utf8_z_t * impl_version_info_z[] = {
    ...
    "version", AFW_UBJSON_VERSION_STRING,
    "versionWithGitInfo", AFW_UBJSON_VERSION_WITH_GIT_INFO,
    NULL
};

static const afw_utf8_t impl_version_info_path =
    AFW_UTF8_LITERAL("/afw/_AdaptiveVersionInfo_/afw_ubjson");
...
void afw_ubjson_generated_register(afw_xctx_t *xctx)
{
    ...
    afw_environment_register_string_literals(
        afw_ubjson_string_literals_get(), xctx);

    /* Register content_type ubjson */
    afw_ubjson_content_type_ubjson_register(xctx);
