 ...
 * @brief Generated version macros for prefix `afw_ubjson_`.
 */
...
#define AFW_UBJSON_VERSION_MINOR 12
#define AFW_UBJSON_VERSION_PATCH 2
#define AFW_UBJSON_VERSION_HEX ( \
    (AFW_VERSION_MAJOR << 16) | \
    (AFW_VERSION_MINOR <<  8) | \
    (AFW_VERSION_PATCH))
#define AFW_UBJSON_VERSION_STRING "0.12.2"
#define AFW_UBJSON_VERSION_WITH_GIT_INFO "0.12.2" \
