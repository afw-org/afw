...
- **Phase 2** merged [PR #161](https://github.com/afw-org/afw/pull/161) (`ae50a2ab`) — EnvironmentRegistry/`current` rich objectOptions pool fix (`afw_object_meta_get_property_type` materializes on view pool).
- **Active branch:** `issue-#149-catalog-phase3` — remaining: more accessors only if proven; metrics R vs snapshot; close #149 when satisfied.
