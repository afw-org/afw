...
| [#39](https://github.com/afw-org/afw/issues/39) | Mike | Support holes in list literals | Support holes in list literals and deal with all of the consequences of entries in lists being able to be undefined. There are a lot of functions that can traverse lists that need to deal with this properly like the… | **Closed** 2026-08-06 — PR [#152](https://github.com/afw-org/afw/pull/152) → mgg-develop (dense elision → undefined, assign-append, create_array, out-of-range bracket get, HOF fixes, convert/constructor docs). | 2026-08-06 |
...
| Adaptive Script language | [#28](https://github.com/afw-org/afw/issues/28), [#35](https://github.com/afw-org/afw/issues/35), [#62](https://github.com/afw-org/afw/issues/62), [#101](https://github.com/afw-org/afw/issues/101), [#22](https://github.com/afw-org/afw/issues/22) | Types mostly shipped (left open); [#39](https://github.com/afw-org/afw/issues/39) **closed** (PR [#152](https://github.com/afw-org/afw/pull/152)); closures left open for [#2](https://github.com/afw-org/afw/issues/2) |
