...
| [#62](https://github.com/afw-org/afw/issues/62) | Mike | Adaptive Script language changes | This issue and this top comment is a index of various Adaptive Script language changes that are needed. These changes… | Index 1–5 landed on `issue-#62-script-language` ([PR #174](https://github.com/afw-org/afw/pull/174), pending review). Running result, multi let/const, for init, assignment chain, labels; void singleton / `: void` procedures. | 2026-08-13 |
