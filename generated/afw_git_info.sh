...
/* ----------------------------- N O T E -------------------------------------
 * 
 * This file was generated by afw_git_info.sh
 *
 * Do not change this file directly.
 *
 * ----------------------------- N O T E ------------------------------------*/
...
/*!
 *  @file afw_git_info.h
 *  @brief Git information header for AFW package afw.
 */

#define AFW_GIT_INFO_BRANCH          "${GIT_BRANCH}"
#define AFW_GIT_INFO_DESCRIBE        "${GIT_DESCRIBE}"
#define AFW_GIT_INFO_SHA             "${GIT_SHA}"
#define AFW_GIT_INFO_BRANCH_DESCRIBE "${GIT_MINUS}+${GIT_DESCRIBE}"

EOF
)

# only update the file if it has changed, to prevent unnecessary recompiles
_AFW_GIT_INFO_FILE="$(dirname ""$0"")/afw_git_info.h"
